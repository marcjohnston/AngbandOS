...
[Serializable]
internal class RangerManaStormChaosSpell : ClassSpell
{
    private RangerManaStormChaosSpell(Game game) : base(game) { }
    public override string SpellName => nameof(ManaStormChaosSpell);
