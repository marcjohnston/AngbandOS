...
[Serializable]
internal class RangerMassCarnageDeathSpell : ClassSpell
{
    private RangerMassCarnageDeathSpell(Game game) : base(game) { }
    public override string SpellName => nameof(MassCarnageDeathSpell);
