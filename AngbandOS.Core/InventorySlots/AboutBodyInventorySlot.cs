...
{
    private AboutBodyInventorySlot(Game game) : base(game) { }
    ...
    public override int BareArmorClassBonus => Game.ExperienceLevel.Value > 15 ? (Game.ExperienceLevel.Value - 13) / 3 : 0;
