...
[Serializable]
internal class GenericRodItemFlavor : RodItemFlavor
{
    public GenericRodItemFlavor(Game game, ReadableFlavorGameConfiguration readableFlavorDefninition) : base(game)
    {
