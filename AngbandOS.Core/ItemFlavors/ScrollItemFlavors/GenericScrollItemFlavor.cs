...
[Serializable]
internal class GenericScrollItemFlavor : ScrollItemFlavor
{
    public GenericScrollItemFlavor(Game game, ReadableFlavorGameConfiguration readableFlavorDefninition) : base(game)
    {
