...
[Serializable]
internal class GenericWandItemFlavor : WandItemFlavor
{
    public GenericWandItemFlavor(Game game, ReadableFlavorGameConfiguration readableFlavorDefninition) : base(game)
    {
