...
{
    private StoneskinTimer(Game game) : base(game) { }
    private StoneskinTimer(Game game, ObjectGameStateBag gameStateBag) : base(game, gameStateBag) { }    protected override void EffectStopped()
    {
