...
{
    private FireResistanceTimer(Game game) : base(game) { }
    private FireResistanceTimer(Game game, ObjectGameStateBag gameStateBag) : base(game, gameStateBag) { }    protected override void EffectStopped()
    {
