...
[Serializable]
internal class BabyGreenDragonMonsterRace : MonsterRace
{
    protected BabyGreenDragonMonsterRace(Game game) : base(game) { }
    ...
    public override string Description => "This hatchling dragon is still soft, its eyes unaccustomed to light and its scales a sickly green.";
    ...
    public override string FriendlyName => "Baby green dragon";
