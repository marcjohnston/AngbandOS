...
{
    protected ByakheeMonsterRace(Game game) : base(game) { }
    ...
    {
        new MonsterAttackDefinition(nameof(ClawAttack), nameof(LoseStrAttackEffect), 3, 4),
        new MonsterAttackDefinition(nameof(BiteAttack), nameof(Exp20AttackEffect), 3, 4),
    };
