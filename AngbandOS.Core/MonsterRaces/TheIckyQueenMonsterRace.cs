...
{
    protected TheIckyQueenMonsterRace(Game game) : base(game) { }
    ...
    {
        (nameof(CrawlAttack), nameof(PoisonAttackEffect), 3, 4),
        (nameof(CrawlAttack), nameof(EatFoodAttackEffect), 3, 4),
        (nameof(TouchAttack), nameof(AcidAttackEffect), 3, 5),
