...
{
    [Serializable]
    internal class PotionCureCriticalWounds : PotionItemClass
    {
        private PotionCureCriticalWounds(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
        ...
        public override Item CreateItem(SaveGame saveGame) => new CureCriticalWoundsPotionItem(saveGame);
    }
}
