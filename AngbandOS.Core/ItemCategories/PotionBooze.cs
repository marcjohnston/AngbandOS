...
{
    [Serializable]
    internal class PotionBooze : PotionItemClass
    {
        private PotionBooze(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
        ...
        {
            saveGame.Project(who, 2, y, x, 0, new ProjectOldConf(saveGame), ProjectionFlag.ProjectJump | ProjectionFlag.ProjectItem | ProjectionFlag.ProjectKill);
            return true;
        }
    }
}
