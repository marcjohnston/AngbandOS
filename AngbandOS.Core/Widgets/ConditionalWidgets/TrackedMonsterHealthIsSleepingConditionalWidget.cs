...
/// </summary>
[Serializable]
internal class TrackedMonsterHealthIsSleepingConditionalWidget : ConditionalWidget
{
    private TrackedMonsterHealthIsSleepingConditionalWidget(Game game) : base(game) { } // This object is a singleton.
