...
/// </summary>
[Serializable]
internal class TrackedMonsterHealthIsAfraidConditionalWidget : ConditionalWidget
{
    private TrackedMonsterHealthIsAfraidConditionalWidget(Game game) : base(game) { } // This object is a singleton.
    protected override (string conditionalName, bool isTrue, int term)[] EnabledNames => new (string, bool, int)[]
    {
        (nameof(TrackedMonsterIsAfraidBoolFunction), true, 0)
    };
