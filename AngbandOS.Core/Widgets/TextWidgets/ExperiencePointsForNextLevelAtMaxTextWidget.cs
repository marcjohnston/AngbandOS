...
[Serializable]
internal class ExperiencePointsForNextLevelAtMaxTextWidget : TextWidget
{
    private ExperiencePointsForNextLevelAtMaxTextWidget(Game game) : base(game) { } // This object is a singleton.
