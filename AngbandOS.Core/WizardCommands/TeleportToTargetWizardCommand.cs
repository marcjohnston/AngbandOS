...
{
    private TeleportToTargetWizardCommand(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? ExecuteScriptName => nameof(TeleportToTargetScript);
}
