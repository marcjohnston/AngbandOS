...
internal class MageFireBoltOrBeamOfFireScript : Script, IScript, ICastSpellScript
{
    ...
    public void ExecuteScript()
    {
        ...
        Game.FireBoltOrBeam(Game.ExperienceLevel.IntValue, Game.SingletonRepository.Get<Projectile>(nameof(FireProjectile)), dir, Game.DiceRoll(8 + ((Game.ExperienceLevel.IntValue - 5) / 4), 8));
    }
