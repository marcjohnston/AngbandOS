...
internal class SingletonRepository
{
    ...
    public void Load()
    {
        ...
        LoadFromConfiguration<AmuletReadableFlavor, ReadableFlavorConfiguration, GenericAmuletReadableFlavor>(Game.Configuration.AmuletReadableFlavors);
        LoadFromConfiguration<Animation, AnimationConfiguration, GenericAnimation>(Game.Configuration.Animations);
        LoadFromConfiguration<Attack, AttackConfiguration, GenericAttack>(Game.Configuration.Attacks);
        LoadFromConfiguration<ClassSpell, ClassSpellConfiguration, GenericClassSpell>(Game.Configuration.ClassSpells);
        LoadFromConfiguration<DungeonGuardian, DungeonGuardianConfiguration, GenericDungeonGuardian>(Game.Configuration.DungeonGuardians);
        LoadFromConfiguration<Dungeon, DungeonConfiguration, GenericDungeon>(Game.Configuration.Dungeons);
        LoadFromConfiguration<GameCommand, GameCommandConfiguration, GenericGameCommand>(Game.Configuration.GameCommands);
        LoadFromConfiguration<God, GodConfiguration, GenericGod>(Game.Configuration.Gods);
        LoadFromConfiguration<HelpGroup, HelpGroupConfiguration, GenericHelpGroup>(Game.Configuration.HelpGroups);
        LoadFromConfiguration<MonsterRace, MonsterRaceConfiguration, GenericMonsterRace>(Game.Configuration.MonsterRaces);
        LoadFromConfiguration<MushroomReadableFlavor, ReadableFlavorConfiguration, GenericMushroomReadableFlavor>(Game.Configuration.MushroomReadableFlavors);
        LoadFromConfiguration<Plural, PluralConfiguration, GenericPlural>(Game.Configuration.Plurals);
        LoadFromConfiguration<PotionReadableFlavor, ReadableFlavorConfiguration, GenericPotionReadableFlavor>(Game.Configuration.PotionReadableFlavors);
        LoadFromConfiguration<ProjectileGraphic, ProjectileGraphicConfiguration, GenericProjectileGraphic>(Game.Configuration.ProjectileGraphics);
        LoadFromConfiguration<RingReadableFlavor, ReadableFlavorConfiguration, GenericRingReadableFlavor>(Game.Configuration.RingReadableFlavors);
        LoadFromConfiguration<RodReadableFlavor, ReadableFlavorConfiguration, GenericRodReadableFlavor>(Game.Configuration.RodReadableFlavors);
        LoadFromConfiguration<ScrollReadableFlavor, ReadableFlavorConfiguration, GenericScrollReadableFlavor>(Game.Configuration.ScrollReadableFlavors);
        LoadFromConfiguration<Shopkeeper, ShopkeeperConfiguration, GenericShopkeeper>(Game.Configuration.Shopkeepers);
        LoadFromConfiguration<Spell, SpellConfiguration, GenericSpell>(Game.Configuration.Spells);
        LoadFromConfiguration<StaffReadableFlavor, ReadableFlavorConfiguration, GenericStaffReadableFlavor>(Game.Configuration.StaffReadableFlavors);
        LoadFromConfiguration<StoreCommand, StoreCommandConfiguration, GenericStoreCommand>(Game.Configuration.StoreCommands);
        LoadFromConfiguration<Symbol, SymbolConfiguration, GenericSymbol>(Game.Configuration.Symbols);
        LoadFromConfiguration<Tile, TileConfiguration, GenericTile>(Game.Configuration.Tiles);
        LoadFromConfiguration<Town, TownConfiguration, GenericTown>(Game.Configuration.Towns);
        LoadFromConfiguration<Vault, VaultConfiguration, GenericVault>(Game.Configuration.Vaults);
        LoadFromConfiguration<WandReadableFlavor, ReadableFlavorConfiguration, GenericWandReadableFlavor>(Game.Configuration.WandReadableFlavors);
        LoadFromConfiguration<WizardCommand, WizardCommandConfiguration, GenericWizardCommand>(Game.Configuration.WizardCommands);
