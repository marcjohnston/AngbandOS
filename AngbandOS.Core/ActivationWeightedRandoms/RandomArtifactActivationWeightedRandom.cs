...
internal class RandomArtifactActivationWeightedRandom : ActivationWeightedRandom
{
    ...
    protected override (string, int)[] ActivationNamesAndWeights => new (string, int)[]
    {
        ...
        (nameof(StoneToMudDirectionalActivation), 100),
        ...
        (nameof(TeleportAwayEvery200DirectionalActivation), 85),
        ...
        (nameof(Vampire50Every400DirectionalActivation), 66),
        ...
        (nameof(SummonFriendlyAnimalActivation), 40),
        ...
        (nameof(SummonFriendlyPhantomActivation), 33),
        ...
        (nameof(SummonFriendlyElemental2In3Activation), 25),
        ...
        (nameof(SummonFriendlyUndead2In3Activation), 5),
        (nameof(SummonFriendlyDemon2In3Activation), 5),
