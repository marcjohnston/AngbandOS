...
[Serializable]
internal class HiUndeadNoUniquesMonsterRaceFilter : MonsterRaceFilter, IMonsterSelector
{
    private HiUndeadNoUniquesMonsterRaceFilter(Game game) : base(game) { } // This object is a singleton.
