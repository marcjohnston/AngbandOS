...
[Serializable]
internal class Bizarre2MonsterRaceFilter : MonsterRaceFilter, IMonsterSelector
{
    private Bizarre2MonsterRaceFilter(Game game) : base(game) { } // This object is a singleton.
