...
[Serializable]
internal class Bizarre1MonsterRaceFilter : MonsterRaceFilter, IMonsterSelector
{
    private Bizarre1MonsterRaceFilter(Game game) : base(game) { } // This object is a singleton.
