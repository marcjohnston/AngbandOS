...
[Serializable]
internal class UniqueMonsterRaceFilter : MonsterRaceFilter, IMonsterSelector
{
    private UniqueMonsterRaceFilter(Game game) : base(game) { } // This object is a singleton.
