...
[Serializable]
internal class TreasureMonsterRaceFilter : MonsterRaceFilter, IMonsterSelector
{
    private TreasureMonsterRaceFilter(Game game) : base(game) { } // This object is a singleton.
