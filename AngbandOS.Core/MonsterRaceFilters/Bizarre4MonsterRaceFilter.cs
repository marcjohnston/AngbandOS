...
[Serializable]
internal class Bizarre4MonsterRaceFilter : MonsterRaceFilter, IMonsterSelector
{
    private Bizarre4MonsterRaceFilter(Game game) : base(game) { } // This object is a singleton.
