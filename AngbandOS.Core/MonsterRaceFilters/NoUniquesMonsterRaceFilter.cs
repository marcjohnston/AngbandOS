...
[Serializable]
internal class NoUniquesMonsterRaceFilter : MonsterRaceFilter, IMonsterSelector
{
    private NoUniquesMonsterRaceFilter(Game game) : base(game) { } // This object is a singleton.
