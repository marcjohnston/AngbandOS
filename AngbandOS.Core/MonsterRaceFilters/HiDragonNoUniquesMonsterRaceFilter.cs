...
[Serializable]
internal class HiDragonNoUniquesMonsterRaceFilter : MonsterRaceFilter, IMonsterSelector
{
    private HiDragonNoUniquesMonsterRaceFilter(Game game) : base(game) { } // This object is a singleton.
