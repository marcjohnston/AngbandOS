...
internal class HurtLotReward : Reward
{
    ...
    public override void GetReward(Patron patron)
    {
        ...
        SaveGame.FireBall(SaveGame.SingletonRepository.Projectiles.Get<DisintegrateProjectile>(), 0, SaveGame.Player.ExperienceLevel * 4, 4);
        SaveGame.Player.TakeHit(SaveGame.Player.ExperienceLevel * 4, wrathReason);
    }
}