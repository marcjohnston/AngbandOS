...
internal class NaturesWrathScript : Script, IScript, ICastSpellScript
{
    ...
    public void ExecuteScript()
    {
        ...
        projectile.Fire(null, 1 + (Game.ExperienceLevel.IntValue / 12), Game.MapY.IntValue, Game.MapX.IntValue, 100 + Game.ExperienceLevel.IntValue, kill: true, item: true, jump: false, beam: false, thru: false, hide: false, grid: false, stop: false);
    }
