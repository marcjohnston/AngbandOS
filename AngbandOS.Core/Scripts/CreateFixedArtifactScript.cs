...
internal class CreateFixedArtifactScript : Script, IScript
{
    ...
    public void ExecuteScript()
    {
        ...
        qPtr.Characteristics.BonusStrength = aPtr.BonusStrength;
        qPtr.Characteristics.BonusIntelligence = aPtr.BonusIntelligence;
        qPtr.Characteristics.BonusWisdom = aPtr.BonusWisdom;
        qPtr.Characteristics.BonusDexterity = aPtr.BonusDexterity;
        qPtr.Characteristics.BonusConstitution = aPtr.BonusConstitution;
        qPtr.Characteristics.BonusCharisma = aPtr.BonusCharisma;
        qPtr.Characteristics.BonusStealth = aPtr.BonusStealth;
        qPtr.Characteristics.BonusSearch = aPtr.BonusSearch;
        qPtr.Characteristics.BonusInfravision = aPtr.BonusInfravision;
        qPtr.Characteristics.BonusTunnel = aPtr.BonusTunnel;
        qPtr.Characteristics.BonusAttacks = aPtr.BonusAttacks;
        qPtr.Characteristics.BonusSpeed = aPtr.BonusSpeed;
