...
[Serializable]
internal class MagicMissle2D6IdentifableDirectionalScript : Script, IIdentifableDirectionalScript
{
    private MagicMissle2D6IdentifableDirectionalScript(Game game) : base(game) { }
