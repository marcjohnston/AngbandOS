...
[Serializable]
internal class BreatheLightOrDarkness200r2Script : Script, IDirectionalCancellableScriptItem
{
    private BreatheLightOrDarkness200r2Script(Game game) : base(game) { }
