...
[Serializable]
internal class ColdBolt3D8IdentifableDirectionalScript : Script, IIdentifableDirectionalScript
{
    private ColdBolt3D8IdentifableDirectionalScript(Game game) : base(game) { }
