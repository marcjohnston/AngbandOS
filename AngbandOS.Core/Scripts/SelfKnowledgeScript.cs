...
internal class SelfKnowledgeScript : Script, IScript, ICastSpellScript, IEatOrQuaffScript
{
    ...
    public void ExecuteScript()
    {
        ...
        else if (Game.LightningResistanceTimer.HasResistance && Game.LightningResistanceTimer.Value != 0)
        {
        ...
        else if (Game.FireResistanceTimer.HasResistance && Game.FireResistanceTimer.Value != 0)
        {
