...
/// </summary>
[Serializable]
internal class BallOfCold100r2Every300DirectionalActivation : DirectionalActivation
{
    ...
    protected override string DirectionalActivationCancellableScriptBindingKey => nameof(Cold100r2ProjectileScript);
