...
[Serializable]
internal class BreatheChaosDisenchantSoundOrShardsDirectionalActivation : DirectionalActivation
{
    private BreatheChaosDisenchantSoundOrShardsDirectionalActivation(Game game) : base(game) { }
