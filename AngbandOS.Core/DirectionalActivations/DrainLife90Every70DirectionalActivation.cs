...
/// </summary>
[Serializable]
internal class DrainLife90Every70DirectionalActivation : DirectionalActivation
{
    ...
    protected override string DirectionalActivationCancellableScriptBindingKey => nameof(OldDrainLife90ProjectileScript);
