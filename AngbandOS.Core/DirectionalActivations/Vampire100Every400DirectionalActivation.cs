...
/// </summary>
[Serializable]
internal class Vampire100Every400DirectionalActivation : DirectionalActivation
{
    ...
    protected override string DirectionalActivationCancellableScriptBindingKey => nameof(Vampire100Script);
