...
/// </summary>
[Serializable]
internal class Vampire50Every400DirectionalActivation : DirectionalActivation
{
    ...
    protected override string DirectionalActivationCancellableScriptBindingKey => nameof(Vampire50Script);
