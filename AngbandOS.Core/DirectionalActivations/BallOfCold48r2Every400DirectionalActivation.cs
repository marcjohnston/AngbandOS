...
/// </summary>
[Serializable]
internal class BallOfCold48r2Every400DirectionalActivation : DirectionalActivation
{
    private BallOfCold48r2Every400DirectionalActivation(Game game) : base(game) { }
