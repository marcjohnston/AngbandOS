...
[Serializable]
internal class BallOfLightning100r2Every1d450p450DirectionalActivation : DirectionalActivation
{
    ...
    protected override string DirectionalActivationCancellableScriptBindingKey => nameof(Electricity100rm2ProjectileScript);
