...
[Serializable]
internal class GenericStringWidget : StringWidget
{
    public GenericStringWidget(Game game, StringWidgetGameConfiguration stringWidgetGameConfiguration) : base(game)
    {
    ...
    public override string StringValueName { get; }
