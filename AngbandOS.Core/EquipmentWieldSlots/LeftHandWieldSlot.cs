...
{
    private LeftHandWieldSlot(Game game) : base(game) { } // This object is a singleton
    private LeftHandWieldSlot(Game game, ObjectGameStateBag gameStateBag) : base(game, gameStateBag) { } // This object is a singleton
