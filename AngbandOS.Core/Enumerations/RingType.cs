...
internal static class RingType
{
    public const int Accuracy = 28;
    ...
    public const int ResConfusion = 43;
    public const int ResDisenchant = 45;
    public const int ResFear = 38;
    public const int ResistCold = 9;
    public const int ResistFire = 8;
    public const int ResistPois = 20;
    public const int ResLd = 39;
    public const int ResNether = 40;
    public const int ResNexus = 41;
    public const int ResShards = 44;
    ...
    public const int Str = 24;
    public const int Stupidity = 3;
    public const int SustainCha = 15;
    public const int SustainCon = 14;
    public const int SustainDex = 13;
    public const int SustainInt = 11;
