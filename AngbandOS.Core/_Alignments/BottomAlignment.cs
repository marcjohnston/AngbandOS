...
{
    private BottomAlignment(Game game) : base(game) { }
    private BottomAlignment(Game game, ObjectGameStateBag gameStateBag) : base(game, gameStateBag) { }    public override string[] Align(string[] lines, int minimumHeight)
    {
