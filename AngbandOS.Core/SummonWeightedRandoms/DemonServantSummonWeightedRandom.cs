...
[Serializable]
internal class DemonServantSummonWeightedRandom : SummonWeightedRandom
{
    protected DemonServantSummonWeightedRandom(Game game) : base(game) { }
    ...
    public string LearnedDetails =>  "control 67%";
}
