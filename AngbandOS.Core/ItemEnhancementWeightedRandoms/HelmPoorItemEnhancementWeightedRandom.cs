...
[Serializable]
internal class HelmPoorItemEnhancementWeightedRandom : ItemEnhancementWeightedRandom
{
    private HelmPoorItemEnhancementWeightedRandom(Game game) : base(game) { } // This object is a singleton.
