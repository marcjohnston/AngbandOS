...
[Serializable]
internal class FixedArtifactEnhancementBundleWeightedRandom : ItemEnhancementWeightedRandom
{
    private FixedArtifactEnhancementBundleWeightedRandom(Game game) : base(game) { } // This object is a singleton
