...
[Serializable]
internal class FixedArtifactItemEnhancementWeightedRandom : ItemEnhancementWeightedRandom
{
    private FixedArtifactItemEnhancementWeightedRandom(Game game) : base(game) { } // This object is a singleton
