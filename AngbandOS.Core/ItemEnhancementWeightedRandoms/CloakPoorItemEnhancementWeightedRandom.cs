...
[Serializable]
internal class CloakPoorItemEnhancementWeightedRandom : ItemEnhancementWeightedRandom
{
    private CloakPoorItemEnhancementWeightedRandom(Game game) : base(game) { } // This object is a singleton.
    protected override (string?, int)[] ItemEnhancementBindingKeyAndWeightTuples => new (string?, int)[]
    {
        ...
        (nameof(CloakOfEnvelopingItemEnhancement), 1)
    };
}
