...
[Serializable]
internal class HiUndeadNoUniquesMonsterFilter : MonsterFilter, IMonsterSelector
{
    private HiUndeadNoUniquesMonsterFilter(Game game) : base(game) { } // This object is a singleton.
