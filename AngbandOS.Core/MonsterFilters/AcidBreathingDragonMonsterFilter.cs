...
[Serializable]
internal class AcidBreathingDragonMonsterFilter : MonsterFilter, IMonsterSelector
{
    private AcidBreathingDragonMonsterFilter(Game game) : base(game) { } // This object is a singleton.
