...
[Serializable]
internal class HiDragonNoUniquesMonsterFilter : MonsterFilter, IMonsterSelector
{
    private HiDragonNoUniquesMonsterFilter(Game game) : base(game) { } // This object is a singleton.
