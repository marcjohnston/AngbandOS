...
[Serializable]
internal class ScrollSyllablesRepository : StringListRepository
{
    public ScrollSyllablesRepository(SaveGame saveGame) : base(saveGame) { }

    /// <summary>
    /// Returns ScrollSyllables as the name of this string list repository.
    /// </summary>
    public override string Name => "ScrollSyllables";

    public override void Load()
    {
        if (SaveGame.Configuration.ScrollSyllables == null)
        {
        ...
        {
            Add(SaveGame.Configuration.ScrollSyllables);
        }
    }
}