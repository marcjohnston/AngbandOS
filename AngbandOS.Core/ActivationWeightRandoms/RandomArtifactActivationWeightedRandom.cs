...
internal class RandomArtifactActivationWeightedRandom : ActivationWeightedRandom
{
    ...
    {
        (nameof(SunlightActivation), 100),
        (nameof(MagicMissile2d6Every2Activation), 100),
        (nameof(StinkingCloud12Every1d4p4Activation), 100),
        (nameof(LightningBolt4d8Every6p1d6Activation), 100),
        (nameof(AcidBolt5d8Every5p1d5Activation), 100),
        (nameof(FrostBolt6d8Every7p1d7Activation), 100),
        (nameof(FireBolt9d8Every8p1d8Activation), 100),
        (nameof(ConfuseMonster20Every15Activation), 100),
        ...
        (nameof(DrainLife100Every100p1d100Activation), 85),
        (nameof(TeleAwayActivation), 85),
        ...
        (nameof(DrainLife120Every400Activation), 66),
        (nameof(Vampire1Activation), 66),
        (nameof(Arrows150Every90p1d90Activation), 66),
        (nameof(FireBall120r3Every225p1d225Activation), 66),
        (nameof(RestLifeActivation), 66),

        (nameof(BallOfCold100r2Every300Activation), 50),
        (nameof(BallOfLightning100r3Every500Activation), 50),
        (nameof(WhirlwindActivation), 50),
        (nameof(DrainLife100Every100p1d100Activation), 50),
        (nameof(CharmAnimal1xEvery300Activation), 50),

        (nameof(SummonAnimalActivation), 40),

        (nameof(DispelEvil5xEvery300p1d300Activation), 33),
        (nameof(ElementalBreath300r4Every500Activation), 33),
        ...
        (nameof(EnslaveUndead1xEvery333Activation), 33),
        (nameof(CharmMonster1xEvery400Activation), 33),
