...
[Serializable]
internal class NumericDivisorDiceRoll : Roll
{
    public NumericDivisorDiceRoll(Game game, bool isNegative, int dieCount, int sideCount, int divisor, int bonus) : base(game)
    {
        if (dieCount == 0)
        {
