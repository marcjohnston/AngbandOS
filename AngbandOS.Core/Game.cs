...
internal partial class Game : IGameSerialize
{
    ...
    private Game(GameConfiguration gameConfiguration, GameReplayDetails? gameReplay, (ObjectGameStateBag GameStateBag, bool UnusedAndEmptyObjectsArePruned)? restoreGameStateBagAndOptions)
    {
        ...
        else
        {
            ...
            AllocRaceTable = restoreGameState.GetByKey(nameof(AllocRaceTable)).GetReferences<AllocationEntry>().ToArray();
            ...
            Inventory = restoreGameState.GetByKey(nameof(Inventory)).GetNullableReferences<Item>();
