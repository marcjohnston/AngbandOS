...
{
    internal class ProjectDarkWeak : Projectile
    {
        public ProjectDarkWeak(SaveGame saveGame) : base(saveGame)
        {
        }

        protected override string BoltGraphic => "GreyBolt";

        protected override string ImpactGraphic => "GreySplat";
