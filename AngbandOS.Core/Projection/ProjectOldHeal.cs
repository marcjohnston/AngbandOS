...
namespace Cthangband.Projection
{
    ...
    {
        public ProjectOldHeal()
        {
            BoltGraphic = "WhiteBullet";
            ImpactGraphic = "";
            EffectAnimation = "WhiteSparkle";
        }
        ...
        protected override bool AffectPlayer(int who, int r, int y, int x, int dam, int aRad)
        {
            ...
            if (fuzzy)
            {
                SaveGame.Instance.MsgPrint("You are hit by something invigorating!");
            }
            Player.RestoreHealth(dam);
            SaveGame.Disturb(true);
            return true;
        }
    }
