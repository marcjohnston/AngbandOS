...
namespace AngbandOS.Projection
{
    ...
    {
        public ProjectOldSlow(SaveGame saveGame) : base(saveGame)
        {
        }

        protected override string BoltGraphic => "BlueBullet";

        protected override string EffectAnimation => "BlueSwirl";
