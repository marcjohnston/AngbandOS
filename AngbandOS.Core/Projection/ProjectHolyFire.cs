...
{
    internal class ProjectHolyFire : Projectile
    {
        public ProjectHolyFire(SaveGame saveGame) : base(saveGame)
        {
        }

        protected override string BoltGraphic => "BrightRedSplat";

        protected override string EffectAnimation => "RedWhiteFlash";
