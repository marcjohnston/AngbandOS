...
{
    internal class ProjectMakeDoor : Projectile
    {
        public ProjectMakeDoor(SaveGame saveGame) : base(saveGame)
        {
        }

        protected override string BoltGraphic => "";

        protected override string EffectAnimation => "BrightBrownSparkle";
