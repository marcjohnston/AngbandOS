...
namespace Cthangband.Projection
{
    ...
    {
        public ProjectHellFire(SaveGame saveGame) : base(saveGame)
        {
            BoltGraphic = "RedSplat";
            ImpactGraphic = "";
            EffectAnimation = "RedBlackFlash";
        }
        ...
        protected override bool AffectPlayer(int who, int r, int y, int x, int dam, int aRad)
        {
            ...
            if (Player.Realm1 == Realm.Death || Player.Realm2 == Realm.Death)
            {
                dam /= 2;
            }
            else if (Player.Realm1 == Realm.Life || Player.Realm2 == Realm.Life)
            {
                dam *= 2;
            }
