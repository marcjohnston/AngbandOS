...
namespace Cthangband.Projection
{
    internal class ProjectControlAnimal : Projectile
    {
        ...
        protected override bool AffectMonster(int who, int r, int y, int x, int dam)
        {
            ...
            if ((rPtr.Flags1 & MonsterFlag1.Unique) != 0 || (rPtr.Flags3 & MonsterFlag3.Animal) == 0 ||
                (rPtr.Flags3 & MonsterFlag3.ImmuneConfusion) != 0 ||
            ...
            else if (Player.HasAggravation || (rPtr.Flags1 & MonsterFlag1.Guardian) != 0)
            {
