...
[Serializable]
internal class DragonsBreatheProjectileWeightedRandomScript : ProjectileWeightedRandomScript
{
    private DragonsBreatheProjectileWeightedRandomScript(Game game) : base(game) { }
