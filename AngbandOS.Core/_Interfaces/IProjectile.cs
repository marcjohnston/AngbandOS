...
/// </summary>
internal interface IProjectile : IDirectionalActivationScript, IAimWandScript, IZapRodScript, IScript, IReadScrollOrUseStaffScript, IUsedScriptItem, ISuccessByChanceScript
{
}
