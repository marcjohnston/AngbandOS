...
internal class ClassSelectionBirthStage : BirthStage
{
    ...
    private bool RenderSelection(int index)
    {
        ...
        Game.DisplayAPlusB(67, 36, characterClass.EffectiveAttributeSet.Get<ReadOnlyAttributeValue<int>>(nameof(DisarmTrapsAttribute)).Value, characterClass.DisarmBonusPerLevel);
