...
[Serializable]
internal class CurePoisonMushroomFoodItemFactory : ItemFactory
{
    ...
    public override string CodedName => "Cure Poison";
    ...
    public override string? EatScriptName => nameof(EatCurePoisonScript);
