...
[Serializable]
internal class IngweAmuletItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private IngweAmuletItemFactory(Game game) : base(game) { } // This object is a singleton.
