...
[Serializable]
internal class BrillianceAmuletItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private BrillianceAmuletItemFactory(Game game) : base(game) { } // This object is a singleton.
