...
[Serializable]
internal class ResistanceAmuletItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private ResistanceAmuletItemFactory(Game game) : base(game) { } // This object is a singleton.
