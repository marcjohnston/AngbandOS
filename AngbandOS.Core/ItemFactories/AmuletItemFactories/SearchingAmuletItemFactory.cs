...
[Serializable]
internal class SearchingAmuletItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private SearchingAmuletItemFactory(Game game) : base(game) { } // This object is a singleton.
