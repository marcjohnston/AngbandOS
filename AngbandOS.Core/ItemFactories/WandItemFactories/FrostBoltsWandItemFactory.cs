...
[Serializable]
internal class FrostBoltsWandItemFactory : ItemFactory
{
    ...
    protected override (string, string, int, int)? AimingBindingTuple => (nameof(ColdBoltOrBeam3d8ProjectileScriptGenericWeightedRandom), "1d5+6", 40, 150);
