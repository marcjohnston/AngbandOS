...
[Serializable]
internal class WonderWandItemFactory : ItemFactory
{
    ...
    protected override (string, string, int, int)? AimingBindingTuple => (nameof(WonderIdentifableDirectionalScript), "1d15+8", 13, 150);
