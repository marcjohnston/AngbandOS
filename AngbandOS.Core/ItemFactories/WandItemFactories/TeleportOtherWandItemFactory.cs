...
[Serializable]
internal class TeleportOtherWandItemFactory : ItemFactory
{
    ...
    protected override (string, string, int, int)? AimingBindingTuple => (nameof(TeleportAwayAll100ProjectileScript), "1d5+6", 18, 150);
