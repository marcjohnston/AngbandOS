...
[Serializable]
internal class FireBoltsWandItemFactory : ItemFactory
{
    private FireBoltsWandItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (string, string, int, int)? AimingBindingTuple => (nameof(FireBoltOrBeam6d8ProjectileWeightedRandom), "1d8+6", 50, 150);
