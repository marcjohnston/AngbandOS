...
[Serializable]
internal class StoneToMudWandItemFactory : ItemFactory
{
    ...
    protected override (string, string, int, int)? AimingBindingTuple => (nameof(StoneToMudIdentifableDirectionalScript), "1d8+3", 15, 150);
