...
[Serializable]
internal class AcidBoltWandItemFactory : ItemFactory
{
    ...
    protected override (string, string, int, int)? AimingBindingTuple => (nameof(AcidBoltOrBeam3d8ProjectileScriptGenericWeightedRandom), "1d8+6", 48, 150);
