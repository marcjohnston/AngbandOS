...
[Serializable]
internal class StinkingCloudWandItemFactory : ItemFactory
{
    private StinkingCloudWandItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (string, string, int, int)? AimingBindingTuple => (nameof(StinkingCloud12R2IdentifableDirectionalScript), "1d8+6", 20, 150);
