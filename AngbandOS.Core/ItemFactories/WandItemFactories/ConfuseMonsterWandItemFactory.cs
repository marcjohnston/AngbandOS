...
[Serializable]
internal class ConfuseMonsterWandItemFactory : ItemFactory
{
    private ConfuseMonsterWandItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (string, string, int, int)? AimingBinderDetails => (nameof(ConfuseMonster10IdentifableDirectionalScript), "1d12+6", 25, 150);
