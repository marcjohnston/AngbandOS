...
[Serializable]
internal class DiseaseMushroomFoodItemFactory : ItemFactory
{
    ...
    public override string CodedName => "Disease";
    ...
    public override string? EatScriptName => nameof(EatDiseaseScript);
