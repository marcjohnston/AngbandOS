...
[Serializable]
internal class StrengthRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private StrengthRingItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    {
        (new int[] {-1, -2}, null, new string[] { nameof(BrokenAndCursedEnchantmentScript), nameof(PoorStrength5BP1EnchantmentScript) }),
        (new int[] {0, 1, 2}, null, new string[] { nameof(BonusStrength5BP1EnchantmentScript) })
    };
