...
[Serializable]
internal class NaryaRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private NaryaRingItemFactory(Game game) : base(game) { } // This object is a singleton.
