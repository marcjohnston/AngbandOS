...
[Serializable]
internal class DamageRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private DamageRingItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    {
        (new int[] {-1, -2}, null, new string[] { nameof(BrokenAndCursedEnchantmentScript), nameof(PoorDamage1D8P10BP5EnchantmentScript) }),
        (new int[] {0, 1, 2}, null, new string[] { nameof(BonusDamage1D8P10BP5EnchantmentScript) })
    };
