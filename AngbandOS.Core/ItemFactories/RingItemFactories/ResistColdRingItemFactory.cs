...
[Serializable]
internal class ResistColdRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private ResistColdRingItemFactory(Game game) : base(game) { } // This object is a singleton.
