...
[Serializable]
internal class LevitationRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private LevitationRingItemFactory(Game game) : base(game) { } // This object is a singleton.
