...
[Serializable]
internal class SlayingRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private SlayingRingItemFactory(Game game) : base(game) { } // This object is a singleton.
