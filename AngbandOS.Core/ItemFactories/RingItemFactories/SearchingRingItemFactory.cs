...
[Serializable]
internal class SearchingRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private SearchingRingItemFactory(Game game) : base(game) { } // This object is a singleton.
