...
[Serializable]
internal class SpeedRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private SpeedRingItemFactory(Game game) : base(game) { } // This object is a singleton.
