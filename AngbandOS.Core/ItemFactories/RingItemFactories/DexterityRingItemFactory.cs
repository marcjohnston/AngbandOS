...
[Serializable]
internal class DexterityRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private DexterityRingItemFactory(Game game) : base(game) { } // This object is a singleton.
