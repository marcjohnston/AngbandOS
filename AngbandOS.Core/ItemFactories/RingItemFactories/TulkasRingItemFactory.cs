...
[Serializable]
internal class TulkasRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private TulkasRingItemFactory(Game game) : base(game) { } // This object is a singleton.
