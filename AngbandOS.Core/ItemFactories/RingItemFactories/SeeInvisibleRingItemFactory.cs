...
[Serializable]
internal class SeeInvisibleRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private SeeInvisibleRingItemFactory(Game game) : base(game) { } // This object is a singleton.
