...
[Serializable]
internal class NenyaRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private NenyaRingItemFactory(Game game) : base(game) { } // This object is a singleton.
