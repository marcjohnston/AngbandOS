...
[Serializable]
internal class ExtraAttacksRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private ExtraAttacksRingItemFactory(Game game) : base(game) { } // This object is a singleton.
