...
[Serializable]
internal class BarahirRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private BarahirRingItemFactory(Game game) : base(game) { } // This object is a singleton.
