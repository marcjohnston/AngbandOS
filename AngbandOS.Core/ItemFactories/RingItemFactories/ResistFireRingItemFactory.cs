...
[Serializable]
internal class ResistFireRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private ResistFireRingItemFactory(Game game) : base(game) { } // This object is a singleton.
