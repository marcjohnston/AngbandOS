...
[Serializable]
internal class WeaknessRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private WeaknessRingItemFactory(Game game) : base(game) { } // This object is a singleton.
