...
[Serializable]
internal class IntelligenceRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private IntelligenceRingItemFactory(Game game) : base(game) { } // This object is a singleton.
