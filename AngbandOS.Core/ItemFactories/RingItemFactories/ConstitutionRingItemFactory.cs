...
[Serializable]
internal class ConstitutionRingItemFactory : ItemFactory
{
    ...
    public override bool NegativeBonusDamageRepresentsBroken => true;    private ConstitutionRingItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    {
        (new int[] {-1, -2}, null, new string[] { nameof(BrokenAndCursedEnchantmentScript), nameof(PoorConstitution5BP1EnchantmentScript) }),
        (new int[] {0, 1, 2}, null, new string[] { nameof(BonusConstitution5BP1EnchantmentScript) })
    };
