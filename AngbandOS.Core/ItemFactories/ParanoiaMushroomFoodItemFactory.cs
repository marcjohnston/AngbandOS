...
[Serializable]
internal class ParanoiaMushroomFoodItemFactory : ItemFactory
{
    ...
    public override string CodedName => "Paranoia";
    ...
    public override string? EatScriptName => nameof(EatParanoiaScript);
