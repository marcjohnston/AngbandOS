...
[Serializable]
internal class SmallIronChestItemFactory : ChestItemFactory
{
    private SmallIronChestItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? DescriptionSyntax => "Small iron chest~";
