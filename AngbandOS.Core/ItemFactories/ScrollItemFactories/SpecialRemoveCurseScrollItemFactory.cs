...
[Serializable]
internal class SpecialRemoveCurseScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivationBindingTuple => (nameof(SpecialRemoveAllCurseIdentifableAndUsedScript), 10);
