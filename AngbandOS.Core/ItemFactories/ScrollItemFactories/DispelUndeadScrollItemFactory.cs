...
[Serializable]
internal class DispelUndeadScrollItemFactory : ScrollItemFactory
{
    private DispelUndeadScrollItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? ActivateScrollScriptName => nameof(DispelUndead60IdentifableAndUsedScript);
}
