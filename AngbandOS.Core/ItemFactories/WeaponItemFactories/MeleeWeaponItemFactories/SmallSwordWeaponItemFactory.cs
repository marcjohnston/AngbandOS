...
[Serializable]
internal class SmallSwordWeaponItemFactory : MeleeWeaponItemFactory
{
    private SmallSwordWeaponItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? DescriptionSyntax => "Small Sword~";
