...
[Serializable]
internal class LongSwordWeaponItemFactory : MeleeWeaponItemFactory
{
    private LongSwordWeaponItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? DescriptionSyntax => "Long Sword~";
