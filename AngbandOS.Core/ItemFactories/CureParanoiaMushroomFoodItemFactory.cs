...
[Serializable]
internal class CureParanoiaMushroomFoodItemFactory : ItemFactory
{
    ...
    public override string CodedName => "Cure Paranoia";
    ...
    public override string? EatScriptName => nameof(EatCureParanoiaScript);
