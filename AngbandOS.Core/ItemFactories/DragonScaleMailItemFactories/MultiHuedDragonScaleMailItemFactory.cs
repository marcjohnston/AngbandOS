...
[Serializable]
internal class MultiHuedDragonScaleMailItemFactory : ItemFactory
{
    private MultiHuedDragonScaleMailItemFactory(Game game) : base(game) { } // This object is a singleton.
