...
[Serializable]
internal class RedDragonScaleMailItemFactory : ItemFactory
{
    private RedDragonScaleMailItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
   {
    ...
    protected override string? ActivationName => nameof(BreatheFire200r2Every1d450p450DirectionalActivation);
