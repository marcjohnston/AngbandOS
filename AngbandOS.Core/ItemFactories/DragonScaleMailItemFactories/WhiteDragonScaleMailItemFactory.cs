...
[Serializable]
internal class WhiteDragonScaleMailItemFactory : ItemFactory
{
    private WhiteDragonScaleMailItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
   {
    ...
    protected override string? DescriptionSyntax  => "White Dragon Scale Mail~";
