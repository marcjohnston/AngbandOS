...
[Serializable]
internal class BronzeDragonScaleMailItemFactory : ItemFactory
{
    private BronzeDragonScaleMailItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
   {
    ...
    protected override string? ActivationName => nameof(BallOfConfusion120r2Every1d450p450DirectionalActivation);
    ...
    protected override string? DescriptionSyntax  => "Bronze Dragon Scale Mail~";
