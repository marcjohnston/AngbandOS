...
[Serializable]
internal class BlackDragonScaleMailItemFactory : ItemFactory
{
    private BlackDragonScaleMailItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
   {
    ...
    protected override string? ActivationName => nameof(BallOfAcid130r2Every1d450p450DirectionalActivation);
    ...
    protected override string? DescriptionSyntax  => "Black Dragon Scale Mail~";
