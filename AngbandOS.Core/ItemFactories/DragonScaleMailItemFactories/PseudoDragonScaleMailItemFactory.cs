...
[Serializable]
internal class PseudoDragonScaleMailItemFactory : ItemFactory
{
    private PseudoDragonScaleMailItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
   {
    ...
    protected override string? ActivationName => nameof(BreatheLightOrDarkness200r2Every1d300p300DirectionalActivation);
    ...
    protected override string? DescriptionSyntax  => "Pseudo Dragon Scale Mail~";
