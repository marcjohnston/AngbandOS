...
[Serializable]
internal class ParalysisMushroomFoodItemFactory : ItemFactory
{
    ...
    public override string CodedName => "Paralysis";
    ...
    public override string? EatScriptName => nameof(EatParalysisScript);
