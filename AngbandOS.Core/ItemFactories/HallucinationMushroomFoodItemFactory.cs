...
[Serializable]
internal class HallucinationMushroomFoodItemFactory : ItemFactory
{
    private HallucinationMushroomFoodItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    public override string CodedName => "Hallucination";
    ...
    public override string? EatScriptName => nameof(EatHallucinationsScript);
