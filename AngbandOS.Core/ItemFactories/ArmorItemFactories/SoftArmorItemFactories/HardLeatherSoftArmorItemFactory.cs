...
[Serializable]
internal class HardLeatherSoftArmorItemFactory : ArmorItemFactory
{
    private HardLeatherSoftArmorItemFactory(Game game) : base(game) { } // This object is a singleton.

    protected override string SymbolName => nameof(OpenParenthesisSymbol);
    public override ColorEnum Color => ColorEnum.BrightBrown;
    public override string Name => "Hard Leather Armor";

    public override int ArmorClass => 6;
    public override int Cost => 150;
    public override int DamageDice => 1;
    public override int DamageSides => 1;
    protected override string? DescriptionSyntax  => "Hard Leather Armor~";
