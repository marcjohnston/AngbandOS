...
[Serializable]
internal class SoftLeatherSoftArmorItemFactory : ArmorItemFactory
{
    private SoftLeatherSoftArmorItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? DescriptionSyntax  => "Soft Leather Armor~";
