...
[Serializable]
internal class AugmentedChainMailHardArmorItemFactory : ArmorItemFactory
{
    private AugmentedChainMailHardArmorItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? DescriptionSyntax  => "Augmented Chain Mail~";
