...
[Serializable]
internal class MetalLamellarHardArmorItemFactory : ArmorItemFactory
{
    private MetalLamellarHardArmorItemFactory(Game game) : base(game) { } // This object is a singleton.
