...
[Serializable]
internal class MetalBrigandineHardArmorItemFactory : HardArmorItemFactory
{
    private MetalBrigandineHardArmorItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? DescriptionSyntax  => "Metal Brigandine Armor~";
