...
[Serializable]
internal class PartialPlateHardArmorItemFactory : ArmorItemFactory
{
    private PartialPlateHardArmorItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? DescriptionSyntax  => "Partial Plate Armor~";
