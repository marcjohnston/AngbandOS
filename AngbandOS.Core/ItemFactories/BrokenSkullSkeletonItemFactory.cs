...
[Serializable]
internal class BrokenSkullSkeletonItemFactory : ItemFactory
{
    private BrokenSkullSkeletonItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? DescriptionSyntax => "Broken Skull~";
