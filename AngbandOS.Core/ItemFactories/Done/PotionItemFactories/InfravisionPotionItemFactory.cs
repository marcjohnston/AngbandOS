...
[Serializable]
internal class InfravisionPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(Infravision1d100p100Script), null, 20);
