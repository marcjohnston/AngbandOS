...
[Serializable]
internal class DetonationsPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBinderDetails => (nameof(DetonationsScript), nameof(Explode25d25ProjectileUnfriendlyScript), 20);
