...
[Serializable]
internal class SlownessPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBinderDetails => (nameof(Slowness1D25P15Script), nameof(OldSlow5ProjectileUnfriendlyScript), 20);
