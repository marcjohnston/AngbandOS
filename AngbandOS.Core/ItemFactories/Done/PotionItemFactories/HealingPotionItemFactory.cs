...
internal class HealingPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBinderDetails => (nameof(Healing300ResetBlindnessConfusionPoisonStunAndBleedingScript), nameof(OldHeal10d10ProjectileFriendlyScript), 20);
