...
[Serializable]
internal class SoftStuddedLeatherSoftItemFactory : ItemFactory
{
    private SoftStuddedLeatherSoftItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
   {
    ...
    protected override string? DescriptionSyntax  => "Soft Studded Leather~";
