...
[Serializable]
internal class MetalCapHelmItemFactory : ItemFactory
{
    private MetalCapHelmItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
  {
    ...
    protected override string? DescriptionSyntax => "Metal Cap~";
