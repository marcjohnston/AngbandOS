...
[Serializable]
internal class HealMonsterWandItemFactory : ItemFactory
{
    ...
    protected override (string, string, int, int)? AimingBindingTuple => (nameof(HealMonsterIdentifableDirectionalScript), "1d20+8", 0, 150);
