...
[Serializable]
internal class DestroyTrapOrDoorWandItemFactory : ItemFactory
{
    ...
    protected override (string, string, int, int)? AimingBindingTuple => (nameof(DestroyTrapOrDoorIdentifableDirectionalScript), "1d8+6", 5, 150);
