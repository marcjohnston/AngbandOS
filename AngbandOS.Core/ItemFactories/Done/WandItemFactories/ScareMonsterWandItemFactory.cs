...
[Serializable]
internal class ScareMonsterWandItemFactory : ItemFactory
{
    ...
    protected override (string, string, int, int)? AimingBinderDetails => (nameof(ScareMonster10IdentifableDirectionalScript), "1d5+3", 25, 150);
