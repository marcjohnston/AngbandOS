...
[Serializable]
internal class DragonsFlameWandItemFactory : ItemFactory
{
    ...
    protected override (string, string, int, int)? AimingBinderDetails => (nameof(FireBall100R3IdentifableDirectionalScript), "1d3+1", 120, 150);
