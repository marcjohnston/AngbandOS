...
[Serializable]
internal class FireBallsWandItemFactory : ItemFactory
{
    ...
    protected override (string, string, int, int)? AimingBinderDetails => (nameof(FireBall72R2IdentifableDirectionalScript), "1d4+2", 90, 150);
