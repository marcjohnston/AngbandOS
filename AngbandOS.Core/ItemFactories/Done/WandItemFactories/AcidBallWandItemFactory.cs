...
[Serializable]
internal class AcidBallWandItemFactory : ItemFactory
{
    ...
    protected override (string, string, int, int)? AimingBindingTuple => (nameof(AcidBall60R2IdentifableDirectionalScript), "1d5+2", 83, 150);
