...
[Serializable]
internal class SmallMetalShieldItemFactory : ItemFactory
{
    private SmallMetalShieldItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
  {
    ...
    protected override string? DescriptionSyntax => "Small Metal Shield~";
