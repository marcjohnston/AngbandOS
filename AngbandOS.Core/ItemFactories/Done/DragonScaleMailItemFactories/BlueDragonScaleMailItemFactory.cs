...
[Serializable]
internal class BlueDragonScaleMailItemFactory : ItemFactory
{
    private BlueDragonScaleMailItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
  {
    ...
    protected override string? DescriptionSyntax  => "Blue Dragon Scale Mail~";
