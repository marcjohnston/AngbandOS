...
[Serializable]
internal class ChaosDragonScaleMailItemFactory : ItemFactory
{
    private ChaosDragonScaleMailItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
   {
    ...
    protected override string? DescriptionSyntax  => "Chaos Dragon Scale Mail~";
