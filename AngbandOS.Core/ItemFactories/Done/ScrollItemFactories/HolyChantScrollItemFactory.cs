...
[Serializable]
internal class HolyChantScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(Blessing1D24P12IdentifableAndUsedScript), 10);
