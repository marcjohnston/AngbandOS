...
[Serializable]
internal class ChaosScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(ChaosBall222R4IdentifableAndUsedScript), 10);
