...
[Serializable]
internal class SpecialAcquirementScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivationBindingTuple => (nameof(SpecialAcquirementIdentifableAndUsedScript), 10);
