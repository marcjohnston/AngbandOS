...
[Serializable]
internal class HolyPrayerScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivationBinderDetails => (nameof(Blessing1d48p24IdentifableAndUsedScript), 10);
