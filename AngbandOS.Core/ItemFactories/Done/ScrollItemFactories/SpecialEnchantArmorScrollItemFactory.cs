...
[Serializable]
internal class SpecialEnchantArmorScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(EnchantArmor1D3P2IdentifableAndUsedScript), 10);
