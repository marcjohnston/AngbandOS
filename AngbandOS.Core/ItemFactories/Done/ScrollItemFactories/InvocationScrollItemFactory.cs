...
[Serializable]
internal class InvocationScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(InvocationIdentifableAndUsedScript), 10);
