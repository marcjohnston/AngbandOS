...
[Serializable]
internal class DetectInvisibleScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(DetectInvisibleIdentifableAndUsedScript), 10);
