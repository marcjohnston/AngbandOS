...
[Serializable]
internal class SummonMonsterScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(SummonMonsterIdentifableAndUsedScript), 10);
