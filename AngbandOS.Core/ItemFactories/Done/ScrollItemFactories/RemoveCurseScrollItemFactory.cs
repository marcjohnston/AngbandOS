...
[Serializable]
internal class RemoveCurseScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(RemoveCurseIdentifableAndUsedScript), 10);
