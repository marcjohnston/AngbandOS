...
[Serializable]
internal class DoorStairLocationScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivationBindingTuple => (nameof(DoorStairLocationIdentifableAndUsedScript), 10);
