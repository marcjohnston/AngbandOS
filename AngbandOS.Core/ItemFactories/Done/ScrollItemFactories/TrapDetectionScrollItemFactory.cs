...
[Serializable]
internal class TrapDetectionScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(DetectTrapsIdentifableAndUsedScript), 10);
