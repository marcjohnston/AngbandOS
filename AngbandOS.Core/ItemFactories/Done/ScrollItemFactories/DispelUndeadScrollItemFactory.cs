...
[Serializable]
internal class DispelUndeadScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivationBindingTuple => (nameof(DispelUndead60IdentifableAndUsedScript), 10);
