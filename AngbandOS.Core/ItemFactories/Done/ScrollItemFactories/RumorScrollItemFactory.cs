...
[Serializable]
internal class RumorScrollItemFactory : ItemFactory
{
    private RumorScrollItemFactory(Game game) : base(game) { } // This object is a singleton
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(RumorIdentifableAndUsedScript), 10);
