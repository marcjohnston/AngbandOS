...
[Serializable]
internal class AcquirementScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(AcquirementIdentifableAndUsedScript), 10);
