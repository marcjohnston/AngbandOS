...
[Serializable]
internal class SummonUndeadScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(SummonUndeadIdentifableAndUsedScript), 10);
