...
[Serializable]
internal class MagicMappingScrollItemFactory : ItemFactory
{
    private MagicMappingScrollItemFactory(Game game) : base(game) { } // This object is a singleton
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(MagicMappingIdentifableAndUsedScript), 10);
