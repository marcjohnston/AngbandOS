...
[Serializable]
internal class SpecialEnchantWeaponScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(EnchantWeaponToDamage1D3AndToHit1D3IdentifableAndUsedScript), 10);
