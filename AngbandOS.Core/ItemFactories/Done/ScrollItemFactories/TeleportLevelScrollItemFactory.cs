...
[Serializable]
internal class TeleportLevelScrollItemFactory : ItemFactory
{
    private TeleportLevelScrollItemFactory(Game game) : base(game) { } // This object is a singleton
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(TeleportLevelIdentifableAndUsedScript), 10);
