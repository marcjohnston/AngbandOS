...
[Serializable]
internal class EnchantWeaponToHitScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(EnchantWeaponToHit1IdentifableAndUsedScript), 10);
