...
[Serializable]
internal class EnchantArmorScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(EnchantArmor1IdentifableAndUsedScript), 10);
