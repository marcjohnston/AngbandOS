...
[Serializable]
internal class MassCarnageScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(MassCarnageIdentifableAndUsedScript), 10);
