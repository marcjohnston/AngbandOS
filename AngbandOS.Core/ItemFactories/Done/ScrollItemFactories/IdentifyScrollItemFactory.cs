...
[Serializable]
internal class IdentifyScrollItemFactory : ItemFactory
{
    ...
    protected override string? FlavorSuppressedDescriptionSyntax => "Scroll~ of $Name$";    public override int Cost => 50;
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(IdentifyIdentifableAndUsedScript), 10);
