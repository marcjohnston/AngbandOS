...
[Serializable]
internal class SatisfyHungerScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(SatisfyHungerIdentifableAndUsedScript), 10);
