...
[Serializable]
internal class ObjectDetectionScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(DetectNormalObjectsIdentifableAndUsedScript), 10);
