...
[Serializable]
internal class TrapDoorDestructionScrollItemFactory : ItemFactory
{
    ...
    protected override (string, int)? ActivateScrollScriptName => (nameof(DestroyTrapsAndDoorsIdentifableAndUsedScript), 10);
