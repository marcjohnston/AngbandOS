...
[Serializable]
internal class HardLeatherBootsItemFactory : ItemFactory
{
    private HardLeatherBootsItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
   {
    ...
    protected override string? DescriptionSyntax => "Pair~ of Hard Leather Boots";
