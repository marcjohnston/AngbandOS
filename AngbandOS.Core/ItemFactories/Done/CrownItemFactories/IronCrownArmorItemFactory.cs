...
[Serializable]
internal class IronCrownItemFactory : ItemFactory
{
    private IronCrownItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? DescriptionSyntax => "Iron Crown~";
