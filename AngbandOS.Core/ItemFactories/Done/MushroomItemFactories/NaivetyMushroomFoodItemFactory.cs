...
[Serializable]
internal class NaivetyMushroomFoodItemFactory : ItemFactory
{
    private NaivetyMushroomFoodItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    public override string? EatScriptBindingKey => nameof(EatNaivetyScript);
