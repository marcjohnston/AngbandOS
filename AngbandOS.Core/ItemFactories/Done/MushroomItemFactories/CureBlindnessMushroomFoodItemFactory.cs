...
[Serializable]
internal class CureBlindnessMushroomFoodItemFactory : ItemFactory
{
    private CureBlindnessMushroomFoodItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    public override string? EatScriptBindingKey => nameof(EatCureBlindnessScript);
