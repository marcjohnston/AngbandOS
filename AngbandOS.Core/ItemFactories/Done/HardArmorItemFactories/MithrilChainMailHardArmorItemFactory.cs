...
[Serializable]
internal class MithrilChainMailHardItemFactory : ItemFactory
{
    private MithrilChainMailHardItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
  {
    ...
    protected override string? DescriptionSyntax  => "Mithril Chain Mail~";
