...
[Serializable]
internal class AdamantitePlateMailHardItemFactory : ItemFactory
{
    private AdamantitePlateMailHardItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
   {
    ...
    protected override string? DescriptionSyntax  => "Adamantite Plate Mail~";
