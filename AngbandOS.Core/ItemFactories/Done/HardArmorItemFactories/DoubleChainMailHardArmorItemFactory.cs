...
[Serializable]
internal class DoubleChainMailHardItemFactory : ItemFactory
{
    private DoubleChainMailHardItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override string? DescriptionSyntax  => "Double Chain Mail~";
