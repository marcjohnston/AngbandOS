...
[Serializable]
internal class ChainMailHardItemFactory : ItemFactory
{
    private ChainMailHardItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
   {
    ...
    protected override string? DescriptionSyntax  => "Chain Mail~";
