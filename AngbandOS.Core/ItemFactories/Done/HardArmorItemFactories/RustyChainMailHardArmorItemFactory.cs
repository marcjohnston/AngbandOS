...
[Serializable]
internal class RustyChainMailHardItemFactory : ItemFactory
{
    private RustyChainMailHardItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
  {
    ...
    protected override string? DescriptionSyntax  => "Rusty Chain Mail~";
