...
[Serializable]
internal class FullPlateHardItemFactory : ItemFactory
{
    private FullPlateHardItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
  {
    ...
    protected override string? DescriptionSyntax  => "Full Plate Armor~";
