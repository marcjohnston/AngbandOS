...
[Serializable]
internal class EmeraldsGoldItemFactory : ItemFactory
{
    private EmeraldsGoldItemFactory(Game game) : base(game) { } // This object is a singleton.

    protected override string SymbolName => nameof(DollarSignSymbol);
    public override ColorEnum Color => ColorEnum.Green;
    public override string Name => "emeralds";

    protected override string InitialGoldPiecesRollExpression => "2d32x4";
