...
[Serializable]
internal class OpalsGoldItemFactory : ItemFactory
{
    private OpalsGoldItemFactory(Game game) : base(game) { } // This object is a singleton.

    protected override string SymbolName => nameof(DollarSignSymbol);
    public override ColorEnum Color => ColorEnum.BrightWhite;
    public override string Name => "opals";

    protected override string InitialGoldPiecesRollExpression => "2d18x4";
