...
[Serializable]
internal class RecallRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBindingTuple => (nameof(RecallIdentifiedAndUsedScriptItemAndDirection), "60", false, 250);
