...
[Serializable]
internal class PerceptionRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBindingTuple => (nameof(PerceptionIdentifiedAndUsedScriptItemAndDirection), "10", false, 250);
