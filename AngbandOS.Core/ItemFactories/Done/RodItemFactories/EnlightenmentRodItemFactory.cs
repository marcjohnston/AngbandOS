...
[Serializable]
internal class EnlightenmentRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBindingTuple => (nameof(EnlightenmentIdentifiedAndUsedScriptItemAndDirection), "99", false, 250);
