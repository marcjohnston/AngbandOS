...
[Serializable]
internal class DetectionRodItemFactory : ItemFactory
{
    private DetectionRodItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (string, string, bool, int)? ZapBindingTuple => (nameof(DetectionIdentifiedAndUsedScriptItemAndDirection), "99", false, 250);
