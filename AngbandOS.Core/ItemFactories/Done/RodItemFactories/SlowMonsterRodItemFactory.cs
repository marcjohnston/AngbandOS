...
[Serializable]
internal class SlowMonsterRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBinderDetails => (nameof(SlowMonsterIdentifiedAndUsedScriptItemAndDirection), "20", true, 250);
