...
[Serializable]
internal class CuringRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBinderDetails => (nameof(CuringIdentifiedAndUsedScriptItemAndDirection), "999", false, 250);
