...
[Serializable]
internal class SleepMonsterRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBindingTuple => (nameof(SleepMonsterIdentifiedAndUsedScriptItemAndDirection), "18", true, 250);
