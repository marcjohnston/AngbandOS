...
[Serializable]
internal class AcidBallsRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBindingTuple => (nameof(AcidBall60R2IdentifiedAndUsedScriptItemAndDirection), "27", true, 250);
