...
[Serializable]
internal class DoorStairLocationRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBinderDetails => (nameof(DetectDoorsAndStairsScript), "70", false, 250);
