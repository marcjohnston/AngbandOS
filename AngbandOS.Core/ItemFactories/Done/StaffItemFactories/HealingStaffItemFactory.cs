...
[Serializable]
internal class HealingStaffItemFactory : ItemFactory
{
    ...
    protected override (string UseScriptBindingKey, string InitialChargesRollExpression, int PerChargeValue, int ManaEquivalent)? UseBindingTuple => (nameof(Healing300ResetStunAndBleedingScript), "1d2+1", 250, 100);
