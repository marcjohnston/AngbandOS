...
[Serializable]
internal class HealingRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBindingTuple => (nameof(HealingIdentifiedAndUsedScriptItemAndDirection), "999", false, 250);
