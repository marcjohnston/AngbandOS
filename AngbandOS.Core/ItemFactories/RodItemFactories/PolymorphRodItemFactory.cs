...
[Serializable]
internal class PolymorphRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBinderDetails => (nameof(PolymorphIdentifiedAndUsedScriptItemAndDirection), "25", true, 250);
