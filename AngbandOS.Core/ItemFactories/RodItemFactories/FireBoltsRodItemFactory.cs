...
[Serializable]
internal class FireBoltsRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBindingTuple => (nameof(FireBoltOrBeam8d8ProjectileScriptGenericWeightedRandom), "15", true, 250);
