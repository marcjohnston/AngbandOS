...
[Serializable]
internal class LightningBoltsRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBindingTuple => (nameof(ElectricityBoltOrBeam3d8ProjectileScriptGenericWeightedRandom), "11", true, 250);
