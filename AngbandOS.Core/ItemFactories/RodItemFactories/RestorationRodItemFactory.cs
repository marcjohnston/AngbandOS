...
[Serializable]
internal class RestorationRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBinderDetails => (nameof(RestorationIdentifiedAndUsedScriptItemAndDirection), "999", false, 250);
