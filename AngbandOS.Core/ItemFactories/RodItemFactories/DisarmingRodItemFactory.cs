...
[Serializable]
internal class DisarmingRodItemFactory : ItemFactory
{
    private DisarmingRodItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (string, string, bool, int)? ZapBinderDetails => (nameof(DisarmingIdentifiedAndUsedScriptItemAndDirection), "1d15+15", true, 250);
