...
[Serializable]
internal class IlluminationRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBindingTuple => (nameof(IlluminationIdentifiedAndUsedScriptItemAndDirection), "1d11+10", false, 250);
