...
[Serializable]
internal class ColdBallsRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBinderDetails => (nameof(ColdBall48r2IdentifiedAndUsedScriptItemAndDirection), "25", true, 250);
