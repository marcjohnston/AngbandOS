...
[Serializable]
internal class SpeedRodItemFactory : ItemFactory
{
    ...
    protected override (string, string, bool, int)? ZapBinderDetails => (nameof(SpeedIdentifiedAndUsedScriptItemAndDirection), "99", false, 250);
