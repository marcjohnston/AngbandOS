...
[Serializable]
internal class SpeedStaffItemFactory : ItemFactory
{
    ...
    protected override (string UseScriptBindingKey, string InitialChargesRollExpression, int PerChargeValue, int ManaEquivalent)? UseBindingTuple => (nameof(Speed1D30P15Or5Script), "1d3+4", 50, 100);
