...
[Serializable]
internal class DoorStairLocationStaffItemFactory : ItemFactory
{
    private DoorStairLocationStaffItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (string UseScriptBindingKey, string InitialChargesRollExpression, int PerChargeValue, int ManaEquivalent)? UseBindingTuple => (nameof(DetectDoorsAndStairsScript), "1d8+6", 18, 100);
