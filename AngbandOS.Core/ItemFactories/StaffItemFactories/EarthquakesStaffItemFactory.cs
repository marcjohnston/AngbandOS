...
[Serializable]
internal class EarthquakesStaffItemFactory : ItemFactory
{
    ...
    protected override (string UseScriptBindingKey, string InitialChargesRollExpression, int PerChargeValue, int ManaEquivalent)? UseBindingTuple => (nameof(EarthquakeR10Script), "1d5+3", 18, 100);
