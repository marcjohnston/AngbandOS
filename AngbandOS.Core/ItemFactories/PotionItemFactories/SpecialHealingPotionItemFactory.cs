...
[Serializable]
internal class SpecialHealingPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(SpecialHealingScript), nameof(OldHeal50d50ProjectileFriendlyProjectileScript), 20);
