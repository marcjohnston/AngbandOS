...
[Serializable]
internal class IntelligencePotionItemFactory : ItemFactory
{
    private IntelligencePotionItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(GainIntelligenceScript), null, 20);
