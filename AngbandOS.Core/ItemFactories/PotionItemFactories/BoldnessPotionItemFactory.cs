...
[Serializable]
internal class BoldnessPotionItemFactory : ItemFactory
{
    private BoldnessPotionItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(ResetFearScript), null, 20);
