...
[Serializable]
internal class RestoreConstitutionPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(RestoreConstitutionScript), null, 20);
