...
[Serializable]
internal class RestoreDexterityPotionItemFactory : ItemFactory
{
    private RestoreDexterityPotionItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(RestoreDexterityScript), null, 20);
