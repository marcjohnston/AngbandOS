...
[Serializable]
internal class IocainePotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(IocaineScript), nameof(DeathRayProjectileUnfriendlyProjectileScript), 20);
