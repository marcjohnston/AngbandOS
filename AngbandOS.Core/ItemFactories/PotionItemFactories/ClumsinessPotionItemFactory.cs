...
[Serializable]
internal class ClumsinessPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(LoseDexterityScript), nameof(NoProjectileMakeUnfriendlyProjectileScript), 20);
