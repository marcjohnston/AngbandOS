...
[Serializable]
internal class SaltWaterPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(SaltWaterScript), nameof(NoEffectButMakeUnfriendlyScript), 20);
