...
[Serializable]
internal class BoozePotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(BoozeScript), nameof(OldConfusionProjectileUnfriendlyScript), 20);
