...
[Serializable]
internal class WaterPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(WaterScript), nameof(NoProjectileMakeUnfriendlyProjectileScript), 20);
