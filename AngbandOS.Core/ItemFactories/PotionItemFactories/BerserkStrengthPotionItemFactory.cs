...
[Serializable]
internal class BerserkStrengthPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(SuperHeroism1D25P25ResetFearAndHeal30Script), null, 20);
