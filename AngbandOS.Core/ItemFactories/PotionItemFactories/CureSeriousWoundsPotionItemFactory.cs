...
[Serializable]
internal class CureSeriousWoundsPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(CureSeriousWounds4d8Script), nameof(OldHeal4d3ProjectileFriendlyProjectileScript), 20);
