...
[Serializable]
internal class RestoreIntelligencePotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(RestoreIntelligenceScript), null, 20);
