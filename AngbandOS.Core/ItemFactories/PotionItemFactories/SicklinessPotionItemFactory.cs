...
[Serializable]
internal class SicklinessPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(LoseConstitutionScript), nameof(NoProjectileMakeUnfriendlyProjectileScript), 20);
