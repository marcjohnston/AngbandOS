...
[Serializable]
internal class RuinationPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(RuinationScript), nameof(Explode25d25ProjectileUnfriendlyProjectileScript), 20);
