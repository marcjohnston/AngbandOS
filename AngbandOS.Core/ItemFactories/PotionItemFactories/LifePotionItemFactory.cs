...
[Serializable]
internal class LifePotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(LifeScript), nameof(OldHeal50d50ProjectileFriendlyProjectileScript), 20);
