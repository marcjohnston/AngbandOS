...
[Serializable]
internal class SpeedPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(Speed1D25P15Or5Script), nameof(SpeedProjectileFriendlyProjectileScript), 20);
