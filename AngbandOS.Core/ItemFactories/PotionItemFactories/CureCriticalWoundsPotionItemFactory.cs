...
[Serializable]
internal class CureCriticalWoundsPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(CureCriticalWounds6d8Script), nameof(OldHeal6d3ProjectileFriendlyScript), 20);
