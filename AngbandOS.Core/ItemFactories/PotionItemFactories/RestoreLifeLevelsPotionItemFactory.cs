...
[Serializable]
internal class RestoreLifeLevelsPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(RestoreLevelScript), null, 20);
