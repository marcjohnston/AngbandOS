...
[Serializable]
internal class StupidityPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(LoseIntelligenceScript), nameof(NoProjectileMakeUnfriendlyProjectileScript), 20);
