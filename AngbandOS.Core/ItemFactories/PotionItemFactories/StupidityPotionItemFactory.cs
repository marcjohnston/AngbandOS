...
[Serializable]
internal class StupidityPotionItemFactory : PotionItemFactory
{
    private StupidityPotionItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (string, string?, int)? QuaffNoticeableScriptName => (nameof(LoseIntelligenceScript), nameof(NoEffectButMakeUnfriendlyScript), 20);
}
