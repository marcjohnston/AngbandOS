...
[Serializable]
internal class AppleJuicePotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(AppleJuiceScript), nameof(NoProjectileMakeUnfriendlyProjectileScript), 20);
