...
[Serializable]
internal class CuringPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(Curing50Script), nameof(OldHeal6d3ProjectileFriendlyProjectileScript), 20);
