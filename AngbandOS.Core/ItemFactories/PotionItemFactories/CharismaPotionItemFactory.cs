...
[Serializable]
internal class CharismaPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(GainCharismaScript), nameof(NoEffectButMakeUnfriendlyScript), 20);
