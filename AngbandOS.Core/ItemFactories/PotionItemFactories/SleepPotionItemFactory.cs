...
[Serializable]
internal class SleepPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(SleepScript), nameof(OldSleepProjectileUnfriendlyProjectileScript), 20);
