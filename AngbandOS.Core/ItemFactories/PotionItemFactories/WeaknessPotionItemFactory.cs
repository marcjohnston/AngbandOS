...
[Serializable]
internal class WeaknessPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(LoseStrengthScript), nameof(NoEffectButMakeUnfriendlyScript), 20);
