...
[Serializable]
internal class NaivetyPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBindingTuple => (nameof(LoseWisdomScript), nameof(NoProjectileMakeUnfriendlyProjectileScript), 20);
