...
[Serializable]
internal class LoseMemoriesPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBinderDetails => (nameof(LoseMemoriesScript), nameof(NoEffectButMakeUnfriendlyScript), 20);
