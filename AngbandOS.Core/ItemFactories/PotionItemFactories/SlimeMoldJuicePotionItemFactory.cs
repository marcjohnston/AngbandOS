...
[Serializable]
internal class SlimeMoldJuicePotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(SlimeMoldScript), nameof(NoEffectButMakeUnfriendlyScript), 20);
