...
[Serializable]
internal class HeroismPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? QuaffBinderDetails => (nameof(Heroism1d25p25RestoreHealth10ResetFearScript), null, 20);
