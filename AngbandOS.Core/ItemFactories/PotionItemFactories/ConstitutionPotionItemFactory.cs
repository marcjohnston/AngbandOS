...
[Serializable]
internal class ConstitutionPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(GainConstitutionScript), null, 20);
