...
[Serializable]
internal class ResistColdPotionItemFactory : PotionItemFactory
{
    private ResistColdPotionItemFactory(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(ResistCold1d10p10Script), null, 20);
}
