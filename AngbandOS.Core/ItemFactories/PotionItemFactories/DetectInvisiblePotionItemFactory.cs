...
[Serializable]
internal class DetectInvisiblePotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(SeeInvisible1d12p12Script), null, 20);
