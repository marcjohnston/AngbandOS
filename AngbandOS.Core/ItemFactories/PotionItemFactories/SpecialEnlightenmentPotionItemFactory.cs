...
[Serializable]
internal class SpecialEnlightenmentPotionItemFactory : ItemFactory
{
    ...
    protected override (string, string?, int)? PotionBinderDetails => (nameof(SpecialEnlightenmentScript), null, 20);
