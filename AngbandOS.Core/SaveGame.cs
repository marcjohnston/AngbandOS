...
namespace AngbandOS
{
    ...
    internal class SaveGame
    {
        ...
        public bool PotionSmashEffect(int who, int y, int x, PotionType itemSubCategory)
        {
            int radius = 2;
            Projectile dt = null;
            int dam = 0;
            ...
            Project(who, radius, y, x, dam, dt, ProjectionFlag.ProjectJump | ProjectionFlag.ProjectItem | ProjectionFlag.ProjectKill);
            return angry;
        }
