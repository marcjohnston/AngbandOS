...
namespace AngbandOS
{
    ...
    internal class SaveGame
    {
        ...
        private void ProcessWorld()
        {
            ...
            {
                caveNoRegen = true;
                if (Player.TimedInvulnerability == 0 && Player.TimedEtherealness == 0 && (Player.Health > Player.Level / 5 || Player.Race.IsEthereal))
                {
                    string damDesc;
        ...
        public void MovePlayer(int direction, bool dontPickup)
        {
            ...
            if (Player.TimedEtherealness != 0 || Player.Race.IsEthereal)
            {
                canPassWalls = true;
        ...
        private string CreateRandomName(Race race)
        {
            return race.CreateRandomName();
        }
