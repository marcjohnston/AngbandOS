...
{
    private MakeElderSignGridTileScript(Game game) : base(game) { }
    private MakeElderSignGridTileScript(Game game, ObjectGameStateBag gameStateBag) : base(game, gameStateBag) { }
