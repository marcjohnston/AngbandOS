...
[Serializable]
internal class DestroyTrapOrDoorGridTileScript : GridTileScript
{
    private DestroyTrapOrDoorGridTileScript(Game game, GameStateBag gameStateBag) : base(game, gameStateBag) { } // This object is a singleton
