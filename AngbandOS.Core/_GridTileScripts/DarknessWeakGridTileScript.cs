...
[Serializable]
internal class DarknessWeakGridTileScript : GridTileScript
{
    private DarknessWeakGridTileScript(Game game, GameStateBag gameStateBag) : base(game, gameStateBag) { } // This object is a singleton
