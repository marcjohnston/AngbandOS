...
internal abstract class ArtifactBias : IGetKey
{
    ...
    /// <returns></returns>
    public virtual bool ApplyRandomArtifactBonuses(EffectiveAttributeSet characteristics) => false;
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public virtual bool ApplyMiscPowers(EffectiveAttributeSet characteristics) => false;
