...
{
    internal class ElvishTextWeightedRandom : WeightedRandom<string>
    {
        public ElvishTextWeightedRandom()
        {
            Add(1, "adan", "ael", "in", "agl", "ar", "aina", "alda", "al", "qua", "am", "arth", "amon", "anca", "an", "dune",
