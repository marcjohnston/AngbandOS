...
[Serializable]
internal class FireColdElectricityPoisonGasOrAcid220rm2ProjectileWeightedRandom : ProjectileWeightedRandomScript
{
    private FireColdElectricityPoisonGasOrAcid220rm2ProjectileWeightedRandom(Game game) : base(game) { }
