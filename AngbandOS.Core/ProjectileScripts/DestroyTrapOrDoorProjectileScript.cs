...
[Serializable]
internal class DestroyTrapOrDoorProjectileScript : ProjectileScript
{
    private DestroyTrapOrDoorProjectileScript(Game game) : base(game) { }
    ...
    protected override string ProjectileBindingKey => nameof(ProjectileNamesEnum.DestroyTrapOrDoorProjectile);
