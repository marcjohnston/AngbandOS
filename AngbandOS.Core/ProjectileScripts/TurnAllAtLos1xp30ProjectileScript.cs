...
[Serializable]
internal class TurnAllAtLos1xp30ProjectileScript : ProjectileScript
{
    private TurnAllAtLos1xp30ProjectileScript(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "1d1xX+30";
