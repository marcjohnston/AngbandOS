...
[Serializable]
internal class Explode230rm2ProjectileScript : ProjectileScript
{
    private Explode230rm2ProjectileScript(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "230";
