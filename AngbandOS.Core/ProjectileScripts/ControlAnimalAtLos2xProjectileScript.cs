...
[Serializable]
internal class ControlAnimalAtLos2xProjectileScript : ProjectileScript
{
    private ControlAnimalAtLos2xProjectileScript(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "1d2xX";
