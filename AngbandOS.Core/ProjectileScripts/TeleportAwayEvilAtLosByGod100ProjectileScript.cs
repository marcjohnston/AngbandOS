...
[Serializable]
internal class TeleportAwayEvilAtLosByGod100ProjectileScript : ProjectileScript
{
    private TeleportAwayEvilAtLosByGod100ProjectileScript(Game game) : base(game) { }
    ...
    public override string? PostMessage => "The power of your god banishes evil!";
}
