...
[Serializable]
internal class Disenchant220rm2ProjectileScript : ProjectileScript
{
    private Disenchant220rm2ProjectileScript(Game game) : base(game) { }
    ...
    protected override string ProjectileBindingKey => nameof(ProjectileNamesEnum.DisenchantProjectile);
