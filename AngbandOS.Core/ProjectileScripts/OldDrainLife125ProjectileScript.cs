...
[Serializable]
internal class OldDrainLife125ProjectileScript : ProjectileScript
{
    private OldDrainLife125ProjectileScript(Game game) : base(game) { }
    ...
    protected override string ProjectileBindingKey => nameof(ProjectileNamesEnum.OldDrainLifeProjectile);
    protected override string DamageRollExpression => "125";
