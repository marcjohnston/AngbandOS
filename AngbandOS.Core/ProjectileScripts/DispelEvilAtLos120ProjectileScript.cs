...
[Serializable]
internal class DispelEvilAtLos120ProjectileScript : ProjectileScript
{
    private DispelEvilAtLos120ProjectileScript(Game game) : base(game) { }
    ...
    protected override string ProjectileBindingKey => nameof(ProjectileNamesEnum.DispelEvilProjectile);
