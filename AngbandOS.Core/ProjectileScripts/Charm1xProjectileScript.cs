...
[Serializable]
internal class Charm1xProjectileScript : ProjectileScript
{
    private Charm1xProjectileScript(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "1d1*X";
}
