...
[Serializable]
internal class OldDrainLife75ProjectileScript : ProjectileScript
{
    private OldDrainLife75ProjectileScript(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "75";
