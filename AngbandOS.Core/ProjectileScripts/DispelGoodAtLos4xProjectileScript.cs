...
[Serializable]
internal class DispelGoodAtLos4xProjectileScript : ProjectileScript
{
    private DispelGoodAtLos4xProjectileScript(Game game) : base(game) { }
    ...
    protected override string ProjectileBindingKey => nameof(ProjectileNamesEnum.DispelGoodProjectile);
