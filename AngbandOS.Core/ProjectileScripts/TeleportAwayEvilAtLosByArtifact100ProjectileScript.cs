...
[Serializable]
internal class TeleportAwayEvilAtLosByArtifact100ProjectileScript : ProjectileScript
{
    private TeleportAwayEvilAtLosByArtifact100ProjectileScript(Game game) : base(game) { }
