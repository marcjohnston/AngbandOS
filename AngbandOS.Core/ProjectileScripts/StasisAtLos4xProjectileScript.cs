...
[Serializable]
internal class StasisAtLos4xProjectileScript : ProjectileScript
{
    private StasisAtLos4xProjectileScript(Game game) : base(game) { }
    ...
    protected override string ProjectileBindingKey => nameof(ProjectileNamesEnum.StasisProjectile);
