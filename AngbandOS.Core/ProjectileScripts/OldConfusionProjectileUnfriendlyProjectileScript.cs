...
[Serializable]
internal class OldConfusionProjectileUnfriendlyProjectileScript : ProjectileScript
{
    private OldConfusionProjectileUnfriendlyProjectileScript(Game game) : base(game) { }
