...
[Serializable]
internal class Shardl1d50p75r2ProjectileScript : ProjectileScript
{
    private Shardl1d50p75r2ProjectileScript(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "1d50+75";
