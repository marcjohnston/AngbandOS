...
[Serializable]
internal class OldDrainLife2xProjectileScript : ProjectileScript
{
    private OldDrainLife2xProjectileScript(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "2*X";
