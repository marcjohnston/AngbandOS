...
[Serializable]
internal class OldHeal2d3ProjectileFriendlyProjectileScript : ProjectileScript
{
    private OldHeal2d3ProjectileFriendlyProjectileScript(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "2d3";
