...
[Serializable]
internal class OldHeal50d50ProjectileFriendlyProjectileScript : ProjectileScript
{
    private OldHeal50d50ProjectileFriendlyProjectileScript(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "50d50";
