...
[Serializable]
internal class DispelLivingAtLos3xProjectileScript : ProjectileScript
{
    private DispelLivingAtLos3xProjectileScript(Game game) : base(game) { }
    ...
    protected override string ProjectileBindingKey => nameof(DispelLivingProjectile);
    protected override string DamageRollExpression => "1d3xX";
