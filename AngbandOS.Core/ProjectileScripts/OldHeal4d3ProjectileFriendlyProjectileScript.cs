...
[Serializable]
internal class OldHeal4d3ProjectileFriendlyProjectileScript : ProjectileScript
{
    private OldHeal4d3ProjectileFriendlyProjectileScript(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "4d3";
