...
[Serializable]
internal class MindFlayerFemaleRaceGender : RaceGender
{
    private MindFlayerFemaleRaceGender(Game game) : base(game) { }
    ...
    {
        (nameof(MindFlayerFemalePhysicalAttributeSet), 1)
    };
}
