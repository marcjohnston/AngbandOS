...
internal class Monster : IItemContainer, IGameSerialize
{
    ...
    public GameStateBag? Serialize(SaveGameState saveGameState)
    {
        return new DictionaryGameStateBag(
            ...
            (nameof(Race), saveGameState.CreateDerivedGameStateBag(Race, typeof(MonsterRace))),
    ...
    public Monster(Game game, RestoreGameState restoreGameState) : this(game)
    {
        ...
        Race = restoreGameState.GetByKey(nameof(Race)).GetDerivedReferenceOrDefault<MonsterRace>();
    ...
    private bool TryCastingASpellAgainstPlayer()
    {
        ...
        if (Game.IsDead || Game.NewLevelFlag)
        {
            return false;
        }
        string monsterName = Name;
    ...
    private bool MonsterCheckHitOnPlayer(int attackPower)
    {
        ...
        int ac = Game.EffectiveAttributeSet.GetInt(nameof(BaseArmorClassAttribute)) + Game.TotalBonusArmorClass;
