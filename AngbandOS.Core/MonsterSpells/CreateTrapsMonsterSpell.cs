...
namespace AngbandOS.Core.MonsterSpells
{
    ...
    internal class CreateTrapsMonsterSpell : MonsterSpell
    {
        ...
        public override void ExecuteOnPlayer(SaveGame saveGame, Monster monster)
        {
            ...
            saveGame.Project(0, 1, saveGame.Player.MapY, saveGame.Player.MapX, 0, new ProjectMakeTrap(saveGame), flg);
        }

        public override void ExecuteOnMonster(SaveGame saveGame, Monster monster, Monster target)
        {
            ProjectionFlag flg = ProjectionFlag.ProjectGrid | ProjectionFlag.ProjectItem | ProjectionFlag.ProjectHide;
            saveGame.Project(0, 1, target.MapY, target.MapX, 0, new ProjectMakeTrap(saveGame), flg);
        }
    }
}
