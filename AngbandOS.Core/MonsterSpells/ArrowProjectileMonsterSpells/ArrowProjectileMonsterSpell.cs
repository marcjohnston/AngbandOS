...
[Serializable]
internal class GenericArrowProjectileMonsterSpell : ArrowProjectileMonsterSpell
{
    protected GenericArrowProjectileMonsterSpell(Game game, ArrowProjectileMonsterSpell arrowProjectileMonsterSpell) : base(game)
    {
        IsInnate = arrowProjectileMonsterSpell.IsInnate;
        CanBeReflected = arrowProjectileMonsterSpell.CanBeReflected;
        IsAttack = arrowProjectileMonsterSpell.IsAttack;
        VsPlayerBlindMessage = arrowProjectileMonsterSpell.VsPlayerBlindMessage;
    }
