...
[Serializable]
internal class ShriekScriptMonsterSpell : ScriptMonsterSpell
{
    private ShriekScriptMonsterSpell(Game game) : base(game) { }
    ...
    public override string? ExecuteOnPlayerScriptBindingKey => nameof(ShriekMonsterSpellOnPlayerScript);
}
