...
[Serializable]
internal class DrainManaScriptMonsterSpell : ScriptMonsterSpell
{
    private DrainManaScriptMonsterSpell(Game game) : base(game) { }
    /// <summary>
    ...
    public override string? ExecuteOnPlayerScriptBindingKey => nameof(DrainManaMonsterSpellOnPlayerScript);
    public override string? ExecuteOnMonsterScriptBindingKey => nameof(DrainManaMonsterSpellOnMonsterScript);
}
