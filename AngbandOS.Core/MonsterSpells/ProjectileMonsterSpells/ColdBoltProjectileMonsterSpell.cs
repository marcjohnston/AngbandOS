...
[Serializable]
internal class ColdBoltProjectileMonsterSpell : ProjectileMonsterSpell
{
    private ColdBoltProjectileMonsterSpell(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "6d8+(ML/3)";
