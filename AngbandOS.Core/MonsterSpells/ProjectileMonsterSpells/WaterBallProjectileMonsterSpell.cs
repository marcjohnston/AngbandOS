...
[Serializable]
internal class WaterBallProjectileMonsterSpell : ProjectileMonsterSpell
{
    private WaterBallProjectileMonsterSpell(Game game) : base(game) { }
    ...
    public override string? PostExecuteOnPlayerScriptBindingKey => nameof(WaterBallMonsterSpellOnPlayerPostScript);
    public override string? PostExecuteOnMonsterScriptBindingKey => nameof(WaterBallMonsterSpellOnMonsterPostScript);
