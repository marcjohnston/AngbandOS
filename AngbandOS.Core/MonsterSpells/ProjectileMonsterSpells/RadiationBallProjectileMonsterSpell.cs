...
[Serializable]
internal class RadiationBallProjectileMonsterSpell : ProjectileMonsterSpell
{
    private RadiationBallProjectileMonsterSpell(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "ML+10d6";
