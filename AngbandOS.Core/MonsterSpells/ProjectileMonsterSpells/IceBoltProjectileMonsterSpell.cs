...
[Serializable]
internal class IceBoltProjectileMonsterSpell : ProjectileMonsterSpell
{
    private IceBoltProjectileMonsterSpell(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "6d6+ML";
