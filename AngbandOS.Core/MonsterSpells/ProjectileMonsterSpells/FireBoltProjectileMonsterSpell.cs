...
[Serializable]
internal class FireBoltProjectileMonsterSpell : ProjectileMonsterSpell
{
    private FireBoltProjectileMonsterSpell(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "9d8+(ML/3)";
