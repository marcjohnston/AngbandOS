...
[Serializable]
internal class Arrow3D6ProjectileMonsterSpell : ProjectileMonsterSpell
{
    private Arrow3D6ProjectileMonsterSpell(Game game) : base(game) { }
    ...
    protected override string DamageRollExpression => "3d6";
