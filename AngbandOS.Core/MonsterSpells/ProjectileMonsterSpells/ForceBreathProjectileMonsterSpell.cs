...
[Serializable]
internal class ForceBreathProjectileMonsterSpell : ProjectileMonsterSpell
{
    private ForceBreathProjectileMonsterSpell(Game game) : base(game) { }
    ...
    protected override string ProjectileKey => nameof(ForceProjectile);
