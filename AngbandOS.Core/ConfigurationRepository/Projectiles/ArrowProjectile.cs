...
internal class ArrowProjectile : Projectile
{
    ...
    protected override ProjectileGraphic? BoltProjectileGraphic => SaveGame.SingletonRepository.ProjectileGraphics.Get(nameof(BrightBrownBoltProjectileGraphic));
