...
[Serializable]
internal class JammedDoor4Tile : Tile
{
    private JammedDoor4Tile(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
    ...
    protected override string? OnJammedTileName => nameof(JammedDoor5Tile);
    ...
    public override int LockLevel => 4;
