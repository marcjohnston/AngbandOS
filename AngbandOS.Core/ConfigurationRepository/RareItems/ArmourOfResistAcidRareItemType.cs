...
{
    private ArmorOfResistAcidRareItem(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
    ...
    public override RareItemTypeEnum RareItemType => RareItemTypeEnum.ArmorOfResistAcid;
