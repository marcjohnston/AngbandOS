...
internal class GenericWandReadableFlavor : WandReadableFlavor
{
    public GenericWandReadableFlavor(SaveGame saveGame, ReadableFlavorDefinition readableFlavorDefninition) : base(saveGame)
    {
