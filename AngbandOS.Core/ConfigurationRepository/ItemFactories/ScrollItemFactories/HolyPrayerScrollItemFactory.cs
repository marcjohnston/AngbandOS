...
{
    private HolyPrayerScrollItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
    ...
    {
        if (SaveGame.TimedBlessing.AddTimer(SaveGame.Rng.DieRoll(48) + 24))
        {
