...
{
    private SpecialEnchantArmorScrollItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
    ...
    {
        if (!SaveGame.EnchantItem(0, 0, SaveGame.Rng.DieRoll(3) + 2))
        {
