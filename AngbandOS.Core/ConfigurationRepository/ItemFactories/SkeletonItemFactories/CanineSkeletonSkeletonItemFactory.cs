...
[Serializable]
internal class CanineSkeletonSkeletonItemFactory : SkeletonItemFactory
{
    private CanineSkeletonSkeletonItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
