...
[Serializable]
internal class DwarfSkeletonSkeletonItemFactory : SkeletonItemFactory
{
    private DwarfSkeletonSkeletonItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
