...
internal class DeathSpellVampiricDrain : Spell
{
    ...
    protected override string LearnedDetails => $"dam {Math.Max(1, SaveGame.ExperienceLevel.Value / 10)}d{SaveGame.ExperienceLevel.Value}+{SaveGame.ExperienceLevel.Value}";
}