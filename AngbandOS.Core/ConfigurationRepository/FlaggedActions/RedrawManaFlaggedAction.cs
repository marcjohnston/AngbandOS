...
internal class RedrawManaFlaggedAction : FlaggedAction
{
    ...
    private RedrawManaFlaggedAction(SaveGame saveGame) : base(saveGame) { }
    protected override void Execute()
    {
        ...
        string tmp = SaveGame.MaxMana.Value.ToString().PadLeft(5);
        ...
        else if (SaveGame.Mana.Value > SaveGame.MaxMana.Value * Constants.HitpointWarn / 5)
        {
        ...
        SaveGame.Screen.Print(color, tmp, RowCursp, ColCursp + 7);
    }
}
