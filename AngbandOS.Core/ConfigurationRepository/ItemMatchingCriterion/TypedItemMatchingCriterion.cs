...
[Serializable]
internal abstract class ItemMatchingCriteria<TItemFactory> : ItemMatchingCriteria where TItemFactory : ItemFactory
{
    protected ItemMatchingCriteria(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
