...
{
    private RestoreWisdomPotionItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
    ...
    public override bool Quaff()
    {
        ...
        return SaveGame.TryRestoringAbilityScore(Ability.Wisdom);
    }
