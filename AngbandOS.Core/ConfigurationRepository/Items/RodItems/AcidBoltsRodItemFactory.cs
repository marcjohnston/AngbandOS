...
{
    private AcidBoltsRodItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
    ...
    {
        SaveGame.FireBoltOrBeam(10, SaveGame.SingletonRepository.Projectiles.Get(nameof(AcidProjectile)), zapRodEvent.Dir.Value, SaveGame.Rng.DiceRoll(6, 8));
