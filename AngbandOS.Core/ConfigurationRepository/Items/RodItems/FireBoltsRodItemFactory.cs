...
{
    private FireBoltsRodItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
    ...
    {
        SaveGame.FireBoltOrBeam(10, SaveGame.SingletonRepository.Projectiles.Get(nameof(FireProjectile)), zapRodEvent.Dir.Value, SaveGame.Rng.DiceRoll(8, 8));
