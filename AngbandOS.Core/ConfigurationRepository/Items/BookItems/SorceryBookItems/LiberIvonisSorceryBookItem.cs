...
{
    public LiberIvonisSorceryBookItem(SaveGame saveGame) : base(saveGame, saveGame.SingletonRepository.ItemFactories.Get(nameof(LiberIvonisSorceryBookItemFactory))) { }
