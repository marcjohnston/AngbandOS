...
{
    public PnakoticManuscriptsCorporealBookItem(SaveGame saveGame) : base(saveGame, saveGame.SingletonRepository.ItemFactories.Get(nameof(PnakoticManuscriptsCorporealBookItemFactory))) { }
