...
{
    public PnakoticManuscriptsCorporealBookItem(SaveGame saveGame) : base(saveGame, saveGame.SingletonRepository.ItemFactories.Get<PnakoticManuscriptsCorporealBookItemFactory>()) { }
