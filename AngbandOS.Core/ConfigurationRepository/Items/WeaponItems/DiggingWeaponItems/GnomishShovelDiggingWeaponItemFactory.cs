...
{
    private GnomishShovelDiggingWeaponItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
    ...
    public override Item CreateItem() => new GnomishShovelDiggingWeaponItem(SaveGame);
}
