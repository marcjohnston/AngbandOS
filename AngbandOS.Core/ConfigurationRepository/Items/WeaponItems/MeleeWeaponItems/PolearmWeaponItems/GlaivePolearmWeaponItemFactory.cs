...
[Serializable]
internal class GlaivePolearmWeaponItemFactory : PolearmWeaponItemFactory
{
    private GlaivePolearmWeaponItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
