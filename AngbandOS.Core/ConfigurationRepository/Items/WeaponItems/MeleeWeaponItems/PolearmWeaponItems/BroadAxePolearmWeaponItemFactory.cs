...
{
    private BroadAxePolearmWeaponItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
    ...
    public override Item CreateItem() => new BroadAxePolearmWeaponItem(SaveGame);
}
