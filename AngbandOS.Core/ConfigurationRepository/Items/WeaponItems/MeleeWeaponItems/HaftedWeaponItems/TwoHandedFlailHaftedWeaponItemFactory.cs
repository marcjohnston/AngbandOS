...
[Serializable]
internal class TwoHandedFlailHaftedWeaponItemFactory : HaftedWeaponItemFactory
{
    private TwoHandedFlailHaftedWeaponItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
