...
[Serializable]
internal class BallAndChainHaftedWeaponItemFactory : HaftedWeaponItemFactory
{
    private BallAndChainHaftedWeaponItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
