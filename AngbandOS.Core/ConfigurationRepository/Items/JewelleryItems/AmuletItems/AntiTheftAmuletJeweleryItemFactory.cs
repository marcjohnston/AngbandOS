...
{
    private AntiTheftAmuletJeweleryItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
    ...
    public override Item CreateItem() => new AntiTheftAmuletJeweleryItem(SaveGame);
}
