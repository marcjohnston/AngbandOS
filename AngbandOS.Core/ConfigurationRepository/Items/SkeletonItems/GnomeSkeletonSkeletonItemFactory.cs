...
[Serializable]
internal class GnomeSkeletonSkeletonItemFactory : SkeletonItemFactory
{
    private GnomeSkeletonSkeletonItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
