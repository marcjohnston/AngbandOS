...
internal class AcidBoltMonsterSpell : BoltProjectileMonsterSpell
{
    ...
    protected override int Damage(Monster monster)
    {
        ...
        return SaveGame.Rng.DiceRoll(7, 8) + (monsterLevel / 3);
    }
    ...
    public override SpellResistantDetection[] SmartLearn => new SpellResistantDetection[] { SaveGame.SingletonRepository.SpellResistantDetections.Get(nameof(AcidSpellResistantDetection)), SaveGame.SingletonRepository.SpellResistantDetections.Get(nameof(ReflectSpellResistantDetection)) };
}
