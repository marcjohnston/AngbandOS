...
internal class OrbOfEntropyScript : Script, IScript
{
    ...
    public void ExecuteScript()
    {
        ...
        SaveGame.FireBall(SaveGame.SingletonRepository.Projectiles.Get(nameof(OldDrainProjectile)), dir, SaveGame.DiceRoll(3, 6) + SaveGame.ExperienceLevel + (SaveGame.ExperienceLevel / (SaveGame.BaseCharacterClass.ID == CharacterClass.Mage || SaveGame.BaseCharacterClass.ID == CharacterClass.HighMage ? 2 : 4)), SaveGame.ExperienceLevel < 30 ? 2 : 3);
    }
}
