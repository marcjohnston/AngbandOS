...
internal class ColdArtifactBiasWeightedRandom : ArtifactBiasWeightedRandom
{
    private ColdArtifactBiasWeightedRandom(Game game) : base(game) { } // This object is a singleton
