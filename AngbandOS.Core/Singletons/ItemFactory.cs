...
internal sealed class ItemFactory : IGetKey, IToJson, IGameSerialize
{
    ...
    public ItemFactory(Game game, ItemFactoryGameConfiguration gameConfiguration) 
    {
        ...
        AssignedColor = gameConfiguration.Color;
        PreassignedItemFlavorBindingKey = gameConfiguration.PreassignedItemFlavorBindingKey;
        NegativeBonusDamageRepresentsBroken = gameConfiguration.NegativeBonusDamageRepresentsBroken;
        NegativeBonusArmorClassRepresentsBroken = gameConfiguration.NegativeBonusArmorClassRepresentsBroken;
        NegativeBonusHitRepresentsBroken = gameConfiguration.NegativeBonusHitRepresentsBroken;
        SlayingRandomArtifactItemEnhancementWeightedRandomBindingKey = gameConfiguration.SlayingRandomArtifactItemEnhancementWeightedRandomBindingKey;
        RandomArtifactBonusArmorCeiling = gameConfiguration.RandomArtifactBonusArmorCeiling;
        RandomArtifactBonusHitCeiling = gameConfiguration.RandomArtifactBonusHitCeiling;
        RandomArtifactBonusDamageCeiling = gameConfiguration.RandomArtifactBonusDamageCeiling;
        RefillScriptBindingKey = gameConfiguration.RefillScriptBindingKey;
        SymbolBindingKey = gameConfiguration.SymbolBindingKey;
        CanBeWeaponOfLaw = gameConfiguration.CanBeWeaponOfLaw;
        CanBeWeaponOfSharpness = gameConfiguration.CanBeWeaponOfSharpness;
        CapableOfVorpalSlaying = gameConfiguration.CapableOfVorpalSlaying;
        UseBindingTuple = gameConfiguration.UseBindingTuple;
        QuaffBindingTuple = gameConfiguration.QuaffBindingTuple;
        AmmunitionItemFactoryBindingKeys = gameConfiguration.AmmunitionItemFactoryBindingKeys;
        CanSpikeDoorClosed = gameConfiguration.CanSpikeDoorClosed;
        CanProjectArrows = gameConfiguration.CanProjectArrows;
        EnchantmentMaximumCount = gameConfiguration.EnchantmentMaximumCount;
        IsMagical = gameConfiguration.IsMagical;
        ValuePerTurnOfLight = gameConfiguration.ValuePerTurnOfLight;
        AimingBindingTuple = gameConfiguration.AimingBindingTuple;
        InitialBrokenStomp = gameConfiguration.InitialBrokenStomp;
        InitialAverageStomp = gameConfiguration.InitialAverageStomp;
        InitialGoodStomp = gameConfiguration.InitialGoodStomp;
        InitialExcellentStomp = gameConfiguration.InitialExcellentStomp;
        RechargeScriptBindingKey = gameConfiguration.RechargeScriptBindingKey;
        IsIgnoredByMonsters = gameConfiguration.IsIgnoredByMonsters;
        IsContainer = gameConfiguration.IsContainer;
        IsGood = gameConfiguration.IsGood;
        IsRangedWeapon = gameConfiguration.IsRangedWeapon;
        MissileDamageMultiplier = gameConfiguration.MissileDamageMultiplier;
        MaxPhlogiston = gameConfiguration.MaxPhlogiston;
        MassProduceBindingTuples = gameConfiguration.MassProduceBindingTuples;
        BreaksDuringEnchantmentProbabilityExpression = gameConfiguration.BreaksDuringEnchantmentProbabilityExpression;
        EnchantmentBindingTuples = gameConfiguration.EnchantmentBindingTuples;
        EatMagicScriptBindingKey = gameConfiguration.EatMagicScriptBindingKey;
        GridProcessWorldScriptBindingKey = gameConfiguration.GridProcessWorldScriptBindingKey;
        MonsterProcessWorldScriptBindingKey = gameConfiguration.MonsterProcessWorldScriptBindingKey;
        EquipmentProcessWorldScriptBindingKey = gameConfiguration.EquipmentProcessWorldScriptBindingKey;
        PackProcessWorldScriptBindingKey = gameConfiguration.PackProcessWorldScriptBindingKey;
        BreakageChanceProbabilityExpression = gameConfiguration.BreakageChanceProbabilityExpression;
        MakeObjectCountExpression = gameConfiguration.MakeObjectCountExpression;
        GetsDamageMultiplier = gameConfiguration.GetsDamageMultiplier;
        IdentityCanBeSensed = gameConfiguration.IdentityCanBeSensed;
        IsArmor = gameConfiguration.IsArmor;
        IsWeapon = gameConfiguration.IsWeapon;
        NumberOfItemsContained = gameConfiguration.NumberOfItemsContained;
        Name = gameConfiguration.Name;
        DescriptionSyntax = gameConfiguration.DescriptionSyntax;
        AlternateDescriptionSyntax = gameConfiguration.AlternateDescriptionSyntax;
        FlavorSuppressedDescriptionSyntax = gameConfiguration.FlavorSuppressedDescriptionSyntax;
        AlternateFlavorSuppressedDescriptionSyntax = gameConfiguration.AlternateFlavorSuppressedDescriptionSyntax;
        FlavorUnknownDescriptionSyntax = gameConfiguration.FlavorUnknownDescriptionSyntax;
        AlternateFlavorUnknownDescriptionSyntax = gameConfiguration.AlternateFlavorUnknownDescriptionSyntax;
        ZapBindingTuple = gameConfiguration.ZapBindingTuple;
        ItemClassBindingKey = gameConfiguration.ItemClassBindingKey;
        PackSort = gameConfiguration.PackSort;
        WieldSlotBindingKeys = gameConfiguration.WieldSlotBindingKeys;
        AskDestroyAll = gameConfiguration.AskDestroyAll;
        HasQualityRatings = gameConfiguration.HasQualityRatings;
        DepthsFoundAndChances = gameConfiguration.DepthsFoundAndChances;
        LevelNormallyFound = gameConfiguration.LevelNormallyFound;
        InitialBonusAttacks = gameConfiguration.InitialBonusAttacks;
        InitialBonusInfravision = gameConfiguration.InitialBonusInfravision;
        InitialBonusSpeed = gameConfiguration.InitialBonusSpeed;
        InitialBonusSearchExpression = gameConfiguration.InitialBonusSearchExpression;
        InitialBonusStealthExpression = gameConfiguration.InitialBonusStealthExpression;
        InitialBonusTunnel = gameConfiguration.InitialBonusTunnel;
        InitialTurnsOfLight = gameConfiguration.InitialTurnsOfLight;
        InitialNutritionalValue = gameConfiguration.InitialNutritionalValue;
        InitialGoldPiecesRollExpression = gameConfiguration.InitialGoldPiecesRollExpression;
        ExperienceGainDivisorForDestroying = gameConfiguration.ExperienceGainDivisorForDestroying;
        SpellBindingKeys = gameConfiguration.SpellBindingKeys;
        IsSmall = gameConfiguration.IsSmall;
        BaseValue = gameConfiguration.BaseValue;
        CanProvideSheathOfElectricity = gameConfiguration.CanProvideSheathOfElectricity;
        CanProvideSheathOfFire = gameConfiguration.CanProvideSheathOfFire;
        RandartActivationChance = gameConfiguration.RandartActivationChance;
        ProvidesSunlight = gameConfiguration.ProvidesSunlight;
        CanApplyArtifactBiasResistance = gameConfiguration.CanApplyArtifactBiasResistance;
        CanBeEatenByMonsters = gameConfiguration.CanBeEatenByMonsters;
        EatScriptBindingKey = gameConfiguration.EatScriptBindingKey;
        VanishesWhenEatenBySkeletons = gameConfiguration.VanishesWhenEatenBySkeletons;
        IsConsumedWhenEaten = gameConfiguration.IsConsumedWhenEaten;
        ReadBindingTuple = gameConfiguration.ReadBindingTuple;
        DisableStomp = gameConfiguration.DisableStomp;
        EnhancementFixedArtifactFactoriesBindingKeys = gameConfiguration.EnhancementFixedArtifactFactoriesBindingKeys;
    }
    #endregion

    #region State Data - Read/write fields.
    /// <summary>
    /// Returns true, if the flavor for this factory has been identified or if the factory doesn't use flavors; false, when the factory uses flavors and
    ...
    /// <summary>
    /// Returns the character that is used to display items of this type.  This character is initially set by the configuration for this <see cref="ItemFactory"/>, but 
    /// flavors may override this symbol and replace it with a different symbol from the flavor.
    /// </summary>
    /// <remarks>
    /// This is state data.
    /// </remarks>
    ...
    /// <summary>
    /// Returns the color to be used for items generated by this factory.  This color is initially set by the configuration for this <see cref="ItemFactory"/>, but flavors
    /// may override this color and replace it with a different color from the flavor.
    /// </summary>
    /// <remarks>
    /// This is state data.
    /// </remarks>
    ...
    /// Use the <see cref="StompableTypeEnum"/> to address each index.
    /// </summary>
    /// <remarks>
    /// This is state data.
    /// </remarks>
    ...
    public void Bind(RestoreGameState? restoreGameState)
    {
        ...
        #region Cached Property Initialization - Non-State Data
