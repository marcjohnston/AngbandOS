...
[Serializable]
internal sealed class Realm : IGetKey, IToJson, IGameSerialize
{
    #region Constructor
    ...
    private string[] SpellBookNames { get; }
    ...
    public bool ResistantToHolyAndHellProjectiles { get; } = false;
    ...
    /// </summary>
    /// <value><c>true</c> if [resistant to hell fire]; otherwise, <c>false</c>.</value>
    public bool SusceptibleToHolyAndHellProjectiles { get; } = false;
