...
internal sealed class MonsterRace : IMonsterCharacteristics, IGetKey, IToJson, IIndexedSingletons, IGameSerialize
{
    ...
    public MonsterRace(Game game, MonsterRaceGameConfiguration gameConfiguration)
    {
        Game = game;
        // 102 Properties
        ...
        MultilineName = gameConfiguration.MultilineName;
        Color = gameConfiguration.Color;
        Animal = gameConfiguration.Animal;
        ArmorClass = gameConfiguration.ArmorClass;
        AttackDefinitions = gameConfiguration.AttackDefinitions;
        AttrAny = gameConfiguration.AttrAny;
        AttrClear = gameConfiguration.AttrClear;
        AttrMulti = gameConfiguration.AttrMulti;
        BashDoor = gameConfiguration.BashDoor;
        CharClear = gameConfiguration.CharClear;
        CharMulti = gameConfiguration.CharMulti;
        ColdBlood = gameConfiguration.ColdBlood;
        Cthuloid = gameConfiguration.Cthuloid;
        Demon = gameConfiguration.Demon;
        Description = gameConfiguration.Description;
        Dragon = gameConfiguration.Dragon;
        Drop_1D2 = gameConfiguration.Drop_1D2;
        Drop_2D2 = gameConfiguration.Drop_2D2;
        Drop_3D2 = gameConfiguration.Drop_3D2;
        Drop_4D2 = gameConfiguration.Drop_4D2;
        Drop60 = gameConfiguration.Drop60;
        Drop90 = gameConfiguration.Drop90;
        DropGood = gameConfiguration.DropGood;
        DropGreat = gameConfiguration.DropGreat;
        EldritchHorror = gameConfiguration.EldritchHorror;
        EmptyMind = gameConfiguration.EmptyMind;
        Escorted = gameConfiguration.Escorted;
        EscortsGroup = gameConfiguration.EscortsGroup;
        Evil = gameConfiguration.Evil;
        Female = gameConfiguration.Female;
        FireAura = gameConfiguration.FireAura;
        ForceMaxHp = gameConfiguration.ForceMaxHp;
        ForceSleep = gameConfiguration.ForceSleep;
        FreqInate = gameConfiguration.FreqInate;
        FreqSpell = gameConfiguration.FreqSpell;
        FriendlyName = gameConfiguration.FriendlyName;
        Friends = gameConfiguration.Friends;
        Giant = gameConfiguration.Giant;
        GoldItemFactoryBindingKey = gameConfiguration.GoldItemFactoryBindingKey;
        Good = gameConfiguration.Good;
        GreatOldOne = gameConfiguration.GreatOldOne;
        HasLegs = gameConfiguration.HasLegs;
        Hdice = gameConfiguration.Hdice;
        Hside = gameConfiguration.Hside;
        HurtByCold = gameConfiguration.HurtByCold;
        HurtByFire = gameConfiguration.HurtByFire;
        HurtByLight = gameConfiguration.HurtByLight;
        HurtByRock = gameConfiguration.HurtByRock;
        ImmuneAcid = gameConfiguration.ImmuneAcid;
        ImmuneCold = gameConfiguration.ImmuneCold;
        ImmuneConfusion = gameConfiguration.ImmuneConfusion;
        ImmuneFear = gameConfiguration.ImmuneFear;
        ImmuneFire = gameConfiguration.ImmuneFire;
        ImmuneLightning = gameConfiguration.ImmuneLightning;
        ImmunePoison = gameConfiguration.ImmunePoison;
        ImmuneSleep = gameConfiguration.ImmuneSleep;
        ImmuneStun = gameConfiguration.ImmuneStun;
        Invisible = gameConfiguration.Invisible;
        KillBody = gameConfiguration.KillBody;
        KillItem = gameConfiguration.KillItem;
        KillWall = gameConfiguration.KillWall;
        LevelFound = gameConfiguration.LevelFound;
        LightningAura = gameConfiguration.LightningAura;
        Male = gameConfiguration.Male;
        Mexp = gameConfiguration.Mexp;
        MoveBody = gameConfiguration.MoveBody;
        Multiply = gameConfiguration.Multiply;
        NeverAttack = gameConfiguration.NeverAttack;
        NeverMove = gameConfiguration.NeverMove;
        Nonliving = gameConfiguration.Nonliving;
        NoticeRange = gameConfiguration.NoticeRange;
        OnlyDropGold = gameConfiguration.OnlyDropGold;
        OnlyDropItem = gameConfiguration.OnlyDropItem;
        ...
        Reaver = gameConfiguration.Reaver;
        Reflecting = gameConfiguration.Reflecting;
        Regenerate = gameConfiguration.Regenerate;
        ResistDisenchant = gameConfiguration.ResistDisenchant;
        ResistNether = gameConfiguration.ResistNether;
        ResistNexus = gameConfiguration.ResistNexus;
        ResistPlasma = gameConfiguration.ResistPlasma;
        ResistTeleport = gameConfiguration.ResistTeleport;
        ResistWater = gameConfiguration.ResistWater;
        Shapechanger = gameConfiguration.Shapechanger;
        Sleep = gameConfiguration.Sleep;
        Smart = gameConfiguration.Smart;
        Speed = gameConfiguration.Speed;
        Stupid = gameConfiguration.Stupid;
        TakeItem = gameConfiguration.TakeItem;
        Troll = gameConfiguration.Troll;
        Undead = gameConfiguration.Undead;
        Unique = gameConfiguration.Unique;
        WeirdMind = gameConfiguration.WeirdMind;
    }
