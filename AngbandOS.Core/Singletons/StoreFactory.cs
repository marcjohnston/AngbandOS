...
[Serializable]
internal sealed class StoreFactory : IItemFilter, IGetKey, IToJson, IGameSerialize
{
    private Game Game { get; }
    public StoreFactory(Game game, StoreFactoryGameConfiguration gameConfiguration)
    {
        Game = game;
        Key = gameConfiguration.GetKey;
        IsEmptyLot = gameConfiguration.IsEmptyLot;
        BuildingsMadeFromPermanentRock = gameConfiguration.BuildingsMadeFromPermanentRock;
        StoreEntranceDoorsAreBlownOff = gameConfiguration.StoreEntranceDoorsAreBlownOff;
        PageSize = gameConfiguration.PageSize;
        UseHomeCarry = gameConfiguration.UseHomeCarry;
        ItemFilterNames = gameConfiguration.ItemFilterNames;
        IsHomeThatCanBeBought = gameConfiguration.IsHomeThatCanBeBought;
        MaintainsStockLevels = gameConfiguration.MaintainsStockLevels;
        MaxInventory = gameConfiguration.MaxInventory;
        MinInventory = gameConfiguration.MinInventory;
        StoreTurnover = gameConfiguration.StoreTurnover;
        StoreStockManifestDefinitions = gameConfiguration.StoreStockManifestDefinitions?.Select(_storeStockManifestDefinition => (_storeStockManifestDefinition.ItemFactoryName, _storeStockManifestDefinition.Weight)).ToArray();
        ShufflesOwnersAndPricing = gameConfiguration.ShufflesOwnersAndPricing;
        ShopkeeperNames = gameConfiguration.ShopkeeperNames;
        AdvertisedStoreCommand1Name = gameConfiguration.AdvertisedStoreCommand1Name;
        AdvertisedStoreCommand2Name = gameConfiguration.AdvertisedStoreCommand2Name;
        AdvertisedStoreCommand3Name = gameConfiguration.AdvertisedStoreCommand3Name;
        AdvertisedStoreCommand4Name = gameConfiguration.AdvertisedStoreCommand4Name;
        AdvertisedStoreCommand5Name = gameConfiguration.AdvertisedStoreCommand5Name;
        WidthOfDescriptionColumn = gameConfiguration.WidthOfDescriptionColumn;
        RenderWeightUnitOfMeasurement = gameConfiguration.RenderWeightUnitOfMeasurement;
        TileName = gameConfiguration.TileName;
        ItemsRenderFlavorAware = gameConfiguration.ItemsRenderFlavorAware;
        OwnerName = gameConfiguration.OwnerName;
        Title = gameConfiguration.Title;
        StoreMaintainsInventory = gameConfiguration.StoreMaintainsInventory;
        ShowItemPricing = gameConfiguration.ShowItemPricing;
        MarkupRate = gameConfiguration.MarkupRate;
        MarkdownRate = gameConfiguration.MarkdownRate;
        PerformsMaintenanceWhenResting = gameConfiguration.PerformsMaintenanceWhenResting;
        LevelForRandomItemCreation = gameConfiguration.LevelForRandomItemCreation;
        MinimumItemValue = gameConfiguration.MinimumItemValue;
        NoStockMessage = gameConfiguration.NoStockMessage;
        PurchaseMessage = gameConfiguration.PurchaseMessage;
        StoreSellsItems = gameConfiguration.StoreSellsItems;
        BoughtMessageAsBoughtBack = gameConfiguration.BoughtMessageAsBoughtBack;
        SellPrompt = gameConfiguration.SellPrompt;
        StoreFullMessage = gameConfiguration.StoreFullMessage;
        StoreMaintainsInscription = gameConfiguration.StoreMaintainsInscription;
        StoreBuysItems = gameConfiguration.StoreBuysItems;
        BoughtVerb = gameConfiguration.BoughtVerb;
        StoreIdentifiesItems = gameConfiguration.StoreIdentifiesItems;
