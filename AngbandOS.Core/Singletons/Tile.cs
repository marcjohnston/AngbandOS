...
[Serializable]
internal sealed class Tile : IGetKey, IToJson, IGameSerialize
{
    ...
    public Tile(Game game, TileGameConfiguration gameConfiguration)
    {
        ...
        AllowMonsterToOccupy = gameConfiguration.AllowMonsterToOccupy;
        AlterActionName = gameConfiguration.AlterActionName;
        BlocksLos = gameConfiguration.BlocksLos;
        BlocksScent = gameConfiguration.BlocksScent;
        CanBeClosed = gameConfiguration.CanBeClosed;
        Color = gameConfiguration.Color;
        Description = gameConfiguration.Description;
        DimsOutsideLOS = gameConfiguration.DimsOutsideLOS;
        HasWater = gameConfiguration.HasWater;
        HiddenTreasureForTileName = gameConfiguration.HiddenTreasureForTileName;
        IsBasicWall = gameConfiguration.IsBasicWall;
        IsBorder = gameConfiguration.IsBorder;
        IsBrokenDoor = gameConfiguration.IsBrokenDoor;
        IsBush = gameConfiguration.IsBush;
        IsClosedDoor = gameConfiguration.IsClosedDoor;
        IsDownStaircase = gameConfiguration.IsDownStaircase;
        IsEarthquakeResistant = gameConfiguration.IsEarthquakeResistant;
        IsElderSignSigil = gameConfiguration.IsElderSignSigil;
        IsGrass = gameConfiguration.IsGrass;
        IsInteresting = gameConfiguration.IsInteresting;
        IsInvisibleTrap = gameConfiguration.IsInvisibleTrap;
        IsJammedClosedDoor = gameConfiguration.IsJammedClosedDoor;
        IsMagma = gameConfiguration.IsMagma;
        IsOpenDoor = gameConfiguration.IsOpenDoor;
        IsOpenFloor = gameConfiguration.IsOpenFloor;
        IsPassable = gameConfiguration.IsPassable;
        IsPath = gameConfiguration.IsPath;
        IsPathBase = gameConfiguration.IsPathBase;
        IsPermanent = gameConfiguration.IsPermanent;
        IsPillar = gameConfiguration.IsPillar;
        IsRevealedWithDetectStairsScript = gameConfiguration.IsRevealedWithDetectStairsScript;
        IsRock = gameConfiguration.IsRock;
        IsRubble = gameConfiguration.IsRubble;
        IsSecretDoor = gameConfiguration.IsSecretDoor;
        IsShop = gameConfiguration.IsShop;
        IsTrap = gameConfiguration.IsTrap;
        IsTrapDoor = gameConfiguration.IsTrapDoor;
        IsTreasure = gameConfiguration.IsTreasure;
        IsTree = gameConfiguration.IsTree;
        IsUnidentifiedTrap = gameConfiguration.IsUnidentifiedTrap;
        IsUpStaircase = gameConfiguration.IsUpStaircase;
        IsVein = gameConfiguration.IsVein;
        IsVisibleDoor = gameConfiguration.IsVisibleDoor;
        IsVisibleTreasure = gameConfiguration.IsVisibleTreasure;
        IsWall = gameConfiguration.IsWall;
        IsWallOuter = gameConfiguration.IsWallOuter;
        IsWallPermanentOuter = gameConfiguration.IsWallPermanentOuter;
        IsWallPermanentSolid = gameConfiguration.IsWallPermanentSolid;
        IsWallSolid = gameConfiguration.IsWallSolid;
        IsWater = gameConfiguration.IsWater;
        IsWildPath = gameConfiguration.IsWildPath;
        IsYellowSignSigil = gameConfiguration.IsYellowSignSigil;
        LockLevel = gameConfiguration.LockLevel;
        MapPriority = gameConfiguration.MapPriority;
        MimicTileName = gameConfiguration.MimicTileName;
        OnJammedTileName = gameConfiguration.OnJammedTileName;
        RunPast = gameConfiguration.RunPast;
        StepOnScriptName = gameConfiguration.StepOnScriptName;
        SymbolName = gameConfiguration.SymbolName;
        VisibleTreasureForTileName = gameConfiguration.VisibleTreasureForTileName;
