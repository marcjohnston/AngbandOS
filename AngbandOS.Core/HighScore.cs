...
namespace AngbandOS
{
    ...
    internal class HighScore
    {
        ...
        public HighScore(SaveGame saveGame)
        {
            ...
            Who = $"{saveGame.Player.Name.Trim()}{saveGame.Player.Generation.ToRoman(true)} the level {saveGame.Player.Level} {saveGame.Races[saveGame.Player.RaceIndex].Title} {Profession.ClassSubName(saveGame.Player.ProfessionIndex, saveGame.Player.Realm1)}";
