...
internal class MageArtifactBias : ArtifactBias
{
    ...
    public override Activation GetActivationPowerType()
    {
        ...
        {
            return Game.SingletonRepository.Get<Activation>(nameof(SummonFriendlyElemental2In3Activation));
        }
        else if (Game.DieRoll(10) == 1)
        {
            return Game.SingletonRepository.Get<Activation>(nameof(SummonFriendlyPhantomActivation));
        }
