...
[Serializable]
internal class GenericTimeWidget : TimeWidget
{
    public GenericTimeWidget(Game game, TimeWidgetGameConfiguration timeWidgetGameConfiguration) : base(game)
    {
    ...
    public override string DateAndTimeValueName { get; }
