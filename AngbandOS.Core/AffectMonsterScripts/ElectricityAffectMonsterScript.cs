...
[Serializable]
internal class ElectricityAffectMonsterScript : AffectMonsterScript
{
    private ElectricityAffectMonsterScript(Game game) : base(game) { } // This object is a singleton.
