...
[Serializable]
internal class DestroyTrapOrDoorAffectMonsterScript : AffectMonsterScript
{
    private DestroyTrapOrDoorAffectMonsterScript(Game game) : base(game) { } // This object is a singleton.
