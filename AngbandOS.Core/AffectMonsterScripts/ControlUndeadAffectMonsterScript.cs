...
[Serializable]
internal class ControlUndeadAffectMonsterScript : AffectMonsterScript
{
    private ControlUndeadAffectMonsterScript(Game game) : base(game) { } // This object is a singleton.
