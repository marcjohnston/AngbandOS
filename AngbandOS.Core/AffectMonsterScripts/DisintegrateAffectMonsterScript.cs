...
[Serializable]
internal class DisintegrateAffectMonsterScript : AffectMonsterScript
{
    private DisintegrateAffectMonsterScript(Game game) : base(game) { } // This object is a singleton.
