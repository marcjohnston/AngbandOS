...
[Serializable]
internal class ControlAnimalAffectMonsterScript : AffectMonsterScript
{
    private ControlAnimalAffectMonsterScript(Game game) : base(game) { } // This object is a singleton.
