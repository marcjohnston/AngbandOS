...
[Serializable]
internal class OldDrainLifeAffectMonsterScript : AffectMonsterScript
{
    private OldDrainLifeAffectMonsterScript(Game game) : base(game) { } // This object is a singleton.
