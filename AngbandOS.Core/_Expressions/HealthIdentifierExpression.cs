...
{
    public HealthIdentifierExpression(string matchedIdentifier, bool? sign = null) : base(matchedIdentifier, sign) { }
    ...
    {
        Func<int> getHealth = (Func<int>)providers[nameof(ExpressionProvidersEnum.GetHealth)];
