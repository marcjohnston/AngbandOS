...
[Serializable]
internal class VampirismTrueDeathSpell : Spell
{
    private VampirismTrueDeathSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(VampirismTrueScript) };
