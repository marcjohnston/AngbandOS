...
[Serializable]
internal class NetherBoltDeathSpell : Spell
{
    private NetherBoltDeathSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(NetherBoltScript) };
