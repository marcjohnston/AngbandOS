...
[Serializable]
internal class HorrifyDeathSpell : Spell
{
    private HorrifyDeathSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(HorrifyScript) };
