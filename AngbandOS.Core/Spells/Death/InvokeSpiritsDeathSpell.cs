...
[Serializable]
internal class InvokeSpiritsDeathSpell : Spell
{
    private InvokeSpiritsDeathSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(InvokeSpiritsScript) };
