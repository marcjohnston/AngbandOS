...
[Serializable]
internal class StinkingCloudDeathSpell : Spell
{
    private StinkingCloudDeathSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(StinkingCloudScript) };
