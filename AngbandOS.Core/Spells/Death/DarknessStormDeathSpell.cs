...
[Serializable]
internal class DarknessStormDeathSpell : Spell
{
    private DarknessStormDeathSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(DarknessStormScript) };
