...
[Serializable]
internal class HellfireDeathSpell : Spell
{
    private HellfireDeathSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(HellfireScript) };
