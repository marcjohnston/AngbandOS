...
[Serializable]
internal class CarnageDeathSpell : Spell
{
    private CarnageDeathSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(GenocideScript) };
