...
[Serializable]
internal class ResistPoisonDeathSpell : Spell
{
    private ResistPoisonDeathSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(ResistPoisonScript) };
