...
[Serializable]
internal class ChainLightningChaosSpell : Spell
{
    private ChainLightningChaosSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(ChainLightingScript) };
