...
[Serializable]
internal class CallChaosChaosSpell : Spell
{
    private CallChaosChaosSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(CallChaosCancellableScript) };
