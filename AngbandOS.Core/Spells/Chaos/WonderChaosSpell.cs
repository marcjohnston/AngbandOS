...
[Serializable]
internal class WonderChaosSpell : Spell
{
    private WonderChaosSpell(Game game) : base(game) { }
    protected override string[]? CastScriptNames => new string[] { nameof(SpellOfWonderScript) };
