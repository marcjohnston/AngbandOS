...
[Serializable]
internal class DragonsBreatheProjectileScriptGenericWeightedRandom : ProjectileScriptGenericWeightedRandom
{
    private DragonsBreatheProjectileScriptGenericWeightedRandom(Game game) : base(game) { }
