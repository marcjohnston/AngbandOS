...
[Serializable]
internal class CharmMonsterEffect : MonsterEffect
{
    private CharmMonsterEffect(Game game) : base(game) { } // This object is a singleton.
    ...
    protected override IdentifiedResultEnum Apply(int who, Monster mPtr, int dam, int r)
    {
        ...
        bool obvious = false;
        string? note = null;
        dam += Game.SingletonRepository.Get<Ability>(nameof(CharismaAbility)).ConRecoverySpeed - 1;
        if (seen)
        {
            obvious = true;
        }
