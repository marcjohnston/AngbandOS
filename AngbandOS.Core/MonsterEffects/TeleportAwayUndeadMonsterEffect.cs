...
[Serializable]
internal class TeleportAwayUndeadMonsterEffect : AffectMonsterScript
{
    private TeleportAwayUndeadMonsterEffect(Game game) : base(game) { } // This object is a singleton.
