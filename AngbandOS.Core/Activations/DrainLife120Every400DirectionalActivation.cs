...
/// </summary>
[Serializable]
internal class DrainLife120Every400DirectionalActivation : Activation
{
    ...
    protected override string ActivationCancellableScriptItemBindingKey => nameof(OldDrainLife120ProjectileScript);
