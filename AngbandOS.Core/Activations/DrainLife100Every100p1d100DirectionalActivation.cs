...
/// </summary>
[Serializable]
internal class DrainLife100Every100p1d100DirectionalActivation : Activation
{
    ...
    protected override string ActivationCancellableScriptItemBindingKey => nameof(OldDrainLife100ProjectileScript);
