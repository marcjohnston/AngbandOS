...
[Serializable]
internal class BallOfElements300r3DirectionalActivation : Activation
{
    ...
    protected override string ActivationCancellableScriptItemBindingKey => nameof(Missle300rm3ProjectileScript);
