...
[Serializable]
internal class LargeBallFire72Every100DirectionalActivation : Activation
{
    ...
    protected override string ActivationCancellableScriptItemBindingKey => nameof(Fire72r3ProjectileScript);
