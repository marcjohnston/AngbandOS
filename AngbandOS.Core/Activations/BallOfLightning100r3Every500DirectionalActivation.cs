...
/// </summary>
[Serializable]
internal class BallOfLightning100r3Every500DirectionalActivation : Activation
{
    ...
    protected override string ActivationCancellableScriptItemBindingKey => nameof(Electricity100r3ProjectileScript);
