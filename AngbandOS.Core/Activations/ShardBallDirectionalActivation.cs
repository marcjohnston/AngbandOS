...
/// </summary>
[Serializable]
internal class ShardBallDirectionalActivation : Activation
{
    private ShardBallDirectionalActivation(Game game) : base(game) { }
    
    protected override string RechargeTimeRollExpression => "400";

    protected override string ActivationCancellableScriptItemBindingKey => nameof(Shard1xp120r2ProjectileScript);
