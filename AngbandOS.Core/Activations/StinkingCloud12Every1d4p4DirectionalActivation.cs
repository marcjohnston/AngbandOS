...
/// </summary>
[Serializable]
internal class StinkingCloud12Every1d4p4DirectionalActivation : Activation
{
    ...
    protected override string ActivationCancellableScriptItemBindingKey => nameof(Poison12r3ProjectileScript);
