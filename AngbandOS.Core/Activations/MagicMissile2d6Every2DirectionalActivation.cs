...
/// </summary>
[Serializable]
internal class MagicMissile2d6Every2DirectionalActivation : Activation
{
    private MagicMissile2d6Every2DirectionalActivation(Game game) : base(game) { }
    ...
    protected override string ActivationCancellableScriptItemBindingKey => nameof(Missile2d6ProjectileScript);
