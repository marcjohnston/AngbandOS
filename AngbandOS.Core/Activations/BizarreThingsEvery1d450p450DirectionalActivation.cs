...
[Serializable]
internal class BizarreThingsEvery1d450p450DirectionalActivation : Activation
{
    ...
    protected override string ActivationCancellableScriptItemBindingKey => nameof(BizarreThingsScript);
