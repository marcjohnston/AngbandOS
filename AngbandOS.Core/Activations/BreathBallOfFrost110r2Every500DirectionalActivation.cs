...
[Serializable]
internal class BreathBallOfFrost110r2Every500DirectionalActivation : Activation
{
    ...
    protected override string ActivationCancellableScriptItemBindingKey => nameof(Cold110rm2ProjectileScript);
