...
[Serializable]
internal class PowerDragonEvery400DirectionalActivation : Activation
{
    private PowerDragonEvery400DirectionalActivation(Game game) : base(game) { }
    ...
    protected override string ActivationCancellableScriptItemBindingKey => nameof(PowerDragonScript);
