...
[Serializable]
internal class ShopkeepersRepositoryCollection : DictionaryRepositoryCollection<string, Shopkeeper>
{
    public ShopkeepersRepositoryCollection(SaveGame saveGame) : base(saveGame) { }
