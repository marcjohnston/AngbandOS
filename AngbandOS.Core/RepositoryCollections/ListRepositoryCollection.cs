...
/// <summary>
/// Represents a RepositoryCollection that uses an internal List<> object to track objects in the repository.  Items in a List
/// repository do not participate in the Loaded phase of the repository life cycle.
/// </summary>
/// <typeparam name="T"></typeparam>
[Serializable]
internal abstract class ListRepositoryCollection<T> : RepositoryCollection<T>
{
    private List<T> list = new List<T>();

    protected ListRepositoryCollection(SaveGame saveGame) : base(saveGame) { }
