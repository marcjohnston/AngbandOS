...
[Serializable]
internal class ShieldOfResistColdItemEnhancement : ItemEnhancement
{
    private ShieldOfResistColdItemEnhancement(Game game) : base(game) { } // This object is a singleton.
