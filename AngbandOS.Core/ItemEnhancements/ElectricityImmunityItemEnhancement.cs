...
[Serializable]
internal class ElectricityImmunityItemEnhancement : ItemEnhancement
{
    private ElectricityImmunityItemEnhancement(Game game) : base(game) { } // This object is a singleton.
