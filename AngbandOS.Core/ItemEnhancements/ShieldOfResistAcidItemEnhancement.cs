...
[Serializable]
internal class ShieldOfResistAcidItemEnhancement : ItemEnhancement
{
    private ShieldOfResistAcidItemEnhancement(Game game) : base(game) { } // This object is a singleton.
