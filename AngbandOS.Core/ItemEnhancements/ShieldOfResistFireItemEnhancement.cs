...
[Serializable]
internal class ShieldOfResistFireItemEnhancement : ItemEnhancement
{
    private ShieldOfResistFireItemEnhancement(Game game) : base(game) { } // This object is a singleton.
