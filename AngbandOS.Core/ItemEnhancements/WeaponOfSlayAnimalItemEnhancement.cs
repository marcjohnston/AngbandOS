...
[Serializable]
internal class WeaponOfSlayAnimalItemEnhancement : ItemEnhancement
{
    private WeaponOfSlayAnimalItemEnhancement(Game game) : base(game) { } // This object is a singleton.
