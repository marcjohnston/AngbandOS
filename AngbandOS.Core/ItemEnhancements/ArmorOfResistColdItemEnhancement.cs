...
[Serializable]
internal class ArmorOfResistColdItemEnhancement : ItemEnhancement
{
    private ArmorOfResistColdItemEnhancement(Game game) : base(game) { } // This object is a singleton.
