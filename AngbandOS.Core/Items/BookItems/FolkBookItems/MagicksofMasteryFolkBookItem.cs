...
{
    public MagicksOfMasteryFolkBookItem(SaveGame saveGame) : base(saveGame, saveGame.SingletonRepository.ItemFactories.Get<MagicksOfMasteryFolkBookItemFactory>()) { }
