...
[Serializable]
    ...
    {
        public CeleanoFragmentTarotBookItem(SaveGame saveGame) : base(saveGame, saveGame.SingletonRepository.ItemFactories.Get<CeleanoFragmentsTarotBookItemFactory>()) { }
