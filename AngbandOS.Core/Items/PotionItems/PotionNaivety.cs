...
{
    [Serializable]
    internal class PotionNaivety : PotionItemClass
    {
        private PotionNaivety(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
        ...
        public override Item CreateItem(SaveGame saveGame) => new NaivetyPotionItem(saveGame);
    }
}
