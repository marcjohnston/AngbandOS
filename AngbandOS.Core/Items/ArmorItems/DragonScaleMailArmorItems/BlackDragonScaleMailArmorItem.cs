...
[Serializable]
    ...
    {
        public BlackDragonScaleMailArmorItem(SaveGame saveGame) : base(saveGame, saveGame.SingletonRepository.ItemCategories.Get<BlackDragonScaleMailArmorItemFactory>()) { }
