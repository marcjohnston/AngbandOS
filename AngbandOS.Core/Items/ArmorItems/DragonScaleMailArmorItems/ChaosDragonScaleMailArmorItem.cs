...
[Serializable]
    ...
    {
        public ChaosDragonScaleMailArmorItem(SaveGame saveGame) : base(saveGame, saveGame.SingletonRepository.ItemCategories.Get<ChaosDragonScaleMailArmorItemFactory>()) { }
