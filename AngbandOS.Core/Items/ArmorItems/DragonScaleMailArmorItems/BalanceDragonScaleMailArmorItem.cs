...
[Serializable]
    ...
    {
        public BalanceDragonScaleMailArmorItem(SaveGame saveGame) : base(saveGame, saveGame.SingletonRepository.ItemCategories.Get<BalanceDragonScaleMailArmorItemFactory>()) { }
