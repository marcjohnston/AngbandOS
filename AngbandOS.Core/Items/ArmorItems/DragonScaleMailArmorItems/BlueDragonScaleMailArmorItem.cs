...
[Serializable]
    ...
    {
        public BlueDragonScaleMailArmorItem(SaveGame saveGame) : base(saveGame, saveGame.SingletonRepository.ItemCategories.Get<BlueDragonScaleMailArmorItemFactory>()) { }
