...
[Serializable]
    ...
    {
        public GoldDragonScaleMailArmorItem(SaveGame saveGame) : base(saveGame, saveGame.SingletonRepository.ItemCategories.Get<GoldDragonScaleMailArmorItemFactory>()) { }
