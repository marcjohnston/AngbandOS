...
{
    private ReflectionAmuletJeweleryItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
    ...
    public override Item CreateItem() => new ReflectionAmuletJeweleryItem(SaveGame);
}
