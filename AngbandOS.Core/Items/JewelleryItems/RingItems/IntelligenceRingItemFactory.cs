...
[Serializable]
internal class IntelligenceRingItemFactory : RingItemFactory
{
    private IntelligenceRingItemFactory(SaveGame saveGame) : base(saveGame) { } // This object is a singleton.
