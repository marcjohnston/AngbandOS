...
{
    [Serializable]
    internal class RodFireBalls : RodItemFactory
    {
        ...
        {
            SaveGame.FireBall(new FireProjectile(SaveGame), zapRodEvent.Dir.Value, 72, 2);
            zapRodEvent.Identified = true;
            zapRodEvent.Item.TypeSpecificValue = 30;
        }
        public override Item CreateItem() => new FireBallsRodItem(SaveGame);
    }
}
