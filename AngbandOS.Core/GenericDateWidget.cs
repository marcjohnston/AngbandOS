...
[Serializable]
internal class GenericDateWidget : DateWidget
{
    public GenericDateWidget(Game game, DateWidgetGameConfiguration dateWidgetGameConfiguration) : base(game)
    {
    ...
    public override string DateValueName { get; }
