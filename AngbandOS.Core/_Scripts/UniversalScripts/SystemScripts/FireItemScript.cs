...
internal class FireItemScript : UniversalScript, IGetKey
{
    ...
    public override void ExecuteScript()
    {
        ...
        int shotDamage = Game.DiceRoll(individualAmmunition.EffectivePropertySet.DamageDice, individualAmmunition.DiceSides) + individualAmmunition.EffectivePropertySet.BonusDamage + missileWeapon.EffectivePropertySet.BonusDamage;
