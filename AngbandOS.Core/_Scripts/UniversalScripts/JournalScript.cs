...
internal class JournalScript : UniversalScript, IGetKey
{
    ...
    private void JournalAbilities()
    {
        ...
        DisplayStat("Chaotic", 16, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ChaoticAttribute)).Get());
        DisplayStat("Vampiric", 17, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(VampiricAttribute)).Get());

        Game.DisplayPlayerEquippy(0, 26 + 11);
        Game.Screen.Print(ColorEnum.Blue, "abcdefghijklm@", 1, 26 + 11);
        DisplayStat("Slay Anim.", 2, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SlayAnimalAttribute)).Get());
        DisplayStat("Slay Evil", 3, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SlayEvilAttribute)).Get());
        DisplayStat("Slay Und.", 4, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SlayUndeadAttribute)).Get());
        DisplayStat("Slay Demon", 5, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SlayDemonAttribute)).Get());
        DisplayStat("Slay Orc", 6, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SlayOrcAttribute)).Get());
        DisplayStat("Slay Troll", 7, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SlayTrollAttribute)).Get());
        DisplayStat("Slay Giant", 8, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SlayGiantAttribute)).Get());
        DisplayStat("Slay Drag.", 9, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<SummationEffectiveAttributeValue>(nameof(SlayDragonAttribute)).Get() > 1);
        ...
        DisplayStat("Poison Brd", 12, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(BrandPoisAttribute)).Get());
        DisplayStat("Acid Brand", 13, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(BrandAcidAttribute)).Get());
        DisplayStat("Elec Brand", 14, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(BrandElecAttribute)).Get());
        DisplayStat("Fire Brand", 15, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(BrandFireAttribute)).Get());
        DisplayStat("Cold Brand", 16, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(BrandColdAttribute)).Get());

        Game.DisplayPlayerEquippy(0, 52 + 11);
        Game.Screen.Print(ColorEnum.Blue, "abcdefghijklm@", 1, 52 + 11);
        DisplayStat("Sust Str", 2, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SustStrAttribute)).Get());
        DisplayStat("Sust Int", 3, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SustIntAttribute)).Get());
        DisplayStat("Sust Wis", 4, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SustWisAttribute)).Get());
        DisplayStat("Sust Dex", 5, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SustDexAttribute)).Get());
        DisplayStat("Sust Con", 6, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SustConAttribute)).Get());
        DisplayStat("Sust Cha", 7, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SustChaAttribute)).Get());
        ...
        DisplayStat("Reflect", 15, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ReflectAttribute)).Get());
        ...
        DisplayStat("Res Acid", 22, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResAcidAttribute)).Get());
        DisplayStat("Res Elec", 23, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResElecAttribute)).Get());
        DisplayStat("Res Fire", 24, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResFireAttribute)).Get());
        DisplayStat("Res Cold", 25, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResColdAttribute)).Get());
        DisplayStat("Res Pois", 26, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResPoisAttribute)).Get());
        DisplayStat("Res Fear", 27, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResFearAttribute)).Get());
        DisplayStat("Res Light", 28, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResLightAttribute)).Get());
        DisplayStat("Res Dark", 29, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResDarkAttribute)).Get());
        DisplayStat("Res Blind", 30, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResBlindAttribute)).Get());
        DisplayStat("Res Conf", 31, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResConfAttribute)).Get());
        DisplayStat("Res Sound", 32, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResSoundAttribute)).Get());
        DisplayStat("Res Shard", 33, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResShardsAttribute)).Get());
        DisplayStat("Res Neth", 34, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResNetherAttribute)).Get());
        DisplayStat("Res Nexus", 35, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResNexusAttribute)).Get());
        DisplayStat("Res Chaos", 36, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResChaosAttribute)).Get());
        DisplayStat("Res Disen", 37, 0, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ResDisenAttribute)).Get());

        Game.DisplayPlayerEquippy(20, 26 + 11);
        Game.Screen.Print(ColorEnum.Blue, "abcdefghijklm@", 21, 26 + 11);
        DisplayStat("Aura Fire", 22, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ShFireAttribute)).Get());
        DisplayStat("Aura Elec", 23, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ShElecAttribute)).Get());

        DisplayStat("Anti-Theft", 25, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(AntiTheftAttribute)).Get());
        ...
        DisplayStat("WraithForm", 28, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(WraithAttribute)).Get());
        ...
        DisplayStat("Show Mods", 32, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(ShowModsAttribute)).Get());
        ...
        DisplayStat("See Invis", 35, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SeeInvisAttribute)).Get());
        DisplayStat("Telepathy", 36, 26, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(TelepathyAttribute)).Get());

        Game.DisplayPlayerEquippy(20, 52 + 11);
        Game.Screen.Print(ColorEnum.Blue, "abcdefghijklm@", 21, 52 + 11);
        DisplayStat("Digestion", 22, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(SlowDigestAttribute)).Get());
        DisplayStat("Regen", 23, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(RegenAttribute)).Get());
        DisplayStat("Xtra Might", 24, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(XtraMightAttribute)).Get());
        DisplayStat("Xtra Shots", 25, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(XtraShotsAttribute)).Get());
        ...
        DisplayStat("Drain Exp", 31, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(DrainExpAttribute)).Get());
        DisplayStat("Teleport", 32, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(TeleportAttribute)).Get());
        DisplayStat("Aggravate", 33, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(AggravateAttribute)).Get());
        DisplayStat("Blessed", 34, 52, (EffectiveAttributeSet itemCharacteristics) => itemCharacteristics.Get<BitwiseOrEffectiveAttributeValue>(nameof(BlessedAttribute)).Get());
