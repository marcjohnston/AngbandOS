...
internal class TimerScript : EatOrQuaffUniversalScript, IGetKey, IToJson
{
    ...
    public void Bind()
    {
        ...
        EnabledBoolPosFunction = Game.SingletonRepository.GetNullable<BoolProductOfSumsFunction>(EnabledBoolPosFunctionBindingKey);
    }
    ...
    /// </summary>
    public BoolProductOfSumsFunction? EnabledBoolPosFunction { get; private set; }
