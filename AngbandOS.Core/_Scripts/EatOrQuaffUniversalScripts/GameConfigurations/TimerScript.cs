...
internal class TimerScript : EatOrQuaffUniversalScript, IGetKey, IToJson
{
    ...
    public void Bind()
    {
        ...
        EnabledBoolPosFunction = Game.SingletonRepository.GetNullable<ProductOfSumsBoolFunction>(EnabledBoolPosFunctionBindingKey);
    }
    ...
    /// </summary>
    public ProductOfSumsBoolFunction? EnabledBoolPosFunction { get; private set; }
