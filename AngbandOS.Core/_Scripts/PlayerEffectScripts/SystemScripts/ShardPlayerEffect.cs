...
internal class ShardPlayerEffect : PlayerEffectUniversalScript
{
    ...
    private ShardPlayerEffect(Game game, ObjectGameStateBag gameStateBag) : base(game, gameStateBag) { }    public override string? BlindPreMessage => "You are hit by shards of crystal!";
