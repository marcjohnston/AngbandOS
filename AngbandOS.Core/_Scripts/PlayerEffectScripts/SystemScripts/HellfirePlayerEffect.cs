...
[Serializable]
internal class HellfirePlayerEffect : PlayerEffectUniversalScript
{
    private HellfirePlayerEffect(Game game) : base(game) { }
    private HellfirePlayerEffect(Game game, ObjectGameStateBag gameStateBag) : base(game, gameStateBag) { }    public override string? BlindPreMessage => "You are hit by something!";
