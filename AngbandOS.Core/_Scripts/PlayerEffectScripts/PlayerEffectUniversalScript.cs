...
[Serializable]
internal abstract class PlayerEffectUniversalScript : IPlayerEffectScript, IGetKey
{
    ...
    protected PlayerEffectUniversalScript(Game game, GameStateBag gameStateBag) // This object is a singleton
    {
        Game = game;
    }
    ...
    public abstract IdentifiedResultEnum Apply(Monster mPtr, int dam);
}
