...
internal class DarknessProjectile : Projectile
{
    ...
    protected override string FloorEffectBindingKey => nameof(DarknessFloorEffect);

    protected override string MonsterEffectBindingKey => nameof(DarknessMonsterEffect);

    protected override string PlayerEffectBindingKey => nameof(DarknessPlayerEffect);
}