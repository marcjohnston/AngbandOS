...
{
    private OldDrainProjectile(Game game) : base(game) { }
    ...
    protected override Animation EffectAnimation => Game.SingletonRepository.Animations.Get(nameof(BlackContractAnimation));
