...
namespace byMarc.Net2.Library.Strings
{
    ...
    public static class StringLib
    {
        ...
        public static string BuildPath(string separator, bool ensureLeading, bool ensureTrailing, params string[] pathSegments)
        {
            ...
            foreach (string segment in pathSegments)
            {
                ...
                while ((Microsoft.VisualBasic.Strings.Left(segment, 1) ?? "") == (separator ?? ""))
                    segment = Microsoft.VisualBasic.Strings.Mid(segment, 2);
                while ((Microsoft.VisualBasic.Strings.Right(segment, 1) ?? "") == (separator ?? ""))
                    segment = Microsoft.VisualBasic.Strings.Left(segment, segment.Length - 1);
        ...
        #region CompareLeadingNumeric - Returns -1, 0 or 1 based on the result of a hybrid string and numeric comparison.  A numeric portion of the string at the beginning is used to determine the comparison.
        /// <summary>
    ...
    /// <remarks></remarks>
        ...
        #endregion
        #region DelimitIf - Returns the concatenation of two strings with a delimiter between them, if both strings are non-empty.
        /// <summary>
    ...
    /// <returns>A string that represents [stringA] + [delimiter] + [stringB].</returns>
        ...
        #endregion
        #region Duplicate - Returns the concatenation of a string copied a specific number of times.
        /// <summary>
    ...
    /// <remarks></remarks>
        ...
        #endregion
        #region EncapsulateIf - Concatenates a prefix and suffix string to a string value, if the string value is non-empty.
        /// <summary>
    ...
    /// <returns>[stringValue] + [conditionalPrefixString]</returns>
        ...
        #endregion
        #region EncapsulateInQuotes - Returns a string enclosed in quotes, with the quote character doubled in the string.
        /// <summary>
    ...
    /// <remarks></remarks>
        ...
        #endregion
        #region EnsurePrefix - Returns a string with a specific prefix.  The original string is returned if it already contains the prefix; otherwise the prefix is concatenated to it.
        /// <summary>
    ...
    /// <remarks></remarks>
        ...
        #endregion
        #region EnsureSuffix - Returns a string with a specific suffix.  The original string is returned if it already contains the suffix; otherwise the suffix is concatenated to it.
        /// <summary>
    ...
    /// <remarks></remarks>
        ...
        #endregion
        #region ExtractText - Returns a substring found within a another string.  A starting position, prefix and suffix can all be specified to identify the location of the text to extract.
        /// <summary>
    ...
    /// <remarks></remarks>
        ...
        #endregion
        #region IfEmpty - Returns an object, if a value is empty.
        /// <summary>
    ...
    /// <returns>The object <paramref name="emptyValue" />, if <paramref name="value" /> is nothing; otherwise <paramref name="value" />.</returns>
        ...
        #endregion
        #region IsAlpha - Returns True, if every character in a string is an alphabetic character (a-z, A-Z).
        /// <summary>
    ...
    /// <returns>TRUE, if every character in <paramref name="s" /> is a character between 'a' and 'z' or 'A' and 'Z'; FALSE otherwise.</returns>
        ...
        #endregion
        #region IsAlphaNumeric - Returns true, if a character or every character in a string is alphabetic or numeric (a-z, A-Z, 0-9).
        /// <summary>
    ...
    /// <remarks></remarks>
        ...
        #endregion
        #region IsDigit - Returns True, if a single character is a digit or every character in a string is a digit (0-9) or the string is empty.
        /// <summary>
    ...
    /// <remarks></remarks>
        ...
        #endregion
        #region IsEnclosed - Returns TRUE, is a string has a given prefix and suffix.
        /// <summary>
    ...
    /// <remarks></remarks>
        ...
        #endregion
        #region IsHexadecimal - Returns true, if every character in a string is a hexadecimal digit.
        /// <summary>
