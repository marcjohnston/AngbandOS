...
public class CauseWoundsMonsterSpellGameConfiguration : NonCompositeSingletonGameConfiguration
{
    ...
    /// <summary>
    /// Returns true, if the spell can attack its foe.  Returns true, by default for cause wounds spells.
    /// </summary>
    ...
    /// <summary>
    /// Returns true, if the spell annoys its foe.  Returns true, by default for cause wounds spells.  Shriek, DrainMana, 
    ...
    /// </summary>
    public virtual string TimedBleedingExpressionText { get; set; } = "0";
}
