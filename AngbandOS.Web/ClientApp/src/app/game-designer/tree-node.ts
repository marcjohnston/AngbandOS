...
export class TreeNode {
     ...
     */
    public metadataAndConfiguration: PropertyMetadataAndConfiguration;

    constructor(title: string, children: TreeNode[] | null, metadataAndConfiguration: PropertyMetadataAndConfiguration) {
        this.title = title;
        this.children = children;
        this.metadataAndConfiguration = metadataAndConfiguration;
    }
}
