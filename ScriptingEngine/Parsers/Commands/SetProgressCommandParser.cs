...
/// <remarks></remarks>
    public class SetProgressCommandParser : CommandParser
    {
        ...
        protected override RunTime.Command[] Parse(Parser parser, ScriptEngine scriptEngine, RunTime.WorkEnvironment workEnvironment)
        {
            ...
            return new RunTime.Command[] { new RunTime.SetProgress(DebugSymbol(parser), value) };
        }
    }
}