...
namespace Big6Search.ScriptingEngine.RunTime
{
    public class SubtractExpression : Expression
    {
        ...
        public SubtractExpression(Expression value1, Expression value2) : this(null, value1, value2)
        {
        }
        public SubtractExpression(DebugSymbol debugSymbol, Expression value1, Expression value2) : base(debugSymbol)
        {
            Value1 = value1;
            Value2 = value2;
        }
