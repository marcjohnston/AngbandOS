namespace byMarc.Net2.Library.LanguageParsing
{
    public class ParsedToken
    {
        ...
        public bool IsOnNewLine
        {
            get
            {
                return (LeadingWhiteSpace.Contains('\r') || LeadingWhiteSpace.Contains('\n'));
            }
        }
        ...
        {
            string whitespace = includeLeadingWhiteSpace ? LeadingWhiteSpace : "";
            return $"{whitespace}{_updatedText}";
        }

        public void set_UpdatedText(string value)
        {
            _updatedText = value;
        }
