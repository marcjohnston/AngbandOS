...
[Serializable]
public class LargeBallFire72Every100DirectionalActivation : ActivationGameConfiguration
{
    ...
    public override string ActivationCancellableScriptItemBindingKey => nameof(Fire72r3ProjectileScript);
