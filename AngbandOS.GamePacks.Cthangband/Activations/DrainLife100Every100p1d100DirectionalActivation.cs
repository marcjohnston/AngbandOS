...
/// </summary>
[Serializable]
public class DrainLife100Every100p1d100DirectionalActivation : ActivationGameConfiguration
{
    ...
    public override string ActivationCancellableScriptItemBindingKey => nameof(OldDrainLife100ProjectileScript);
