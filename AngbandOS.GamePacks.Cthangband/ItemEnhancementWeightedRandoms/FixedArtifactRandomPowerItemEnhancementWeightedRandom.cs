...
public class FixedArtifactRandomPowerItemEnhancementWeightedRandom : ItemEnhancementWeightedRandomGameConfiguration
{
    ...
    {
        // 50%
        (nameof(FeatherFallItemItemEnhancement), 64),
        (nameof(FreeActionItemEnhancement), 64),
        (nameof(HoldLifeItemEnhancement), 64),
        (nameof(LightsourceRadius3ItemEnhancement), 64),
        (nameof(RegenerationItemEnhancement), 64),
        (nameof(SeeInvisibleItemEnhancement), 64),
        (nameof(SlowDigestItemEnhancement), 64),
        (nameof(TelepathyItemEnhancement), 64),
