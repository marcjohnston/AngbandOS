...
[Serializable]
public class SoftLeatherSoftArmorItemFactory : ItemFactoryGameConfiguration
{
    public override string[]? EnhancementFixedArtifactFactoriesBindingKeys => new string[] { nameof(FixedArtifactsEnum.SoftLeatherArmorOfTheKoboldChiefFixedArtifact) };
    ...
    public override string? ItemEnhancementBindingKey => nameof(SoftLeatherSoftArmorItemFactoryItemEnhancement);
