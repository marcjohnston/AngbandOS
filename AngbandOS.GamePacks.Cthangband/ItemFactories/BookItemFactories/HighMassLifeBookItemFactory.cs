...
[Serializable]
public class HighMassLifeBookItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(HighMassLifeBookItemFactoryItemEnhancement);
