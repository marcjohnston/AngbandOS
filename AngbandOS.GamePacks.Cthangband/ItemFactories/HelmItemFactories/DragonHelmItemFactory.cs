...
{
    public override string[]? EnhancementFixedArtifactFactoriesBindingKeys => new string[] { nameof(FixedArtifactsEnum.DragonHelmOfPowerFixedArtifact) };
    ...
    public override string? ItemEnhancementBindingKey => nameof(DragonHelmItemFactoryItemEnhancement);
