...
[Serializable]
public class HumanSkeletonSkeletonItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(HumanSkeletonSkeletonItemFactoryItemEnhancement);
