...
[Serializable]
public class BastardSwordSwordWeaponItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(BastardSwordItemFactoryItemEnhancement);
