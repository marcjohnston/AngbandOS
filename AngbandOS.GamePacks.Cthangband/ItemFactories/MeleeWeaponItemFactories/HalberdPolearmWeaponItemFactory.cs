...
[Serializable]
public class HalberdPolearmWeaponItemFactory : ItemFactoryGameConfiguration
{
    public override string[]? EnhancementFixedArtifactFactoriesBindingKeys => new string[] { nameof(FixedArtifactsEnum.HalberdArmorbaneFixedArtifact) };
    ...
    public override string? ItemEnhancementBindingKey => nameof(HalberdPolearmWeaponItemFactoryItemEnhancement);
