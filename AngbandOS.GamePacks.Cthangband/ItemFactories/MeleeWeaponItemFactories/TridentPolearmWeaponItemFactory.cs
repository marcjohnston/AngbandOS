...
{
    public override string[]? EnhancementFixedArtifactFactoriesBindingKeys => new string[] { nameof(FixedArtifactsEnum.TridentOfTheGnorriFixedArtifact), nameof(FixedArtifactsEnum.TridentOfWrathFixedArtifact) };
