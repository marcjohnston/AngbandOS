...
[Serializable]
public class TeleportationStaffItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string UseScriptBindingKey, string InitialChargesRollExpression, int PerChargeValue, int ManaEquivalent)? UseBindingTuple => (nameof(SystemScriptsEnum.TeleportSelfScript), "1d4+5", 100, 100);
