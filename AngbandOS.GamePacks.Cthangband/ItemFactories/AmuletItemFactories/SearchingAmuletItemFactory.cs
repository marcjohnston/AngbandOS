...
[Serializable]
public class SearchingAmuletItemFactory : ItemFactoryGameConfiguration
{
    ...
    {
        (new int[] {-1, -2}, null, new string[] { nameof(SystemScriptsEnum.BrokenAndCursedEnchantmentScript), nameof(SystemScriptsEnum.PoorSearch1D5P5BEnchantmentScript) }),
        (new int[] {0, 1, 2}, null, new string[] { nameof(SystemScriptsEnum.BonusSearch1D5P5BEnchantmentScript) })
    };

    public override string? ItemEnhancementBindingKey => nameof(SearchingAmuletItemFactoryItemEnhancement);
