...
[Serializable]
public class AntiTeleportationAmuletItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(NoTeleportItemFactoryItemEnhancement);
