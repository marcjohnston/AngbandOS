...
[Serializable]
public class AdornmentAmuletItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(AdornmentAmuletItemFactoryItemEnhancement);
