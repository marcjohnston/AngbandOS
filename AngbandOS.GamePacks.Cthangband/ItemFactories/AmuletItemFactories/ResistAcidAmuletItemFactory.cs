...
[Serializable]
public class ResistAcidAmuletItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(ResistAcidAmuletItemFactoryItemEnhancement);
