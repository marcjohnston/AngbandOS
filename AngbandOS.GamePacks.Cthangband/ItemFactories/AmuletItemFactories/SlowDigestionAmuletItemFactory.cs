...
[Serializable]
public class SlowDigestionAmuletItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(SlowDigestionAmuletItemFactoryItemEnhancement);
