...
[Serializable]
public class AntiTheftAmuletItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(AntiTheftAmuletItemFactoryItemEnhancement);
