...
public class ShovelDiggingWeaponItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(ShovelDiggingWeaponItemFactoryItemEnhancement);
    ...
    {
        (new int[] {-2}, null, new string[] { nameof(SystemScriptsEnum.TerribleHit1D5P5BP10BEnchantmentScript), nameof(SystemScriptsEnum.TerribleDamage1D5P5BP10BEnchantmentScript), nameof(SystemScriptsEnum.TerribleDiggerEnchantmentScript), nameof(SystemScriptsEnum.TerribleTunnelEnchantmentScript), nameof(SystemScriptsEnum.CursedWeaponEnchantmentScript) }),
        (new int[] {-1}, null, new string[] { nameof(SystemScriptsEnum.PoorHit1D5P5BEnchantmentScript), nameof(SystemScriptsEnum.PoorDamage1D5P5BEnchantmentScript), nameof(SystemScriptsEnum.TerribleTunnelEnchantmentScript), nameof(SystemScriptsEnum.CursedWeaponEnchantmentScript) }),
    ...
    public override string[] WieldSlotBindingKeys => new string[] { nameof(WieldSlotsEnum.DiggerWieldSlot) };
