...
[Serializable]
public class BlackDragonScaleMailItemFactory : ItemFactoryGameConfiguration
{
    public override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
   {
    ...
    public override string? ItemEnhancementBindingKey => nameof(BlackDragonItemFactoryItemEnhancement);
