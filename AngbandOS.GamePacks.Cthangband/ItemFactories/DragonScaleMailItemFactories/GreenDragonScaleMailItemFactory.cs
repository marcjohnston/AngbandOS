...
[Serializable]
public class GreenDragonScaleMailItemFactory : ItemFactoryGameConfiguration
{
    public override (int, string)[]? MassProduceBindingTuples => new (int, string)[]
  {
    ...
    public override string? ItemEnhancementBindingKey => nameof(GreenDragonItemFactoryItemEnhancement);
    ...
    public override string? DescriptionSyntax  => "Green Dragon Scale Mail~";
