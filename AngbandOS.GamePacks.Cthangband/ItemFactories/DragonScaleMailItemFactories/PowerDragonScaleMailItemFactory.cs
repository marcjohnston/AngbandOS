...
[Serializable]
public class PowerDragonScaleMailItemFactory : ItemFactoryGameConfiguration
{
    public override string[]? EnhancementFixedArtifactFactoriesBindingKeys => new string[] { nameof(FixedArtifactsEnum.PowerDragonScaleMailBladeturnerFixedArtifact) };
