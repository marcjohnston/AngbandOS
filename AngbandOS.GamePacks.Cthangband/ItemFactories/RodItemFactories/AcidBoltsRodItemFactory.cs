...
[Serializable]
public class AcidBoltsRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(AcidBoltOrBeam6d8ProjectileScriptWeightedRandom), "12", true, 250);
    ...
    public override string? ItemEnhancementBindingKey => nameof(AcidBoltsRodItemFactoryItemEnhancement);
