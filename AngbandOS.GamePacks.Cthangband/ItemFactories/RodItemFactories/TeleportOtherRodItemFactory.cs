...
[Serializable]
public class TeleportOtherRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(TeleportAwayAll100ProjectileScript), "25", true, 250);
    ...
    public override string? ItemEnhancementBindingKey => nameof(TeleportOtherRodItemFactoryItemEnhancement);
