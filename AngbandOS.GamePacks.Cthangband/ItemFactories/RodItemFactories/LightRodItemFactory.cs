...
[Serializable]
public class LightRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(LightWeak6d8ProjectileScript), "9", true, 250);
