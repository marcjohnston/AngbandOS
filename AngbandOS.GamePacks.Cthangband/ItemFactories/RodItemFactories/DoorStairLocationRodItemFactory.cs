...
[Serializable]
public class DoorStairLocationRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(SystemScriptsEnum.DetectDoorsAndStairsScript), "70", false, 250);
