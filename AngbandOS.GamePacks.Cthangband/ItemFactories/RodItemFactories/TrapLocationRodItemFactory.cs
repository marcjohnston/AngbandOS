...
[Serializable]
public class TrapLocationRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(SystemScriptsEnum.TrapLocationIdentifiedAndUsedScriptItemAndDirection), "1d10+10", false, 250);
    ...
    public override string? ItemEnhancementBindingKey => nameof(TrapLocationRodItemFactoryItemEnhancement);
