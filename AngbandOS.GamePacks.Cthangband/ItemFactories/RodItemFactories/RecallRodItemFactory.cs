...
[Serializable]
public class RecallRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(SystemScriptsEnum.RecallIdentifiedAndUsedScriptItemAndDirection), "60", false, 250);
    ...
    public override string? ItemEnhancementBindingKey => nameof(RecallRodItemFactoryItemEnhancement);
