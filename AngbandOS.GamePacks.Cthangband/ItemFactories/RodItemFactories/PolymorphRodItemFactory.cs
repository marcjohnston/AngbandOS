...
[Serializable]
public class PolymorphRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(OldPolymorph1xProjectileScript), "25", true, 250);
    ...
    public override string? ItemEnhancementBindingKey => nameof(PolymorphRodItemFactoryItemEnhancement);
