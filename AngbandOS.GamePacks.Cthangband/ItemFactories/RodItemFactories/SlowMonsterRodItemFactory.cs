...
[Serializable]
public class SlowMonsterRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(OldSlow1xProjectileScript), "20", true, 250);
    ...
    public override string? ItemEnhancementBindingKey => nameof(SlowMonsterRodItemFactoryItemEnhancement);
