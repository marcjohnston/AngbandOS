...
[Serializable]
public class AcidBallsRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(Acid60r2ProjectileScript), "27", true, 250);
