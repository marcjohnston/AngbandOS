...
[Serializable]
public class FireBoltsRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(FireBoltOrBeam8d8ProjectileScriptWeightedRandom), "15", true, 250);
    ...
    public override string? ItemEnhancementBindingKey => nameof(FireBoltsRodItemFactoryItemEnhancement);
