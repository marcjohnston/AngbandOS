...
[Serializable]
public class RestorationRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(SystemScriptsEnum.RestorationIdentifiedAndUsedScriptItemAndDirection), "999", false, 250);
    ...
    public override string? ItemEnhancementBindingKey => nameof(RestorationRodItemFactoryItemEnhancement);
