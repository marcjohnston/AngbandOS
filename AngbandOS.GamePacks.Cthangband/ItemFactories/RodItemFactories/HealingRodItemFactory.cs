...
[Serializable]
public class HealingRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(SystemScriptsEnum.HealingIdentifiedAndUsedScriptItemAndDirection), "999", false, 250);
    ...
    public override string? ItemEnhancementBindingKey => nameof(HealingRodItemFactoryItemEnhancement);
