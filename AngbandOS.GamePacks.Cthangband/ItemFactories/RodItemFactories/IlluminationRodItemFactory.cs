...
[Serializable]
public class IlluminationRodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, bool, int)? ZapBindingTuple => (nameof(SystemScriptsEnum.IlluminationIdentifiedAndUsedScriptItemAndDirection), "1d11+10", false, 250);
    ...
    public override string? ItemEnhancementBindingKey => nameof(IlluminationRodItemFactoryItemEnhancement);
