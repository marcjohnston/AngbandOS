...
[Serializable]
public class IdentifyScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override string? FlavorSuppressedDescriptionSyntax => "Scroll~ of $Name$";    public override int Cost => 50;
