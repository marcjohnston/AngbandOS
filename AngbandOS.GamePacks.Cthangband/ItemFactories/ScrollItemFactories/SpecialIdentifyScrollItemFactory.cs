...
[Serializable]
public class SpecialIdentifyScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.IdentifyItemFullyScript), 10);
