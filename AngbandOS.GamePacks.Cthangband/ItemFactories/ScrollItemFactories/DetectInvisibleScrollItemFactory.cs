...
[Serializable]
public class DetectInvisibleScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.DetectInvisibleIdentifableAndUsedScript), 10);
    ...
    public override string? ItemEnhancementBindingKey => nameof(DetectInvisibleScrollItemFactoryItemEnhancement);
