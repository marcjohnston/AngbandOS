...
[Serializable]
public class CreateRandomArtifactScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override string? ItemEnhancementBindingKey => nameof(CreateRandomArtifactScrollItemFactoryItemEnhancement);
