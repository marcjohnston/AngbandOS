...
[Serializable]
public class HolyPrayerScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.Blessing1d48p24IdentifableAndUsedScript), 10);
