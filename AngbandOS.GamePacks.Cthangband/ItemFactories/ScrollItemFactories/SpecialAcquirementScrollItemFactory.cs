...
[Serializable]
public class SpecialAcquirementScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.SpecialAcquirementIdentifableAndUsedScript), 10);
    ...
    public override string? ItemEnhancementBindingKey => nameof(SpecialAcquirementScrollItemFactoryItemEnhancement);
