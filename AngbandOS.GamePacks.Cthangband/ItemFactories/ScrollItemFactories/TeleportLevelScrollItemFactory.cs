...
[Serializable]
public class TeleportLevelScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.TeleportLevelScript), 10);
    ...
    public override string? ItemEnhancementBindingKey => nameof(TeleportLevelScrollItemFactoryItemEnhancement);
