...
[Serializable]
public class ProtectionFromEvilScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override string? ItemEnhancementBindingKey => nameof(ProtectionFromEvilScrollItemFactoryItemEnhancement);
