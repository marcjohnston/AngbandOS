...
[Serializable]
public class TrapDetectionScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.DetectTrapsIdentifableAndUsedScript), 10);
    ...
    public override string? ItemEnhancementBindingKey => nameof(TrapDetectionScrollItemFactoryItemEnhancement);
