...
[Serializable]
public class MonsterConfusionScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.MonsterConfusionIdentifableAndUsedScript), 10);
    ...
    public override string? ItemEnhancementBindingKey => nameof(MonsterConfusionScrollItemFactoryItemEnhancement);
