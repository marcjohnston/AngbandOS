...
[Serializable]
public class SpecialEnchantWeaponScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.EnchantWeaponToDamage1D3AndToHit1D3IdentifableAndUsedScript), 10);
    ...
    public override string? ItemEnhancementBindingKey => nameof(SpecialEnchantWeaponScrollItemFactoryItemEnhancement);
