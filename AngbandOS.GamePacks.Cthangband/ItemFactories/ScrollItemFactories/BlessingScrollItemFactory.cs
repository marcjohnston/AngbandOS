...
[Serializable]
public class BlessingScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.Blessing1d12p6IdentifableAndUsedScript), 10);
