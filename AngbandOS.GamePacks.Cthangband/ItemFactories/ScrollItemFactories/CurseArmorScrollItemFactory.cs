...
[Serializable]
public class CurseArmorScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.CurseArmorIdentifableAndUsedScript), 10);
