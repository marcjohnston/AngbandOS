...
[Serializable]
public class ObjectDetectionScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.DetectNormalObjectsIdentifableAndUsedScript), 10);
    ...
    public override string? ItemEnhancementBindingKey => nameof(ObjectDetectionScrollItemFactoryItemEnhancement);
