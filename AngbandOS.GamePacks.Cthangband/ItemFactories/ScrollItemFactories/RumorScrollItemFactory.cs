...
[Serializable]
public class RumorScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override string Name => "Rumor";
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.RumorIdentifableAndUsedScript), 10);
    ...
    public override string? ItemEnhancementBindingKey => nameof(RumorScrollItemFactoryItemEnhancement);
