...
[Serializable]
public class AcquirementScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.AcquirementIdentifableAndUsedScript), 10);
    ...
    public override string? ItemEnhancementBindingKey => nameof(AcquirementScrollItemFactoryItemEnhancement);
