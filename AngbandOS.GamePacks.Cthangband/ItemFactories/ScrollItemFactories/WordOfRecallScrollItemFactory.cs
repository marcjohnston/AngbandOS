...
[Serializable]
public class WordOfRecallScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.WordOfRecallIdentifableAndUsedScript), 10);
    ...
    public override string? ItemEnhancementBindingKey => nameof(WordOfRecallScrollItemFactoryItemEnhancement);
