...
[Serializable]
public class TeleportationScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override string? ItemEnhancementBindingKey => nameof(TeleportationScrollItemFactoryItemEnhancement);
