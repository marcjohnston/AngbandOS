...
[Serializable]
public class EnchantArmorScrollItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override (string, int)? ReadBindingTuple => (nameof(SystemScriptsEnum.EnchantArmor1IdentifableAndUsedScript), 10);
    ...
    public override string? ItemEnhancementBindingKey => nameof(EnchantArmorScrollItemFactoryItemEnhancement);
