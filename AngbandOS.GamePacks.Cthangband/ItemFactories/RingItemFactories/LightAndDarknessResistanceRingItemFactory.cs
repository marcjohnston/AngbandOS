...
[Serializable]
public class LightAndDarknessResistanceRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(LightAndDarknessResistanceRingItemFactoryItemEnhancement);
