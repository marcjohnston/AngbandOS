...
[Serializable]
public class AcidRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(AcidRingItemFactoryItemEnhancement);
