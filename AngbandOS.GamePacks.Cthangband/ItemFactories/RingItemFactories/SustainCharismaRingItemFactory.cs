...
[Serializable]
public class SustainCharismaRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(SustainCharismaRingItemFactoryItemEnhancement);
