...
[Serializable]
public class BarahirRingItemFactory : ItemFactoryGameConfiguration
{
    public override string[]? EnhancementFixedArtifactFactoriesBindingKeys => new string[] { nameof(FixedArtifactsEnum.RingOfMagicFixedArtifact) };
    ...
    public override string? ItemEnhancementBindingKey => nameof(BarahirRingItemFactoryItemEnhancement);
