...
[Serializable]
public class SustainConstitutionRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(SustainConstitutionRingItemFactoryItemEnhancement);
