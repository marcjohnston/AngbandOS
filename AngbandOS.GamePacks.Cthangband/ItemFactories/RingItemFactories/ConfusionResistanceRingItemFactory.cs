...
[Serializable]
public class ConfusionResistanceRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(ConfusionResistanceRingItemFactoryItemEnhancement);
