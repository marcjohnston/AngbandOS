...
[Serializable]
public class FearResistanceRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(FearResistanceRingItemFactoryItemEnhancement);
