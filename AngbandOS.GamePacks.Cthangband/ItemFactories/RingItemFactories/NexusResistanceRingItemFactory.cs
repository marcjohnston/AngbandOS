...
[Serializable]
public class NexusResistanceRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(NexusResistanceRingItemFactoryItemEnhancement);
