...
[Serializable]
public class NaryaRingItemFactory : ItemFactoryGameConfiguration
{
    public override string[]? EnhancementFixedArtifactFactoriesBindingKeys => new string[] { nameof(FixedArtifactsEnum.RingOfElementalPowerFireFixedArtifact) };
    ...
    public override string? ItemEnhancementBindingKey => nameof(NaryaRingItemFactoryItemEnhancement);
