...
[Serializable]
public class DisenchantmentResistanceRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(DisenchantmentResistanceRingItemFactoryItemEnhancement);
