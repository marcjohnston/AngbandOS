...
[Serializable]
public class IntelligenceRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    {
        (new int[] {-1, -2}, null, new string[] { nameof(SystemScriptsEnum.BrokenAndCursedEnchantmentScript), nameof(SystemScriptsEnum.PoorIntelligence5BP1EnchantmentScript) }),
        (new int[] {0, 1, 2}, null, new string[] { nameof(SystemScriptsEnum.BonusIntelligence5BP1EnchantmentScript) })
    };

    public override int Cost => 500;
    public override string? ItemEnhancementBindingKey => nameof(IntelligenceRingItemFactoryItemEnhancement);
