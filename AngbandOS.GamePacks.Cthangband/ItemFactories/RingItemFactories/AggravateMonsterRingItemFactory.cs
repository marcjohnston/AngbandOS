...
[Serializable]
public class AggravateMonsterRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(AggravateMonsterRingItemFactoryItemEnhancement);
