...
[Serializable]
public class TeleportationRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(TeleportationRingItemFactoryItemEnhancement);
