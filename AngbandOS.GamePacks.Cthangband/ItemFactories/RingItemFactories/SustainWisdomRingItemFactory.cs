...
[Serializable]
public class SustainWisdomRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(SustainWisdomItemFactoryItemEnhancement);
