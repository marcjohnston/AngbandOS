...
[Serializable]
public class SpeedRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    {
        (new int[] {-1, -2}, null, new string[] { nameof(SystemScriptsEnum.BrokenAndCursedEnchantmentScript), nameof(SystemScriptsEnum.PoorSpeed1D5P5EnchantmentScript) }),
        (new int[] {0, 1, 2}, null, new string[] { nameof(SystemScriptsEnum.BonusSpeed1D5P5BEnchantmentScript) })
    };
