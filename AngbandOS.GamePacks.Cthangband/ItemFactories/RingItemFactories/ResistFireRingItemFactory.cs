...
[Serializable]
public class ResistFireRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(ResistFireRingItemFactoryItemEnhancement);
