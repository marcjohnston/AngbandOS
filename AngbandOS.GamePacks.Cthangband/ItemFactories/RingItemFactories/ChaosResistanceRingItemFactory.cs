...
[Serializable]
public class ChaosResistanceRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(ChaosResistanceRingItemFactoryItemEnhancement);
