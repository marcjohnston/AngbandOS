...
[Serializable]
public class ConstitutionRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    {
        (new int[] {-1, -2}, null, new string[] { nameof(SystemScriptsEnum.BrokenAndCursedEnchantmentScript), nameof(SystemScriptsEnum.PoorConstitution5BP1EnchantmentScript) }),
