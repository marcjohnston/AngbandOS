...
[Serializable]
public class BlindnessResistanceRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(BlindnessResistanceRingItemFactoryItemEnhancement);
