...
[Serializable]
public class DexterityRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    {
        (new int[] {-1, -2}, null, new string[] { nameof(SystemScriptsEnum.BrokenAndCursedEnchantmentScript), nameof(SystemScriptsEnum.PoorDexterity5BP1EnchantmentScript) }),
        (new int[] {0, 1, 2}, null, new string[] { nameof(SystemScriptsEnum.BonusDexterity5BP1EnchantmentScript) })
    };

    public override int Cost => 500;
    public override string? ItemEnhancementBindingKey => nameof(DexterityRingItemFactoryItemEnhancement);
