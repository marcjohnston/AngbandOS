...
[Serializable]
public class SustainIntelligenceRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(SustainIntelligenceRingItemFactoryItemEnhancement);
