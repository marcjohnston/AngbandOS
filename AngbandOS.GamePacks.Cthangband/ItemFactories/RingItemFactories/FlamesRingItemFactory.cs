...
[Serializable]
public class FlamesRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(FlamesRingItemFactoryItemEnhancement);
