...
[Serializable]
public class SoundResistanceRingItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(SoundResistanceRingItemFactoryItemEnhancement);
