...
[Serializable]
public class MetalBrigandineHardArmorItemFactory : ItemFactoryGameConfiguration
{
    public override string[]? EnhancementFixedArtifactFactoriesBindingKeys => new string[] { nameof(FixedArtifactsEnum.MetalBrigandineArmorOfSerpentsFixedArtifact) };
