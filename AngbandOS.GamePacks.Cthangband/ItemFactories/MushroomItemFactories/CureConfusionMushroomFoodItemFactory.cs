...
[Serializable]
public class CureConfusionMushroomFoodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? EatScriptBindingKey => nameof(SystemScriptsEnum.EatCureConfusionScript);
    ...
    public override string? ItemEnhancementBindingKey => nameof(CureConfusionMushroomFoodItemFactoryItemEnhancement);
