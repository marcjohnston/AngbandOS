...
[Serializable]
public class RestoringMushroomFoodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? EatScriptBindingKey => nameof(SystemScriptsEnum.EatRestoringScript);
    ...
    public override string? ItemEnhancementBindingKey => nameof(RestoringMushroomFoodItemFactoryItemEnhancement);
