...
[Serializable]
public class ParalysisMushroomFoodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? EatScriptBindingKey => nameof(SystemScriptsEnum.EatParalysisScript);
    ...
    public override string? ItemEnhancementBindingKey => nameof(ParalysisMushroomFoodItemFactoryItemEnhancement);
