...
[Serializable]
public class SicknessMushroomFoodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? EatScriptBindingKey => nameof(SystemScriptsEnum.EatSicknessScript);
    ...
    public override string? ItemEnhancementBindingKey => nameof(SicknessMushroomFoodItemFactoryItemEnhancement);
