...
[Serializable]
public class CureParanoiaMushroomFoodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? EatScriptBindingKey => nameof(SystemScriptsEnum.EatCureParanoiaScript);
    ...
    public override string? ItemEnhancementBindingKey => nameof(CureParanoiaMushroomFoodItemFactoryItemEnhancement);
