...
[Serializable]
public class CurePoisonMushroomFoodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? EatScriptBindingKey => nameof(SystemScriptsEnum.EatCurePoisonScript);
    ...
    public override string? ItemEnhancementBindingKey => nameof(CurePoisonMushroomFoodItemFactoryItemEnhancement);
