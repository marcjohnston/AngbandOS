...
[Serializable]
public class BlindnessMushroomFoodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? EatScriptBindingKey => nameof(SystemScriptsEnum.EatBlindnessScript);
    ...
    public override string? ItemEnhancementBindingKey => nameof(BlindnessMushroomFoodItemFactoryItemEnhancement);
