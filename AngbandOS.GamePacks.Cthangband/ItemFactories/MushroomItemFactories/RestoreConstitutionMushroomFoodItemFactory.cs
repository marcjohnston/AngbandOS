...
[Serializable]
public class RestoreConstitutionMushroomFoodItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? EatScriptBindingKey => nameof(SystemScriptsEnum.EatRestoreConstitutionScript);
    ...
    public override string? ItemEnhancementBindingKey => nameof(RestoreConstitutionMushroomFoodItemFactoryItemEnhancement);
