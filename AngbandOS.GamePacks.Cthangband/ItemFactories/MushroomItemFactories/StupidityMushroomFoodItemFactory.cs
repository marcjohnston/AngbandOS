...
[Serializable]
public class StupidityMushroomFoodItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override string? EatScriptBindingKey => nameof(SystemScriptsEnum.EatStupidityScript);
    ...
    public override string? ItemEnhancementBindingKey => nameof(StupidityMushroomFoodItemFactoryItemEnhancement);
