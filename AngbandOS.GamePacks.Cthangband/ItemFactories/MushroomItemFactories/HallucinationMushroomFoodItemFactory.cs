...
[Serializable]
public class HallucinationMushroomFoodItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override string? EatScriptBindingKey => nameof(SystemScriptsEnum.EatHallucinationsScript);
    ...
    public override string? ItemEnhancementBindingKey => nameof(HallucinationMushroomFoodItemFactoryItemEnhancement);
