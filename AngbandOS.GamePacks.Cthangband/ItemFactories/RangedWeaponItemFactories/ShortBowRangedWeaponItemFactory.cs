...
[Serializable]
public class ShortBowRangedWeaponItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(ShortBowRangedWeaponItemFactoryItemEnhancement);
