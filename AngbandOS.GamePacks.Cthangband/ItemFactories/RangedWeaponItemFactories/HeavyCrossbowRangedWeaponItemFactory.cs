...
[Serializable]
public class HeavyCrossbowRangedWeaponItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? DescriptionSyntax => "Heavy Crossbow~";
    public override int LevelNormallyFound => 30;
    public override (int level, int chance)[]? DepthsFoundAndChances => new (int, int)[]
    {
        (30, 1)
    };
    public override string? ItemEnhancementBindingKey => nameof(HeavyCrossbowRangedWeaponItemFactoryItemEnhancement);
