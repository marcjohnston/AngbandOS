...
[Serializable]
public class RestoreIntelligencePotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(SystemScriptsEnum.RestoreIntelligenceScript), null, 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(RestoreIntelligencePotionItemFactoryItemEnhancement);
