...
public class LoseMemoriesPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(SystemScriptsEnum.LoseMemoriesScript), nameof(NoProjectileMakeUnfriendlyProjectileScript), 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(LoseMemoriesPotionItemFactoryItemEnhancement);
