...
[Serializable]
public class UglinessPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(LoseCharismaAbilityScoreScript), null, 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(UglinessPotionItemFactoryItemEnhancement);
