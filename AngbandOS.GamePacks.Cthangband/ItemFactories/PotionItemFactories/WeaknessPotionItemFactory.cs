...
[Serializable]
public class WeaknessPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(LoseStrengthAbilityScoreScript), nameof(NoProjectileMakeUnfriendlyProjectileScript), 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(WeaknessPotionItemFactoryItemEnhancement);
