...
[Serializable]
public class StrengthPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(GainStrengthAbilityScoreScript), null, 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(StrengthPotionItemFactoryItemEnhancement);
