...
[Serializable]
public class RestoreStrengthPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(SystemScriptsEnum.RestoreStrengthScript), null, 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(RestoreStrengthPotionItemFactoryItemEnhancement);
