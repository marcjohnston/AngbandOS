...
[Serializable]
public class BoldnessPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(SystemScriptsEnum.ResetFearScript), null, 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(BoldnessPotionItemFactoryItemEnhancement);
