...
[Serializable]
public class ClumsinessPotionItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override string? ItemEnhancementBindingKey => nameof(ClumsinessPotionItemFactoryItemEnhancement);
