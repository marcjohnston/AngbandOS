...
[Serializable]
public class BoozePotionItemFactory : ItemFactoryGameConfiguration
{
    /// <summary>
    ...
    public override string? ItemEnhancementBindingKey => nameof(BoozePotionItemFactoryItemEnhancement);
