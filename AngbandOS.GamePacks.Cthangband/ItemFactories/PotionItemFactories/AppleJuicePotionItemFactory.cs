...
[Serializable]
public class AppleJuicePotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? PreassignedItemFlavorBindingKey => nameof(LightBrownPotionItemFlavor);
