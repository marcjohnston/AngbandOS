...
[Serializable]
public class RestoreLifeLevelsPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(SystemScriptsEnum.RestoreLevelScript), null, 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(RestoreLifeLevelsPotionItemFactoryItemEnhancement);
