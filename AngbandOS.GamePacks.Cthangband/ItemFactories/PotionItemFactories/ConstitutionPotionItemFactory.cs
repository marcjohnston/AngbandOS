...
[Serializable]
public class ConstitutionPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(SystemScriptsEnum.GainConstitutionScript), null, 20);
