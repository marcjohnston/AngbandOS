...
[Serializable]
public class ResistColdPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(ResistColdPotionItemFactoryItemEnhancement);
