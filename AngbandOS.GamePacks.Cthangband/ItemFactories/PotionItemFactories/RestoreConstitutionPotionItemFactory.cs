...
[Serializable]
public class RestoreConstitutionPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(SystemScriptsEnum.RestoreConstitutionScript), null, 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(RestoreConstitutionPotionItemFactoryItemEnhancement);
