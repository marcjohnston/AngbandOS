...
[Serializable]
public class IntelligencePotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(GainIntelligenceAbilityScoreScript), null, 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(IntelligencePotionItemFactoryItemEnhancement);
