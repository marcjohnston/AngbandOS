...
[Serializable]
public class HeroismPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(SystemScriptsEnum.Heroism1d25p25RestoreHealth10ResetFearScript), null, 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(HeroismPotionItemFactoryItemEnhancement);
