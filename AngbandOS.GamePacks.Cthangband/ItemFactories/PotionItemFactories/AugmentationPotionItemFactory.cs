...
[Serializable]
public class AugmentationPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string?, int)? QuaffBindingTuple => (nameof(SystemScriptsEnum.AugmentScript), null, 20);
    ...
    public override string? ItemEnhancementBindingKey => nameof(AugmentationPotionItemFactoryItemEnhancement);
