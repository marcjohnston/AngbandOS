...
[Serializable]
public class DexterityPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(DexterityPotionItemFactoryItemEnhancement);
