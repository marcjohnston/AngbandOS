...
[Serializable]
public class InfravisionPotionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(InfravisionPotionItemFactoryItemEnhancement);
