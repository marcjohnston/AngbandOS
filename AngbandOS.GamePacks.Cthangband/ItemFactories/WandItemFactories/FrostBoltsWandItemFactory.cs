...
[Serializable]
public class FrostBoltsWandItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override (string, string, int, int)? AimingBindingTuple => (nameof(ColdBoltOrBeam3d8ProjectileWeightedRandom), "1d5+6", 40, 150);
