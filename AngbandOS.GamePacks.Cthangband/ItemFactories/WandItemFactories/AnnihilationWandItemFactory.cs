...
[Serializable]
public class AnnihilationWandItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(AnnihilationWandItemFactoryItemEnhancement);
    public override int LevelNormallyFound => 60;
    public override (int level, int chance)[]? DepthsFoundAndChances => new (int, int)[]
    {
        (60, 4)
    };
    public override (string, string, int, int)? AimingBindingTuple => (nameof(OldDrainLife125ProjectileScript), "1d2+1", 150, 150);
