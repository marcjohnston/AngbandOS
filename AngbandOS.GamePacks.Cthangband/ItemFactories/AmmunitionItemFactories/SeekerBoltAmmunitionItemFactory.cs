...
[Serializable]
public class SeekerBoltAmmunitionItemFactory : ItemFactoryGameConfiguration
{
    ...
    public override string? ItemEnhancementBindingKey => nameof(SeekerBoltAmmunitionItemFactoryItemEnhancement);
