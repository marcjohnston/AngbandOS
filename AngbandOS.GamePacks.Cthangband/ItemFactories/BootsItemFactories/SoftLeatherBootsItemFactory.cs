...
[Serializable]
public class SoftLeatherBootsItemFactory : ItemFactoryGameConfiguration
{
    public override string[]? EnhancementFixedArtifactFactoriesBindingKeys => new string[] { nameof(FixedArtifactsEnum.PairOfSoftLeatherBootsOfDancingFixedArtifact) };
