...
[Serializable]
public class HardLeatherBootsItemFactory : ItemFactoryGameConfiguration
{
    public override string[]? EnhancementFixedArtifactFactoriesBindingKeys => new string[] { nameof(FixedArtifactsEnum.PairOfHardLeatherBootsOfIthaquaFixedArtifact) };
