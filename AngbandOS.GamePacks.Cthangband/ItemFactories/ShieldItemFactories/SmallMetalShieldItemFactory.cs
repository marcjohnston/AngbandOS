...
[Serializable]
public class SmallMetalShieldItemFactory : ItemFactoryGameConfiguration
{
    public override string[]? EnhancementFixedArtifactFactoriesBindingKeys => new string[] { nameof(FixedArtifactsEnum.SmallMetalShieldVitriolFixedArtifact) };
