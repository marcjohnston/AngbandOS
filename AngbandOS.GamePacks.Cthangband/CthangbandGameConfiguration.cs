...
public class CthangbandGameConfiguration : GameConfiguration
{
    ...
    public override string[]? InsultPlayerAttacks => new string[]
    {
    ...
    public override string[]? MoanPlayerAttacks => new string[]
    {
    ...
    public override string[]? ShopkeeperBargainComments => new string[]
    {
        "Yipee!",
        "I think I'll retire!",
    ...
    public override string[]? ShopkeeperGoodComments => new string[]
    {
        "Cool!",
        "You've made my day!",
    ...
    public override string[]? ShopkeeperLessThanGuessComments => new string[]
    {
        "Damn!",
        "You bastard!",
    ...
    public override string[]? ShopkeeperWorthlessComments => new string[]
    {
        "Arrgghh!",
        "You bastard!",
    ...
    public override string[]? SingingPlayerAttacks => new string[]
    {
        "sings 'We are a happy family.'",
        "sings 'I love you, you love me.'"
    };

    public override string[]? WorshipPlayerAttacks => new string[]
    {
        "looks up at you!",
