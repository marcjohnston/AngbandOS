...
[Serializable]
internal class OldConfuseProjectile : ProjectileGameConfiguration
{
    public override string? BoltProjectileGraphicBindingKey => nameof(GreySplatProjectileGraphic);
