...
[Serializable]
internal class ElectricityProjectile : ProjectileGameConfiguration
{
    public override string? BoltProjectileGraphicBindingKey => nameof(BrightYellowBoltProjectileGraphic);
