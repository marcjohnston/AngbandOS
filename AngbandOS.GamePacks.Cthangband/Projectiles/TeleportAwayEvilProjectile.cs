...
[Serializable]
public class TeleportAwayEvilProjectile : ProjectileGameConfiguration
{
    ...
    public override string MonsterEffectBindingKey => nameof(MonsterEffectScriptsEnum.TeleportAwayEvilMonsterEffect);
}