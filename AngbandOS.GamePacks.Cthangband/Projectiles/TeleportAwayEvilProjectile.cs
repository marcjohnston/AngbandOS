...
[Serializable]
internal class TeleportAwayEvilProjectile : ProjectileGameConfiguration
{
    ...
    public override string MonsterEffectBindingKey => nameof(MonsterEffectScripts.TeleportAwayEvilMonsterEffect);
}