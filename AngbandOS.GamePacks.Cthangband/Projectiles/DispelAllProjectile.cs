...
[Serializable]
internal class DispelAllProjectile : ProjectileGameConfiguration
{
    public override string? BoltProjectileGraphicBindingKey => nameof(BrightPinkSplatProjectileGraphic);
