...
[Serializable]
internal class PlasmaProjectile : ProjectileGameConfiguration
{
    public override string? BoltProjectileGraphicBindingKey => nameof(BrightRedBoltProjectileGraphic);
