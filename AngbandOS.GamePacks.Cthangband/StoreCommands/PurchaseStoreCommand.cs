...
[Serializable]
public class PurchaseStoreCommand : StoreCommandGameConfiguration
{
    ...
    public override string ExecuteScriptName => nameof(SystemScriptsEnum.PurchaseStoreItemScript);
}
