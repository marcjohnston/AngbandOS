...
[Serializable]
public class ResearchItemStoreCommand : StoreCommandGameConfiguration

{
    ...
    public override string ExecuteScriptName => nameof(SystemScriptsEnum.ResearchItemScript);
}
