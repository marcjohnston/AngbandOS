...
[Serializable]
public class EnchantWeaponStoreCommand : StoreCommandGameConfiguration

{
    ...
    public override string ExecuteScriptName => nameof(SystemScriptsEnum.EnchantWeapon4h4d0acScript);
}
