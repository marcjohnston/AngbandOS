...
[Serializable]
public class ExamineStoreItemCommand : StoreCommandGameConfiguration
{
    ...
    public override string ExecuteScriptName => nameof(SystemScriptsEnum.ExamineStoreItemScript);
}
