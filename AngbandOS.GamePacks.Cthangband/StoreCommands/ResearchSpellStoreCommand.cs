...
[Serializable]
public class ResearchSpellStoreCommand : StoreCommandGameConfiguration

{
    ...
    public override string ExecuteScriptName => nameof(SystemScriptsEnum.ResearchSpellScript);
}
