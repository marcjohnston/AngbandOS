...
[Serializable]
public class GainLevelRewardWizardCommand : WizardCommandGameConfiguration
{
    ...
    public override string? ExecuteScriptName => nameof(SystemScriptsEnum.GainLevelRewardScript);
}
