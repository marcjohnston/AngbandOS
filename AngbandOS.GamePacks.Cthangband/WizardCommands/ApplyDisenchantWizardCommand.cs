...
[Serializable]
public class ApplyDisenchantWizardCommand : WizardCommandGameConfiguration
{
    ...
    public override string? ExecuteScriptName => nameof(SystemScriptsEnum.ApplyDisenchantScript);
}
