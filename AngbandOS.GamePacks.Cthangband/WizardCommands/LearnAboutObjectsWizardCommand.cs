...
[Serializable]
public class LearnAboutObjectsWizardCommand : WizardCommandGameConfiguration
{
    ...
    public override string? ExecuteScriptName => nameof(SystemScriptsEnum.LearnScript);
}
