...
[Serializable]
public class SelfKnowledgeWizardCommand : WizardCommandGameConfiguration
{
    ...
    public override string? ExecuteScriptName => nameof(SystemScriptsEnum.SelfKnowledgeScript);
}
