...
[Serializable]
public class SenseInventoryWizardCommand : WizardCommandGameConfiguration
{
    ...
    public override string? ExecuteScriptName => nameof(SystemScriptsEnum.SenseInventoryScript);
}
