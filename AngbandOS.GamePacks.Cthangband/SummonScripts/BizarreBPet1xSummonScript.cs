...
[Serializable]
public class BizarreBPet1xSummonScript : SummonScriptGameConfiguration
{
    public override string MonsterFilterBindingKey => nameof(MonsterRaceFiltersEnum.Bizarre2MonsterRaceFilter);
