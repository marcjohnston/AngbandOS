...
[Serializable]
public class PawnStoreFactory : StoreFactoryGameConfiguration
{
    ...
    public override string TileName => nameof(PawnbrokersStoreTile);
    ...
    {
        nameof(ItemFiltersEnum.AnythingOfValueItemFilter)
    };
    ...
    public override string? AdvertisedStoreCommand4Name => nameof(IdentifyAllStoreCommand);
