...
[Serializable]
public class AlchemistStoreFactory : StoreFactoryGameConfiguration
{
    ...
    public override string TileName => nameof(AlchemistStoreTile);
    ...
    public override string? AdvertisedStoreCommand4Name => nameof(RestorationStoreCommand);
}