...
[Serializable]
public class OlogMonsterRace : MonsterRaceGameConfiguration
{
    ...
    public override (string, string?, int, int)[]? AttackDefinitions => new (string, string?, int, int)[]
    {
        ...
        (nameof(HitAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 1, 12),
        (nameof(BiteAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 2, 3),
        (nameof(BiteAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 2, 3)
    };
    ...
    public override string? MultilineName => "Olog";
