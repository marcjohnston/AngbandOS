...
[Serializable]
public class TheNorsaMonsterRace : MonsterRaceGameConfiguration
{
    ...
    {
        (nameof(CrushAttack), nameof(AttackEffectsEnum.AcidAttackEffect), 8, 12),
        ...
        (nameof(CrushAttack), nameof(AttackEffectsEnum.PoisonAttackEffect), 10, 14)
    };
