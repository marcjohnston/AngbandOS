...
[Serializable]
public class FafnerTheDragonMonsterRace : MonsterRaceGameConfiguration
{
    ...
    public override (string, string?, int, int)[]? AttackDefinitions => new (string, string?, int, int)[]
    {
        ...
        (nameof(ClawAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 4, 10),
        (nameof(BiteAttack), nameof(AttackEffectsEnum.FireAttackEffect), 14, 6),
        (nameof(BiteAttack), nameof(AttackEffectsEnum.PoisonAttackEffect), 14, 6)
    };
