...
[Serializable]
public class ShoggothMonsterRace : MonsterRaceGameConfiguration
{
    ...
    {
        (nameof(CrushAttack), nameof(AttackEffectsEnum.AcidAttackEffect), 5, 6),
        (nameof(CrushAttack), nameof(AttackEffectsEnum.AcidAttackEffect), 5, 6),
        (nameof(CrushAttack), nameof(AttackEffectsEnum.AcidAttackEffect), 5, 6),
        (nameof(CrushAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 6, 6)
    };
