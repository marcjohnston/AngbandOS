...
[Serializable]
public class ChaosMasterMonsterRace : MonsterRaceGameConfiguration
{
    ...
    {
        (nameof(HitAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 10, 2),
        (nameof(KickAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 10, 2),
        (nameof(PunchAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 10, 2),
        (nameof(KickAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 10, 2)
    };
