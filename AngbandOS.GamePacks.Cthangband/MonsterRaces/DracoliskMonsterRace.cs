...
[Serializable]
public class DracoliskMonsterRace : MonsterRaceGameConfiguration
{
    ...
    {
        (nameof(BiteAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 5, 12),
        (nameof(BiteAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 5, 12),
        (nameof(BiteAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 8, 8),
