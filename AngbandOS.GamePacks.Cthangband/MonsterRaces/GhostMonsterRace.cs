...
[Serializable]
public class GhostMonsterRace : MonsterRaceGameConfiguration
{
    ...
    public override (string, string?, int, int)[]? AttackDefinitions => new (string, string?, int, int)[]
    {
        ...
        (nameof(ClawAttack), nameof(AttackEffectsEnum.LoseIntAttackEffect), 1, 6),
        (nameof(ClawAttack), nameof(AttackEffectsEnum.LoseWisAttackEffect), 1, 6)
    };
