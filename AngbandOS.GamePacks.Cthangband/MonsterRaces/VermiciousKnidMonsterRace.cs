...
[Serializable]
public class VermiciousKnidMonsterRace : MonsterRaceGameConfiguration
{
    ...
    {
        (nameof(TouchAttack), nameof(AttackEffectsEnum.TerrifyAttackEffect), 4, 6),
        (nameof(CrawlAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 4, 6),
        (nameof(EngulfAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 4, 6),
    };
