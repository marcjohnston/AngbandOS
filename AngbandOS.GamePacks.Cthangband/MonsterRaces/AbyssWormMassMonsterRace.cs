...
[Serializable]
public class AbyssWormMassMonsterRace : MonsterRaceGameConfiguration
{
    ...
    {
        (nameof(CrawlAttack), nameof(AttackEffectsEnum.Exp10AttackEffect), 0, 0),
    };
    ...
    public override string? MultilineName => "Abyss\nworm\nmass";
