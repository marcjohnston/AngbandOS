...
[Serializable]
public class BlackReaverMonsterRace : MonsterRaceGameConfiguration
{
    ...
    {
        (nameof(HitAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 1, 50),
        (nameof(HitAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 1, 50),
        (nameof(HitAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 1, 50),
        (nameof(HitAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 1, 50)
    };
    public override bool Reaver => true;
