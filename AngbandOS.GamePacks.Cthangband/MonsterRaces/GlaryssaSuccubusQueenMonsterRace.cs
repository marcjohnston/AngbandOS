...
[Serializable]
public class GlaryssaSuccubusQueenMonsterRace : MonsterRaceGameConfiguration
{
    ...
    {
        (nameof(ClawAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 5, 5),
        (nameof(ClawAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 5, 5),
        (nameof(HitAttack), nameof(AttackEffectsEnum.LoseStrAttackEffect), 4, 4),
        (nameof(TouchAttack), nameof(AttackEffectsEnum.Exp80AttackEffect), 8, 1)
    };
