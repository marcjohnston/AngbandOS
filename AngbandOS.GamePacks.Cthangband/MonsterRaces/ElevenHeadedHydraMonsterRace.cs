...
[Serializable]
public class ElevenHeadedHydraMonsterRace : MonsterRaceGameConfiguration
{
    ...
    {
        (nameof(BiteAttack), nameof(AttackEffectsEnum.FireAttackEffect), 3, 12),
        (nameof(BiteAttack), nameof(AttackEffectsEnum.FireAttackEffect), 3, 12),
        (nameof(BiteAttack), nameof(AttackEffectsEnum.FireAttackEffect), 3, 12),
        (nameof(BiteAttack), nameof(AttackEffectsEnum.FireAttackEffect), 3, 12)
    };
    ...
    public override string? MultilineName => "11-headed\nhydra";
}
