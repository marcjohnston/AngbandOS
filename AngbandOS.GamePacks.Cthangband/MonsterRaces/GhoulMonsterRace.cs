...
[Serializable]
public class GhoulMonsterRace : MonsterRaceGameConfiguration
{
    ...
    {
        (nameof(ClawAttack), nameof(AttackEffectsEnum.PoisonAttackEffect), 1, 4),
        (nameof(BiteAttack), nameof(AttackEffectsEnum.PoisonAttackEffect), 1, 4),
        (nameof(BiteAttack), nameof(AttackEffectsEnum.ParalyzeAttackEffect), 1, 5),
    };
