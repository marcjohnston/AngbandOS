...
[Serializable]
public class LordOfChaosMonsterRace : MonsterRaceGameConfiguration
{
    ...
    {
        (nameof(KickAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 20, 2),
        (nameof(KickAttack), nameof(AttackEffectsEnum.HurtAttackEffect), 10, 2),
        (nameof(HitAttack), nameof(AttackEffectsEnum.PoisonAttackEffect), 20, 1),
        (nameof(HitAttack), nameof(AttackEffectsEnum.LoseAllAttackEffect), 15, 1)
    };
