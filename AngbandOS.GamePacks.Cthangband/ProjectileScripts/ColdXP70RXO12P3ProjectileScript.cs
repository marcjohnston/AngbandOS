...
[Serializable]
public class ColdXP70RXO12P3ProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string DamageRollExpression => "X+70";
    public override string RadiusRollExpression => "X/12+3";
}
