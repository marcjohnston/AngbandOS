...
[Serializable]
public class TurnAllAtLos1xp30ProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(TurnAllProjectile);
    public override string DamageRollExpression => "X+30";
