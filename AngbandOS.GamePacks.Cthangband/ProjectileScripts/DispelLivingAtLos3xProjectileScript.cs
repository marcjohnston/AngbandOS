...
[Serializable]
public class DispelLivingAtLos3xProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(DispelLivingProjectile);
