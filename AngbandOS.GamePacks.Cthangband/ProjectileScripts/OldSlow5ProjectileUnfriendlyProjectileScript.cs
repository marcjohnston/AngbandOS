...
[Serializable]
public class OldSlow5ProjectileUnfriendlyProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(OldSlowProjectile);

    public override string DamageRollExpression => "5";
