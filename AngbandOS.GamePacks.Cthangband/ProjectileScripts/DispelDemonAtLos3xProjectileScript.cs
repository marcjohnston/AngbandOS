...
[Serializable]
public class DispelDemonAtLos3xProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(DispelDemonProjectile);
