...
[Serializable]
public class DestroyTrapOrDoorProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(DestroyTrapOrDoorProjectile);
