...
[Serializable]
public class DispelEvilAtLos4xProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(DispelEvilProjectile);
