...
[Serializable]
public class OldCloneProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(OldCloneProjectile);
    public override string DamageRollExpression => "0"; // Not used.
