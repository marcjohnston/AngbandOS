...
[Serializable]
public class CharmAtLos2xProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(CharmProjectile);
    public override string DamageRollExpression => "1d2*X";
