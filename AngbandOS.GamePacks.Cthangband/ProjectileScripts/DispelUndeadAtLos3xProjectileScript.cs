...
[Serializable]
public class DispelUndeadAtLos3xProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(DispelUndeadProjectile);
    public override string DamageRollExpression => "3*X";
