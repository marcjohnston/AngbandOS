...
[Serializable]
public class OldPolymorph1xProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(OldPolymorphProjectile);
