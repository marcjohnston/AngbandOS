...
[Serializable]
public class PlasmaBallAllDirections75R2ProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(PlasmaProjectile);
