...
[Serializable]
public class OldHeal10d10ProjectileFriendlyProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(OldHealProjectile);

    public override string DamageRollExpression => "10d10";
