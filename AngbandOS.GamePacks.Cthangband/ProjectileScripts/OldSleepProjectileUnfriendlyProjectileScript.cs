...
[Serializable]
public class OldSleepProjectileUnfriendlyProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(OldSleepProjectile);
