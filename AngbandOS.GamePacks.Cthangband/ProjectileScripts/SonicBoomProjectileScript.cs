...
[Serializable]
public class SonicBoomProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string DamageRollExpression => "45+x";
    public override string RadiusRollExpression => "2+(x/10)";
}
