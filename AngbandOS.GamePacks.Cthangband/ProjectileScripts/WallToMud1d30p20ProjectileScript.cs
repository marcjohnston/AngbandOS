...
[Serializable]
public class WallToMud1d30p20ProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(WallToMudProjectile);
    public override string DamageRollExpression => "1d30+20";
