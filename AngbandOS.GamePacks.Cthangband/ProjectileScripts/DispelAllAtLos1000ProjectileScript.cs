...
[Serializable]
public class DispelAllAtLos1000ProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(DispelAllProjectile);
    public override string DamageRollExpression => "1000";
