...
[Serializable]
public class ControlUndead1xProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(ControlUndeadProjectile);
