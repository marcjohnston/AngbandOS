...
[Serializable]
public class NoProjectileMakeUnfriendlyProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(NoProjectile);
