...
[Serializable]
public class TimeBallAllDirections75R2ProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(TimeProjectile);
