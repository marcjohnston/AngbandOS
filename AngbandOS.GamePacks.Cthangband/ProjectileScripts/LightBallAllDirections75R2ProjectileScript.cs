...
[Serializable]
public class LightBallAllDirections75R2ProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(LightProjectile);
