...
[Serializable]
public class DispelGoodAtLos4xProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(DispelGoodProjectile);
