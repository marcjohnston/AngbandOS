...
[Serializable]
public class ForceBallAllDirections75R2ProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(ForceProjectile);
