...
[Serializable]
public class Shardl1d50p75r2ProjectileScript : ProjectileScriptGameConfiguration
{
    ...
    public override string ProjectileBindingKey => nameof(ShardProjectile);
    public override string DamageRollExpression => "1d50+75";
