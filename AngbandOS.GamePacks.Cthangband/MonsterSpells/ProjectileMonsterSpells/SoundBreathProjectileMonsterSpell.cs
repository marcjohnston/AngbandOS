...
[Serializable]
public class SoundBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "sound");
    ...
    public override string ProjectileKey => nameof(SoundProjectile);
    public override string DamageRollExpression => "MH/6";
    public override int? MaxDamage => 400;
    public override string[] SmartLearnSpellResistantDetectionKeys => new string[] { nameof(SpellResistantDetectionsEnum.SoundSpellResistantDetection) };
    /// <summary>
