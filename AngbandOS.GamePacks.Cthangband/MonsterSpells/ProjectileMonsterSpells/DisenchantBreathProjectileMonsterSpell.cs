...
[Serializable]
public class DisenchantBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "disenchantment");
    ...
    public override string ProjectileKey => nameof(DisenchantProjectile);
    public override string DamageRollExpression => "MH/6";
    public override int? MaxDamage => 500;
    public override string[] SmartLearnSpellResistantDetectionKeys => new string[] { nameof(SpellResistantDetectionsEnum.DisenSpellResistantDetection) };
    /// <summary>
