...
[Serializable]
public class GravityBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "gravity");
    ...
    public override string ProjectileKey => nameof(GravityProjectile);
