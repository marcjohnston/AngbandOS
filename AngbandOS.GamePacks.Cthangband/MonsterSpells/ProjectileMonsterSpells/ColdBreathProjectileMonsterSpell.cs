...
[Serializable]
public class ColdBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "frost");
    ...
    public override int? MaxDamage => 1600;
    public override string[] SmartLearnSpellResistantDetectionKeys => new string[] { nameof(SpellResistantDetectionsEnum.ColdSpellResistantDetection) };
    /// <summary>
