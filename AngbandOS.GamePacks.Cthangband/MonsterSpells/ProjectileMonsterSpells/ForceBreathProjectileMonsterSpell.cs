...
[Serializable]
public class ForceBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "force");
    public override string? VsMonsterSeenMessage => "{0} breathes force at {3}";
    public override string? VsPlayerActionMessage => "{0} breathes force.";
    public override string ProjectileKey => nameof(ForceProjectile);
