...
[Serializable]
public class Arrow7D6ProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may", "fire missiles");
    ...
    public override string DamageRollExpression => "7d6";
}
