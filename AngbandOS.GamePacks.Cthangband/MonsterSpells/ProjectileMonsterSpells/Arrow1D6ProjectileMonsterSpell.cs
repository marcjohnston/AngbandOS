...
[Serializable]
public class Arrow1D6ProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may", "fire an arrow");
    ...
    public override string DamageRollExpression => "1d6";
