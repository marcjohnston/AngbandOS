...
[Serializable]
public class ShardsBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "shards");
    ...
    public override string ProjectileKey => nameof(ExplodeProjectile);
