...
[Serializable]
public class PlasmaBoltProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("which", "produce plasma bolts");
    ...
    public override string DamageRollExpression => "10+8d7+ML";
    public override string ProjectileKey => nameof(PlasmaProjectile);
