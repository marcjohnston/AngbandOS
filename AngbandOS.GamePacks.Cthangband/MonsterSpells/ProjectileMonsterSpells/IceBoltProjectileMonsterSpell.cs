...
[Serializable]
public class IceBoltProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("which", "produce ice bolts");
    ...
    public override string DamageRollExpression => "6d6+ML";
    public override string ProjectileKey => nameof(IceProjectile);
