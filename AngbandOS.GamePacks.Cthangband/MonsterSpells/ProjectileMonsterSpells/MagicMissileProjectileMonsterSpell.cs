...
[Serializable]
public class MagicMissileProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("which", "produce magic missiles");
    ...
    public override string DamageRollExpression => "2d6+(ML/3)";

    public override string ProjectileKey => nameof(MissileProjectile);
