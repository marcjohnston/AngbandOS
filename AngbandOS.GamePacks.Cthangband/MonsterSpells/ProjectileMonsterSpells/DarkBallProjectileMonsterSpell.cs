...
[Serializable]
public class DarkBallProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("which", "invoke darkness storms");
    ...
    public override string ProjectileKey => nameof(DarknessProjectile);
    public override string DamageRollExpression => "ML*5+10d10";
    public override string RadiusExpressionText => "4";
    public override string[] SmartLearnSpellResistantDetectionKeys => new string[] { nameof(SpellResistantDetectionsEnum.DarkSpellResistantDetection) };
