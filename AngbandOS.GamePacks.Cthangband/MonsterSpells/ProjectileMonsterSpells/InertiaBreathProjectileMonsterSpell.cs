...
[Serializable]
public class InertiaBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "inertia");
    ...
    public override string ProjectileKey => nameof(InertiaProjectile);
