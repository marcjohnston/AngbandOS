...
[Serializable]
public class LightBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "light");
    ...
    public override string ProjectileKey => nameof(LightProjectile);
    public override string DamageRollExpression => "MH/6";
    public override int? MaxDamage => 400;
    public override string[] SmartLearnSpellResistantDetectionKeys => new string[] { nameof(SpellResistantDetectionsEnum.LightSpellResistantDetection) };
    /// <summary>
