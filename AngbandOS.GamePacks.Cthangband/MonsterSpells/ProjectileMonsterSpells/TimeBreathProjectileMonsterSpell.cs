...
[Serializable]
public class TimeBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "time");
    ...
    public override string ProjectileKey => nameof(TimeProjectile);
