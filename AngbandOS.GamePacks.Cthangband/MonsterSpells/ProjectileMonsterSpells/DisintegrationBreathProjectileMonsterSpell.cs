...
[Serializable]
public class DisintegrationBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "disintegration");
    ...
    public override string ProjectileKey => nameof(DisintegrateProjectile);
