...
[Serializable]
public class ConfusionBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "confusion");
    ...
    public override string ProjectileKey => nameof(ConfusionProjectile);
