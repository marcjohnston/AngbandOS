...
[Serializable]
public class NexusBreathProjectileMonsterSpell : ProjectileMonsterSpellGameConfiguration
{
    public override (string, string) KnowledgeAction => ("may breathe", "nexus");
    ...
    public override string ProjectileKey => nameof(NexusProjectile);
    public override string DamageRollExpression => "MH/3";
    public override int? MaxDamage => 250;
    public override string[] SmartLearnSpellResistantDetectionKeys => new string[] { nameof(SpellResistantDetectionsEnum.NexusSpellResistantDetection) };
    /// <summary>
