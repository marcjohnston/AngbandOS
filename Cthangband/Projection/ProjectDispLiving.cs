...
namespace Cthangband.Projection
{
    ...
    {
        public ProjectDispLiving()
        {
            BoltGraphic = "GreenSplat";
            ImpactGraphic = "";
            EffectAnimation = "GreenExpand";
        }
        ...
        protected override bool AffectMonster(int who, int r, int y, int x, int dam)
        {
            ...
            {
                bool getAngry = (rPtr.Flags3 & MonsterFlag3.Undead) == 0 && (rPtr.Flags3 & MonsterFlag3.Nonliving) == 0;
                if (getAngry && who == 0)
                {
