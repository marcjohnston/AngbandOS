...
namespace Cthangband.ActivationPowers
{
    ...
    {
        public static readonly IActivationPower[] ArtifactPowers;
        ...
        {
            return ArtifactPowers.SingleOrDefault(artifactPower => artifactPower.GetType() == type);
        }
        ...
        {
            int index = Program.Rng.DieRoll(ArtifactPowers.Length) - 1;
            return ArtifactPowers[index];
        }
        ...
        static ActivationPowerManager()
        {
            ...
            ArtifactPowers = artifactPowerList.ToArray();
        }
    }
}
