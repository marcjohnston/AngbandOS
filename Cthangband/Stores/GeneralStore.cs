    ...
    internal class GeneralStore : Store
    {
        ...
        protected override ItemIdentifier[] GetStoreTable()
        {
            return new[]
            {
                ...
                new ItemIdentifier(typeof(LightWoodenTorch)),
                new ItemIdentifier(typeof(LightWoodenTorch)),
                new ItemIdentifier(typeof(LightWoodenTorch)),
                new ItemIdentifier(typeof(LightBrassLantern)),
                new ItemIdentifier(typeof(LightBrassLantern)),
                new ItemIdentifier(typeof(LightOrb)),
                new ItemIdentifier(typeof(FlaskOfOil)),
                new ItemIdentifier(typeof(FlaskOfOil)),
                new ItemIdentifier(typeof(FlaskOfOil)),
                new ItemIdentifier(typeof(FlaskOfOil)),
                new ItemIdentifier(typeof(FlaskOfOil)),
                new ItemIdentifier(typeof(FlaskOfOil)),
                new ItemIdentifier(typeof(SpikeIronSpike)), 
                new ItemIdentifier(typeof(SpikeIronSpike)),
                new ItemIdentifier(typeof(ShotIronShot)),
                new ItemIdentifier(typeof(Arrow)),
                new ItemIdentifier(typeof(Bolt)),
                new ItemIdentifier(typeof(DiggingShovel)),
                new ItemIdentifier(typeof(DiggingPick)),
                new ItemIdentifier(typeof(Cloak)),
                new ItemIdentifier(typeof(Cloak)),
                new ItemIdentifier(typeof(Cloak)),
                new ItemIdentifier(typeof(FoodRation)),
                new ItemIdentifier(typeof(FoodRation)),
