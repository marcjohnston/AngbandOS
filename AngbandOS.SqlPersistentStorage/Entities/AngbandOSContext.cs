...
public partial class AngbandOSContext : DbContext
{
    ...
    public virtual DbSet<GameRecovery> GameRecoveries { get; set; }
    ...
    public virtual DbSet<ReplayStep> ReplaySteps { get; set; }

    public virtual DbSet<RepositoryEntity> RepositoryEntities { get; set; }

    public virtual DbSet<SavedGame> SavedGames { get; set; }

    public virtual DbSet<SavedGameContent> SavedGameContents { get; set; }

    public virtual DbSet<UserGameConfiguration> UserGameConfigurations { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_GameReplays");

            entity.HasIndex(e => e.Id, "UQ_GameReplays").IsUnique();

            entity.Property(e => e.UserId)
                .HasMaxLength(36)
                .IsUnicode(false);

            entity.HasOne(d => d.User).WithMany(p => p.GameRecoveries)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_GameReplaySequences");
        ...
        {
            entity.HasKey(e => new { e.RepositoryName, e.Key }).HasName("PK_RepositoryEntities_1");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_SavedGames_1");
            ...
            entity.HasOne(d => d.SavedGameContent).WithMany(p => p.SavedGames)
                .HasForeignKey(d => d.SavedGameContentId)
                .HasConstraintName("FK_SavedGames_SavedGameContents");

            entity.HasOne(d => d.User).WithMany(p => p.SavedGames)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
